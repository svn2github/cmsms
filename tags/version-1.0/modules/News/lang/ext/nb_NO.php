...
$lang['autodiscoverylink'] = 'URL adresse for Feed Auto-Discovery (blank for standard)';
...
$lang['help'] = '	<h3>Hva gj&oslash;r denne modulen?</h3>
	...
	<p>Den letteste m&aring;ten &aring; bruke modulen er med {news} taggen. (pakker modulen i en tagg, for &aring; forenkle syntaksen).Dette vil sette modulen hvor du &oslash;nsker p&aring; din innholdsside eller i en mal. Et eksempel p&aring; en bruk av modulen er <code>{news number=&#039;5&#039;}</code></p>';
