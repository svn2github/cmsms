...
<li class="active0{$node->depth}"><h3 class="clearfix"><dfn>{$node->hierarchy}: </dfn>{$node->menutext}</h3>{elseif $node->parent == true && $node->depth == 1}
...
<li class="separator" style="list-style-type: none;"><hr class="clearfix"></hr>{else}
