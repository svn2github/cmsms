<?php
$lang['expired_searchable'] = 'Artikel, deren Verfallsdatum &uuml;berschritten ist, d&uuml;rfen in den Suchergebnissen erscheinen';
$lang['helpshowall'] = 'Alle Artikel anzeigen (unabh&auml;ngig von deren Verfallsdatum)';
...
$lang['notify_n_draft_items'] = '%d News-Artikel wurde(n) noch nicht ver&ouml;ffentlicht.';
$lang['helprsscategory'] = 'Wenn Sie den Parameters makerssbutton verwenden, kann mit diesem Parameter eine bestimmte Kategorie f&uuml;r den RSS-Feed festgelegt werden.';
$lang['unlimited'] = 'Unbegrenzt';
$lang['none'] = 'Keine';
$lang['rss_destinationpage'] = 'Die Seiten-ID oder der Seiten-Alias der Zielseite f&uuml;r News-Artikel aus dem RSS-Feed';
...
$lang['expiry_interval'] = 'Voreingestellte Anzahl der Tage, nach denen ein Artikel verf&auml;llt (falls ein Verfallsdatum verwendet wird)';
...
$lang['content'] = 'Inhalt';
$lang['dateformat'] = '%s hat kein g&uuml;ltiges yyyy-mm-dd hh:mm:ss Format';
...
$lang['helpcategory'] = 'Mit diesem Parameter k&ouml;nnen Sie festlegen, aus welcher Kategorie die Eintr&auml;ge angezeigt werden. <strong>Um auch die Unterkategorien anzeigen zu lassen, geben Sie nach dem Kategorienamen ein * ein.</strong> &Uuml;ber eine durch Kommata getrennte Liste k&ouml;nnen auch mehrere Kategorien angezeigt werden. Ohne diesen Parameter werden alle Kategorien angezeigt. Dieser Parameter funktioniert auch mit der Aktion &quot;fesubmit&quot;, obwohl dort nur eine Kategorie unterst&uuml;tzt wird.';
$lang['helpmoretext'] = 'Mit diesem Parameter wird der Text festgelegt, der nach der News-Zusammenfassung angezeigt wird, wenn der Artikel l&auml;nger als die vorgegebene L&auml;nge ist. Standard ist &quot;Weiterlesen ...&quot;';
...
$lang['helpsortby'] = 'Felder, nach denen die Eintr&auml;ge sortiert werden. M&ouml;gliche Optionen sind: &quot;news_date&quot;, &quot;summary&quot;, &quot;news_data&quot;, &quot;news_category&quot;, &quot;news_title&quot;, &quot;news_extra&quot;, &quot;end_time&quot;, &quot;start_time&quot;, &quot;random&quot;. Standard ist &quot;news_date&quot;. Ist die gew&auml;hlte Option &quot;random&quot;, wird der Parameter sortasc ignoriert.';
$lang['helpsortasc'] = 'Sortiert Eintr&auml;ge in aufsteigende Folge schneller als in absteigender (nach Datum).';
$lang['helpdetailpage'] = 'Seite, auf der die News-Details angezeigt werden.  Das kann entweder ein Seiten-Alias oder eine Seiten-ID sein. Damit k&ouml;nnen die News-Details in einem anderen Template als die News-Zusammenfassung angezeigt werden.';
$lang['helpshowarchive'] = 'Mit diesem Parameter werden nur die Artikel angezeigt, deren Verfallsdatum &uuml;berschritten ist.';
$lang['helpbrowsecat'] = 'Mit diesem Parameter wird eine Liste der Kategorien angezeigt (browsecat=&#039;1&#039;).';
...
<p>In der News-Modul-Version 2.9 und h&ouml;her wurde sowohl das Variablenelement $entry->formatpostdate als auch der Parameter &quot;dateformat&quot; entfernt. Sie sollten daher in den News-Templates anstatt $entry->formatpostdate $entry->postdate verwenden. Das Datum kann dann mit dem Modifikator cms_date_format formatiert werden (wie in den mitgelieferten Muster-Templates gezeigt).</p>
...
<li>Erstellen Sie ein neues Datenbank-Template <em>(je nach Bedarf f&uuml;r die Zusammenfassungs- oder Detail-Ansicht)</em>. Geben Sie dem neuen Template den gleichen Namen wie das alte Template (einschlie&szlig;lich der Endung .tpl). F&uuml;gen Sie den Inhalt des Zwischenspeichers ein.</li>
