...
<p><strong>Hinweis:</strong> Wenn das Template des Men&uuml;Managers mitexportiert werden soll, muss dieses Template zuvor im MenuManager in die Datenbank importiert werden (siehe Hilfe des MenuManager-Moduls). Wurde im Template nur ein Verweis auf eine Template-Datei eingetragen (<em>(also z.Bsp. {menu template=&#039;simple_navigation<strong>.tpl</strong>&#039;}), wird dies nicht mit exportiert.</p>
