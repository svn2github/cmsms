...
$lang['help_includeprefix'] = 'Include only those items who\'s page alias contains the specified prefix.  This parameter cannot be combined with the excludeprefix parameter.';
$lang['help_excludeprefix'] = 'Exclude all items (and their children) who\'s page alias contains the specified prefix.  This parameter must not be used in conjunction with the includeprefix parameter.';
