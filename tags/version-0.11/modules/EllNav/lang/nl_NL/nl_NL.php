...
$lang['help'] = '<h3>Wat kan deze module?</h3>
	<p>Deze module maakt middels een stylesheet vormgegeven hierarchische menus, gebaseerd op de pagina die de gebruiker bekijkt. Meestal wordt deze modyule gebruikt om de web-site inhoud onder te verdelen in verschillende \'vakjes\' bijvoorbeeld zoals de veelgebruikte L vormige navigatie structuur (een menu links en een menu bovenaan de pagina, vandaar de letter L).</p>
    <p>De manier van navigatie heeft een horizontaal men, waar de \'top-level\' inhoud getoond wordt, en een vertikaal menu waar de sub-pagina\'s (inclusief de huidige pagina) uitgevouwen getoond worden. Het is het makkelijkst om daar een voorbeeld van te geven. Gegeven de volgende content structuur:</P>
    <ul><li>People
	...
	<h3>Whelke parameters kunnen opgegeven worden?</h3>
	<p>
	<ul>
