...
switch ($sType) {
    case 'File':
        $Config["UserFilesPath"] = $Config["UserFilesPath"] . 'File/';
        break;
    case 'Image':
        $Config["UserFilesPath"] = $Config["UserFilesPath"] . 'images/';
        break;
    case 'Flash':
        $Config["UserFilesPath"] = $Config["UserFilesPath"] . 'Flash/';
        break;
    case 'Media':
        $Config["UserFilesPath"] = $Config["UserFilesPath"] . 'Media/';
        break;
} 
