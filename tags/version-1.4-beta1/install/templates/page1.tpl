...
<table class="legend" border="0">
	...
	<tbody>
		<tr>
			<td><img src="images/true.gif" alt="{$success}" title="{$success}" height="16" width="16" border="0" /></td>
			<td>{lang_install a=install_value_passed}</td>
		</tr>
		<tr>
			<td><img src="images/false.gif" alt="{$failure}" title="{$failure}" height="16" width="16" border="0" /></td>
			<td>{lang_install a=install_value_failed}</td>
		</tr>
		<tr>
			<td><img src="images/red.gif" alt="{$failure}" title="{$failure}" height="16" width="16" border="0" /></td>
			<td>{lang_install a=install_value_required}</td>
		</tr>
		<tr>
			<td><img src="images/yellow.gif" alt="{$caution}" title="{$caution}" height="16" width="16" border="0" /></td>
			<td>{lang_install a=install_value_recommended}</td>
		</tr>
		<tr>
			<td><img src="images/green.gif" alt="{$success}" title="{$success}" height="16" width="16" border="0" /></td>
