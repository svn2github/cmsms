<?php
$lang['info_cmsmailer'] = 'Ce module est utilis&eacute; par de nombreux autres modules pour faciliter l&#039;envoi d&#039;emails. Il doit &ecirc;tre correctement configur&eacute; pour votre h&eacute;bergement. Utiliser les informations fournies par votre h&eacute;bergeur pour r&eacute;gler ces param&egrave;tres. Si vous ne parvenez toujours pas  &agrave; envoyer le message de test correctement, vous devez contacter votre hebergeur pour obtenir de l&#039;aide.';
...
$lang['info_from'] = 'Adresse utilis&eacute;e en tant qu&#039;exp&eacute;diteur pour tous les courriers(emails)<br/> <strong> Remarque </ strong>, cette adresse email doit &ecirc;tre r&eacute;gl&eacute;e correctement pour votre hebergement pour &eacute;viter des difficult&eacute; d&#039;envoi des emails. <br/> Si vous ne connaissez pas la juste valeur de ce param&egrave;tre, vous devez prendre contact avec votre h&eacute;bergeur';
