<?php
$lang['helprsscategory'] = 'In Verbindung mit dem makerssbutton Parameter erlaubt dieser Parameter die Festlegung einer bestimmten Kategorie f&uuml;r den RSS-Feed.';
$lang['unlimited'] = 'Unbegrenzt';
$lang['none'] = 'Kein';
$lang['rss_destinationpage'] = 'Die ID oder der Seiten-Alias f&uuml;r die Zielseite f&uuml;r News-Artikel aus dem RSS-Feed';
$lang['anonymous'] = 'Anonym';
$lang['unknown'] = 'Unbekannt';
$lang['fesubmit_redirect'] = 'Die Seiten-ID oder der Alias einer Seite, auf die der Versender eines Artikels &uuml;ber die fesubmit-Aktion weitergeleitet werden soll';
$lang['allow_summary_wysiwyg'] = 'Erlaubt die Verwendung eines WYSIWYG-Editors f&uuml;r das Zusammenfassungsfeld';
...
$lang['error_filesize'] = 'Eine hochgeladene Datei &uuml;berschreitet die maximal erlaubte Gr&ouml;&szlig;e';
...
$lang['msg_contenttype_removed'] = 'Der Inhaltstyp News wurde entfernt. Bitte verwenden Sie in Ihren Seiten-Templates bzw. Inhalten anstatt dessen den {news}-Tag mit den entsprechenden Parametern.';
...
$lang['error_templatenamexists'] = 'Ein Template mit diesem Namen existiert bereits';
...
$lang['deprecated'] = 'nicht mehr unterst&uuml;tzt';
...
$lang['info_sysdefault'] = '<em>(das Template, welches standardm&auml;&szlig;ig bei Erstellung eines neuen Templates verwendet wird)</em>';
...
$lang['restoretodefaultsmsg'] = 'Diese Funktion setzt den Inhalt der Templates auf die programmseitigen Voreinstellung zur&uuml;ck. Wollen Sie dies wirklich?';
...
$lang['endrequiresstart'] = 'Wenn Sie ein Verfallsdatums angeben, muss auch ein Startdatum festgelegt werden.';
...
$lang['helpdateformat'] = 'Anzeigeformat von Datum und Zeit des Artikels. Dieses basiert auf der PHP-Funktion <a href=&quot;http://php.net/strftime&quot; target=&quot;_blank&quot;>strftime</a> und kann im Template mit $entry->formatpostdate eingesetzt werden. Standardm&auml;&szlig;ig wird die Einstellung %x verwendet (entspricht dem serverseitig voreingestellten Format)';
...
$lang['helpaction'] = '&Uuml;berschreibt die vorgegebene Aktion. M&ouml;gliche Werte sind &#039;default&#039;, um die Zusammenfassungsansicht anzuzeigen, und &#039;fesubmit&#039;, um auf der Webseite ein Formular zur &Uuml;bermittlung neuer Artikel anzuzeigen.';
$lang['help'] = '<h3>Wichtige Hinweise</h3>
<p>Die Versionsnummer dieses News-Moduls ist h&ouml;her als die, die mit der CMSms-Version 1.1 ausgeliefert wurde. Wenn Sie diese Version des News-Moduls verwenden, sollten Sie bei einer Aktualisierung von CMS made simple besonders vorsichtig sein. Achten Sie insbesondere darauf, dass das Verzeichnis /modules/News NICHT &uuml;berschrieben wird.</p>
	...
	<ul>
		<li><b>itemcount</b> - maximale Anzahl der anzuzeigenden News-Artikel.</li>
                <li><b>entry->authorname</b> - vollst&auml;ndiger Name des Autors (Vor-/Nachname).</li>
	</ul>
	<h3>Sicherheit</h3>
	...
	<p>Am einfachsten kann das Modul mit dem {news}-Tag verwendet werden. Dieser f&uuml;gt die Ausgabe des Moduls in Ihr Template oder Seite ein und zeigt die News-Eintr&auml;ge an. Der einzuf&uuml;gende Code sollte so aussehen:</p> <code>{news number=&quot;5&quot;}</code>
<h3>Templates</h3>
...
$lang['utma'] = '156861353.717462736.1147511856.1204988561.1212906535.318';
