...
$lang['restoretodefaultsmsg'] = 'Dies setzt den Inhalt der Templates auf den Systemstandard zur&uuml;ck. Wollen Sie dies wirklich?';
...
<p> Daf&uuml;r m&uuml;ssen Sie lediglich den folgenden Tag irgendwo in Ihrer Seite aufrufen <em>&amp;lt;!-- pageAttribute: NotSearchable --&amp;gt;</em>. Wenn das Search-Modul diesen Tag auf einer Seite findet, wird deren Inhalt nicht indiziert.</p>
<p>Der Tag <em>&amp;lt;!-- pageAttribute: NotSearchable --&amp;gt;</em> kann auch in Templates eingesetzt werden. In diesem Fall werden diejenigen Seiten, die dieses Template verwenden, nicht indiziert. Wird der Tag entfernt, erfolgt eine Neuindizierung dieser Seiten.</p>';
$lang['changelog'] = '<ul>
