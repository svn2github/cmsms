...
<table class="settings" border="0">
	<caption class="tbcaption">Choose the language you would prefer to use for the installer<br/><em><span style="font-size: 0.8em;">(This does not effect the default settings of CMS Made Simple)</span></em></caption>
	<tbody>
	<tr>
		<td align="center">
