...
$smarty->assign('title_rss_destpage',$this->Lang('rss_destinationpage'));
$smarty->assign('input_rss_destpage',
		$this->CreateInputText($id,'rss_destpage',
				       $this->GetPreference('rss_destpage',''),20,20));
