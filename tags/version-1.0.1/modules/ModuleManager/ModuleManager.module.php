...
#
# Version: 1.1.1, Robert Campbell <rob@techcom.dyndns.org>
#
#-------------------------------------------------------------------------
...
// 	      }
  ...
  function _GetRepositoryModules()
  {
	...
	$_SESSION['modulemanager_cache'] = $modules;
      }
    else
      {
	$modules = $_SESSION['modulemanager_cache'];
      }
    ...
    foreach( $modules as $module )
      {
	$details = array();
	if( !isset( $_SESSION['modulemanager_cache_'.$module] ) || 
	    !is_array( $_SESSION['modulemanager_cache_'.$module] ) )
	  {
	    $details = $nu_soapclient->call('ModuleRepository.soap_moduledetails',array('name' => $module ));
	    $_SESSION['modulemanager_cache_'.$module] = $details;
	  }
	else
	  {
	    $details = $_SESSION['modulemanager_cache_'.$module];
	  }
