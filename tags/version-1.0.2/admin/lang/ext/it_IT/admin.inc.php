...
$lang['admin']['errorcantcreatefile'] = 'Non posso crare un file (problemi di permissi?)';
...
$lang['admin']['errormodulewontload'] = 'Problema nell&#039;instanziare un modulo utilizzabile';
...
$lang['admin']['jsdisabled'] = 'Spaicente, questa funzione richiede i Javascript abilitati.';
...
$lang['admin']['aliasalreadyused'] = 'Alias gi&agrave; in uso per altra pagina. Cambiate &quot;Page Alias&quot; nel tab &quot;Options&quot; a qualcosa d&#039;altro.';
...
$lang['admin']['confirmcancel'] = 'Siete sicuri di voler annullare i cambiamenti? Click OK per annullare tutti i cambiamenti. Click Cancel per continuare le modifiche.';
...
$lang['admin']['errorcouldnotparsexml'] = 'Errore nell&#039;analisi del file XML';
$lang['admin']['errorcreatingassociation'] = 'Errore creando l&#039;associazione';
$lang['admin']['errorcssinuse'] = 'Questo CSS &egrave; ancora in uso da pagine o template. Si prega di rimuovere prima queste associazioni.';
...
$lang['admin']['cachenotwritable'] = 'La cartella Cache non &egrave; scrivibile. La pulizia della cache non lavora correttamente. Si prega di modificare i permessi della cartella tmp/cache per la piena lettura/scrittura/esecuzione (chmod 777)';
$lang['admin']['modulesnotwritable'] = 'La cartella dei moduli non &egrave; scrivibile, se volete installare i moduli uploading il file XML dovete modificare i permessi della cartella dei moduli per la piena lettura/scrittura/esecuzione (chmod 777).';
$lang['admin']['noxmlfileuploaded'] = 'Nessun file &egrave; stato uploaded. Per installare un modulo via XML dovete scegliere e upload un file modulo (.xml) dal vostro computer.';
...
$lang['admin']['eventhandlers'] = 'Associazioni eventi';
...
$lang['admin']['setallcontent'] = 'Attribuite tutto il contenuto';
...
$lang['admin']['gcb_wysiwyg'] = 'Abilita GCB WYSIWYG';
$lang['admin']['gcb_wysiwyg_help'] = 'Abilita l&#039;editor WYSIWYG per editare Blocchi di contenuto';
...
$lang['admin']['attachtemplate'] = 'Assegnatelo a questo Modello';
...
$lang['admin']['hide_help_links_help'] = 'Check questo box per disabilitare il wiki e i link di aiuto del modulo nell&#039;intestazione della pagina.';
...
$lang['admin']['mediatype_projection'] = 'projection : Inteso per presentationi, per esempio proiezioni o stampa di lucidi.';
...
$lang['admin']['utmz'] = '156861353.1157407430.3.3.utmccn=(referral)|utmcsr=dev.cmsmadesimple.org|utmcct=/|utmcmd=referral';
$lang['admin']['utma'] = '156861353.1861570971.1156160505.1157321899.1157407430.3';
