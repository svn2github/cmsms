...
$lang['admin']['forgotpwprompt'] = 'Voer uw gebruikersnaam in.<br />Er zal een email met verdere informatie worden verstuurd naar het bekende mailadres bij deze naam';
...
$lang['admin']['css_max_age'] = 'Maximale tijd (seconden) die stylesheets gebufferd mogen worden in de browser';
...
$lang['admin']['help_function_current_date'] = '	<h3>What doet dit?</h3>
	<p>Geeft de huidige datum en tijd weer. Wanneer er geen formaat is gegeven zal deze een standaard formaat hebben als &#039;Jan 01, 2004&#039;.</p>
	<h3>Hoe wordt dit gebruikt?</h3>
	<p>Voeg simpelweg de tag in jouw template/pagina als: <code>{current_date format=&quot;%A %d-%b-%y %T %Z&quot;}</code></p>
	<h3>Welke parameters gebruikt het?</h3>
	<ul>
		<li><em>(optioneel)</em>format - Datum/Tijd formaat gebruik makend van de parameters van php&#039;s strftime functie.  Kijk <a href="http://php.net/strftime" target="_blank">hier</a> voor een parameter lijst en informatie.</li>
		<li><em>(optioneel)</em>ucword - Indien &quot;waar&quot; maakt dit een hoofdletter van de eerste letter van elk woord.</li>
	</ul>
	</p>';
...
$lang['admin']['event_desc_moduleupgraded'] = 'Verzonden nadat een module is ge&uuml;pgrade';
$lang['admin']['event_desc_moduleinstalled'] = 'Verzonden nadat een module is ge&iuml;nstalleerd';
$lang['admin']['event_desc_moduleuninstalled'] = 'Verzonden nadat een module is gede&iuml;nstalleerd';
...
$lang['admin']['users'] = 'Back-end Gebruikers';
$lang['admin']['usersdescription'] = 'Hier beheert u de back-end gebruikers van deze website';
$lang['admin']['groups'] = 'Back-end Groepen';
$lang['admin']['groupsdescription'] = 'Hier beheert u de back-end gebruikersgroepen';
$lang['admin']['groupassignments'] = 'Back-end Groepstoekenningen';
$lang['admin']['groupassignmentdescription'] = 'Hier kunt u back-end gebruikers aan groepen toewijzen.';
$lang['admin']['groupperms'] = 'Back-end Groepsrechten';
...
$lang['admin']['recoveryemailsent'] = 'Email verzonden naar het bekende mailadres. Controleer uw Postvak In van uw mail programma voor verdere instructies';
...
$lang['admin']['utma'] = '156861353.799969050.1225024056.1248533999.1248632946.416';
$lang['admin']['utmz'] = '156861353.1247839126.410.68.utmccn=(referral)|utmcsr=ernas-ongezouten-website.nl|utmcct=/admin/moduleinterface.php|utmcmd=referral';
