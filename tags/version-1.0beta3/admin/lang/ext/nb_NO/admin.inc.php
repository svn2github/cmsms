...
$lang['admin']['event_desc_adduserdefinedtagpre'] = 'Sendt f&oslash;r en bruekrdefinert tagg blir satt inn';
$lang['admin']['global_umask'] = 'Fil opprettelse maske (umask)';
$lang['admin']['errorcantcreatefile'] = 'Kunne ikke lage en fil (rettighetsproblem?)';
$lang['admin']['errormoduleversionincompatible'] = 'Modulen er ikke kompativel med denne CMS versjonen';
...
$lang['admin']['errorinstallfialed'] = 'Modul-installasjonen feilet';
...
$lang['admin']['info_edituser_password'] = 'Endre dete feltet for &aring; endre brukerens passord';
$lang['admin']['info_edituser_passwordagain'] = 'Endre dete feltet for &aring; endre brukerens passord';
$lang['admin']['originator'] = 'Opprinnelse (Originator)';
$lang['admin']['module_name'] = 'Modulnavn';
$lang['admin']['event_name'] = 'Hendelsesnavn';
$lang['admin']['event_description'] = 'Hendelsesbeskrivelse';
$lang['admin']['error_delete_default_parent'] = 'Du kan ikke slette en forelder til standardsiden.';
$lang['admin']['jsdisabled'] = 'Beklager, denne funksjonen krever at du tillater Javascript i din nettleser.';
$lang['admin']['order'] = 'Rekkef&oslash;lge';
...
$lang['admin']['sibling_duplicate_order'] = 'To s&oslash;sken-sider kan ikke ha den samme rekkef&oslash;lge. Sidene ble ikke omsortert.';
$lang['admin']['no_orders_changed'] = 'Du valgte omsortere sider, men du har ikke endret rekkef&oslash;lge p&aring; dem. Sidene ble derfor ikke omsortert.';
$lang['admin']['order_too_small'] = 'En side rekkef&oslash;lge kan ikke v&aelig;re null. Sidene ble ikke omsortert.';
$lang['admin']['order_too_large'] = 'En side-rekkef&oslash;lgekan ikke v&aelig;re st&oslash;rre enn antall sider p&aring; samme niv&aring;. Sidene ble ikke omsortert.';
...
$lang['admin']['changepermissionsconfirm'] = 'V&AElig;R FORSIKTIG\n\nDene handling vil pr&oslash;ve &aring; sikre at alle filene som utgj&oslash;r denne modulen er skrivbare for websrveren..\nEr du sikker p&aring; du vil fortsette?';
...
$lang['admin']['aliasalreadyused'] = 'Alias har allerede blitt brukt p&aring; en annen side. Endre  &quot;Side alias&quot; i &quot;Innstillinger&quot; fanen til noe annet';
...
$lang['admin']['cantchmodfiles'] = 'Kunne ikke endre rettigheter p&aring; noen filer';
$lang['admin']['cantremovefiles'] = 'Problem med &aring; fjerne filer (rettigheter?)';
$lang['admin']['confirmcancel'] = 'Er du sikker p&aring; du vil angre dine endringer? Klikk OK for &aring; angre endirnger. Klikk Angre/Cancel for &aring; fortsette redigeringen.';
...
$lang['admin']['errorcouldnotparsexml'] = 'Feil ved parsing av XML file. Kontroller at du laster opp en .xml fil og ikke en .tar.gz eller en zip fil.';
...
$lang['admin']['uploadxmlfile'] = 'Innstaller modul via XML fil';
$lang['admin']['cachenotwritable'] = 'Cache mappa er ikke skrivbar. &Aring; t&oslash;mme cachen vil ikke fungere. Vennligst gi tmp/cache mappa fulle lese/skrive/kj&oslash;re(read/write/execute) tillatelser (chmod 777)';
$lang['admin']['modulesnotwritable'] = 'Modul-mappen er ikke skrivbar. Om du &oslash;nsker &aring; innstallere moduler ved &aring; laste opp en XML-fil s&aring; m&aring; du sette modul-mappen til &aring; ha fulle lese/skrive/kj&oslash;re(read/write/execute) rettigheter (chmod 777).';
$lang['admin']['noxmlfileuploaded'] = 'Ingen fil ble lastet opp. For &aring; innstallere en modul via XML m&aring; du finne og s&aring; laste opp en modul .xml fil fra din databaskin.';
...
$lang['admin']['eventhandlers'] = 'Hendelsesbehandler';
$lang['admin']['editeventhandler'] = 'Rediger Hendelses behandleren(Event Handler)';
$lang['admin']['eventhandlerdescription'] = 'Assosier brukerdefinert tag med hendelse';
...
$lang['admin']['handler'] = 'Handler (brukerdefinert tag)';
...
$lang['admin']['wikihelp'] = 'Hjelp p&aring; Wiki';
...
$lang['admin']['blobexists'] = 'Navn p&aring; Global innholdsblokk er allerede i bruk';
$lang['admin']['blobmanagement'] = 'Administrasjon av Global innholdsblokk';
$lang['admin']['errorinsertingblob'] = 'Det oppstod en feil under innleggelse av Global innholdsblokk.';
$lang['admin']['addhtmlblob'] = 'Legg til Global innholdsblokk';
$lang['admin']['edithtmlblob'] = 'Rediger Global innholdsblokk';
...
$lang['admin']['moduleerrormessage'] = 'Feilmelding %s modulen';
...
$lang['admin']['layout'] = 'Utseende/Layout';
...
$lang['admin']['htmlblobs'] = 'Globale innholdsblokker';
...
$lang['admin']['htmlblobdescription'] = 'Globale innholdsblokker er egendefinerte kodeblokker som du kan plassere og gjenbruke p&aring; dine sider eller maler.';
...
$lang['admin']['user_created'] = 'Bruker opprettet';
$lang['admin']['forums'] = 'Forum';
$lang['admin']['wiki'] = 'Wiki ';
$lang['admin']['irc'] = 'IRC ';
$lang['admin']['module_help'] = 'Modul Hjelp';
...
$lang['admin']['admincallout'] = 'Admin. snarveier';
$lang['admin']['showbookmarks'] = 'Vis Admin.bokmerkene';
$lang['admin']['hide_help_links'] = 'Skjul hjelpe-lenker';
...
$lang['admin']['mediatype_print'] = 'print : Ment for ark, ugjennomsiktig materiale og for dokumenter vist p&aring; skjerm i utskrift forh&aring;ndsvisnings modus.';
...
$lang['admin']['mediatype_tty'] = 'tty : Ment for media som bruker en fikserte-pitch tegn nett, for eksempel teletype og teminaler.';
...
$lang['admin']['siteadmin'] = 'Administrator for nettstedet';
...
<h4>Parametere</h4>
<ul>
<li>&#039;user&#039; - Referanse til det affekterte bruker objektet.</li>
</ul>';
$lang['admin']['event_help_logoutpost'] = '<p>Sendt etter en bruker loggere seg ut fra administrasjonpanelet.</p>
<h4>Parametere</h4>
<ul>
<li>&#039;user&#039; - Referanse til det affekterte bruker objectet.</li>
</ul>';
...
<h4>Parametere</h4>
<ul>
<li>&#039;group&#039; - Referanse til det affekterte gruppe objektet.</li>
</ul>';
...
<h4>Parametere</h4>
<ul>
<li>&#039;stylesheet&#039; - Referanse til det affekterte stilsett objektet.</li>
</ul>';
...
<h4>Parametere</h4>
<ul>
<li>&#039;stylesheet&#039; - Referanse til det affekterte stilsettet objektet.</li>
</ul>';
$lang['admin']['event_help_addtemplatepre'] = '<p>Sendt f&oslash;r en ny mal blir opprettet.</p>
<h4>Parametere</h4>
<ul>
<li>&#039;template&#039; - Referanse til det affekterte mal objektet.</li>
</ul>';
...
<h4>Parametere</h4>
<ul>
<li>&#039;template&#039; - Referanse til den affekterte mal teksten.</li>
</ul>';
...
<h4>Parametere</h4>
<ul>
<li>&#039;global_content&#039; - Referanse til det affekterte global innholdsblokk objektet.</li>
</ul>';
$lang['admin']['event_help_addglobalcontentpost'] = '<p>Sendt etter en ny global innholdsblokk har blitt opprettet.</p>
<h4>Parametere</h4>
<ul>
<li>&#039;global_content&#039; - Referanse til det affekterte globale innholdsblokk objektet.</li>
</ul>';
...
<h4>Parametere</h4>
<ul>
<li>&#039;global_content&#039; - Referanse til den affekterte globale innholdsblokk teksten.</li>
</ul>';
...
<h4>Parametere</h4>
<ul>
<li>&#039;global_content&#039; - Referanse til det affekterte innholds objektet.</li>
</ul>';
$lang['admin']['event_help_contenteditpost'] = '<p>Sendt etter endring av innhold ble lagret.</p>
<h4>Parametere</h4>
<ul>
<li>&#039;content&#039; - Referanse til det affekterte innholds objektet.</li>
</ul>';
...
$lang['admin']['filterbymodule'] = 'Filtrer p&aring; modul';
$lang['admin']['showall'] = 'Vis alt';
$lang['admin']['core'] = 'Core/kjerne';
$lang['admin']['utma'] = '156861353.1946822495.1154336060.1154336060.1154337928.2';
$lang['admin']['utmb'] = '156861353';
$lang['admin']['utmc'] = '156861353';
$lang['admin']['utmz'] = '156861353.1154337928.2.2.utmccn=(referral)|utmcsr=forum.cmsmadesimple.org|utmcct=/index.php/topic,5867.15.html|utmcmd=referral';
?>