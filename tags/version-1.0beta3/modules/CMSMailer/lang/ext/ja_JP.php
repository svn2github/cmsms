...
$lang['prompt_testaddress'] = 'メールアドレスをテスト';
$lang['sendtest'] = 'テストメッセージを送信';
$lang['password'] = 'パスワード';
$lang['username'] = 'ユーザ名';
$lang['smtpauth'] = 'SMTP認証';
$lang['mailer'] = 'メーラーメソッド';
$lang['host'] = 'SMTPホスト名<br/><i>(もしくはIPアドレス)</i>';
$lang['port'] = 'SMTPサーバーポート';
$lang['from'] = 'アドレスから';
$lang['fromuser'] = 'ユーザー名から';
$lang['sendmail'] = 'Sendmail location';
$lang['timeout'] = 'SMTPタイムアウト';
$lang['submit'] = '送信';
$lang['cancel'] = '中止';
$lang['info_mailer'] = '使用メールメソッド(sendmail, smtp, mail).  通常はsmtpが最も信頼できます。';
$lang['info_host'] = 'SMTPホスト名(smtpメーラーメソッドにのみ有効)';
$lang['info_port'] = 'SMTPポート番号(通常は25)(smtpメーラーメソッドにのみ有効)';
$lang['info_from'] = '全メールで送信者として使用されているアドレス';
$lang['info_fromuser'] = 'Friendly name used for sending all emails';
$lang['info_sendmail'] = 'sendmail実行ファイルへの完全パス(sendmailメーラーメソッドの場合にのみ有効)';
$lang['info_timeout'] = 'The number of seconds in an SMTP conversation before an error occurs (valid for the smtp mailer method)';
$lang['info_smtpauth'] = 'smtpホストには認証が必要です。 (smtpメーラーメソッドにのみ有効)';
$lang['info_username'] = 'SMTP認証ユーザ名(smtp認証を選択時、smtpメーラーメソッドにのみ有効)';
$lang['info_password'] = 'SMTP認証パスワード(smtp認証を選択時、smtpメーラーメソッドにのみ有効)';
