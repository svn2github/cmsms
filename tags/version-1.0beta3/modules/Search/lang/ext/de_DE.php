...
$lang['param_resultpage'] = 'Seite, auf der die Ergebnisse angezeigt werden sollen. Dies kann entweder ein Seiten-Alias oder eine ID sein. Damit k&ouml;nnen die Suchergebnisse in einem anderem Template als das Suchformular angezeigt werden.';
$lang['description'] = 'Modul f&uuml;r die Suche auf der Seite und den Inhalten der Module.';
...
$lang['eventdesc-SearchInitiated'] = 'Absenden, wenn eine Suche gestartet wurde.';
$lang['eventdesc-SearchCompleted'] = 'Absenden, wenn eine Suche beendet wurde.';
$lang['eventdesc-SearchItemAdded'] = 'Absenden, wenn ein neuer Eintrag indiziert wurde.';
$lang['eventdesc-SearchItemDeleted'] = 'Absenden, wenn ein Eintrag aus dem Index gel&ouml;scht wurde.';
$lang['eventdesc-SearchAllItemsDeleted'] = 'Absenden, wenn alle Eintr&auml;ge aus dem Index gel&ouml;scht wurden.';
$lang['eventhelp-SearchInitiated'] = '<p>Absenden, wenn eine Suche gestartet wurde.</p>
<h4>Parameter</h4>
<ol>
<li>Text, nach dem gesucht wird.</li>
</ol>
';
$lang['eventhelp-SearchCompleted'] = '<p>Absenden, wenn eine Suche beendet wurde.</p>
<h4>Parameter</h4>
<ol>
...
';
$lang['eventhelp-SearchItemAdded'] = '<p>Absenden, wenn ein neuer Eintrag indiziert wurde.</p>
<h4>Parameter</h4>
<ol>
<li>Modulename.</li>
...
';
$lang['eventhelp-SearchItemDeleted'] = '<p>Absenden, wenn ein Eintrag aus dem Index gel&ouml;scht wurde.</p>
<h4>Parameter</h4>
<ol>
<li>Modulname.</li>
...
';
$lang['eventhelp-SearchAllItemsDeleted'] = '<p>Absenden wenn alle Eintr&auml;ge aus dem Index gel&ouml;scht wurden.</p>
<h4>Parameter</h4>
<ul>
<li>Keine</li>
</ul>
...
<p>Das Search-Modul durchsucht grunds&auml;tzlich keine &quot;inaktiven&quot; Seiten. Wenn Sie aus welchen Gr&uuml;nden auch immer das CustomContent-Modul oder andere Smarty-Logik verwenden, um verschiedenen Usergruppen verschiedene Inhalte zu pr&auml;sentieren, kann es erforderlich sein, die gesamte Seite von einer Indizierung auszuschlie&szlig;en.  Daf&uuml;r m&uuml;ssen Sie lediglich den folgenden Tag irgendwo in Ihrer Seite aufrufen <em><!-- pageAttribute: NotSearchable --></em> Wenn das Search-Modul diesen Tag auf einer Seite findet, wird kein Inhalt dieser Seite indiziert.</p>
<p>Der Tag <em><!-- pageAttribute: NotSearchable --></em> kann auch in Templates eingesetzt werden. In diesem Fall werden keine der Seiten, die dieses Template verwenden, indiziert. Wenn der Tag entfernt wird, erfolgt eine Neuindizierung.</p>';
