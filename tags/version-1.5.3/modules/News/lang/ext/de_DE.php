...
$lang['msg_contenttype_removed'] = 'Der Inhaltstyp &bdquo;News&ldquo; wird nicht mehr unterst&uuml;tzt. Bitte verwenden Sie in Ihren Seitenvorlagen bzw. -inhalten anstatt dessen den {news}-Tag mit den entsprechenden Parametern.';
...
$lang['approve'] = 'Den Status auf &bdquo;ver&ouml;ffentlicht&ldquo; setzen';
$lang['revert'] = 'Den Status auf &bdquo;Entwurf&ldquo; setzen';
...
$lang['summarytemplateupdated'] = 'Das aktualisierte Zusammenfassungsvorlage wurde in der Datenbank gespeichert.';
$lang['title'] = 'Titel';
...
<table>
  ...
  <thead>
    <tr>
       <th>Parameter</th><th>Aktion</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th>news_id</th><td>ID des News-Artikels</td>
    </tr>
    <tr>
      <th>category_id</th><td>ID der Kategorie f&uuml;r diesen Artikel</td>
    </tr>
    <tr>
      <th>title</th><td>Titel des Artikels</td>
    </tr>
    <tr>
      <th>content</th<td>Inhalt des Artikels</td>
    </tr>
    <tr>
      <th>summary</th><td>Zusammenfassung des Artikels</td>
    </tr>
    <tr>
      <th>status</th><td>Status des Artikels (&bdquo;Entwurf/draft&ldquo; oder &bdquo;ver&ouml;ffentlichen/publish&ldquo;)</td>
    </tr>
    <tr>
      <th>start_time</th><td>Datum, ab dem der Artikel angezeigt werden soll</td>
    </tr>
    <tr>
      <th>end_time</th><td>Datum, ab dem der Artikel nicht mehr angezeigt werden soll</td>
    </tr>
    <tr>
      <th>useexp</th><td>das Verfallsdatum soll ignoriert werden oder auch nicht</td>
    </tr>
  </tbody>
</table>
';
$lang['eventdesc-NewsArticleEdited'] = 'Ausf&uuml;hren, wenn ein Artikel bearbeitet wurde.';
$lang['eventhelp-NewsArticleEdited'] = '<p>Ausf&uuml;hren, wenn ein Artikel hinzugef&uuml;gt wurde.</p>
<table>
  <caption>Parameter</caption>
  <thead>
    <tr>
...
$lang['eventhelp-NewsArticleDeleted'] = '<p>Ausf&uuml;hren, wenn ein Artikel hinzugef&uuml;gt wurde.</p>
<table>
  <caption>Parameter</caption>
  <thead>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      <th>category_id</th><td>ID der Nachrichtenkategorie</td>
    </tr>
    <tr>
      <th>name</th><td>Name der Nachrichtenkategorie</td>
    </tr>
  </tbody>
</table>';
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <th>origname</th><td>urspr&uuml;nglicher Name der Nachrichtenkategorie</td>
    </tr>
  </tbody>
</table>';
...
<table>
  ...
  <tbody>
    <tr>
      <th>category_id</th><td>ID der gel&ouml;schten Nachrichtenkategorie</td>
    </tr>
    <tr>
      <th>name</th><td>Name der gel&ouml;schten Nachrichtenkategorie</td>
    </tr>
  </tbody>
</table>';
$lang['help_articleid'] = 'Dieser Parameter funktioniert nur in der Detailansicht. Mit ihm kann vorgegeben werden, welcher Artikel im Detail-Modus angezeigt werden soll. Wird an dieser Stelle der Wert -1 verwendet, wird der neueste ver&ouml;ffentliche, nicht abgelaufene Artikel angezeigt.';
...
$lang['helpdetailpage'] = 'Seite, auf der die Nachrichtendetails angezeigt werden. Das kann entweder ein Seiten-Alias oder eine Seiten-ID sein. Damit k&ouml;nnen die Nachrichtendetails in einer anderen Vorlage als die Nachrichtenzusammenfassung angezeigt werden.';
...
<p>In der News-Modul-Version 2.9 und h&ouml;her wurde sowohl das Variablenelement <code>$entry->formatpostdate</code> als auch der Parameter &bdquo;dateformat&ldquo; entfernt. Sie sollten daher anstatt <code>$entry->formatpostdate</code> jetzt <code>$entry->postdate</code> verwenden. Das Datum kann dann mit dem Modifikator &bdquo;cms_date_format&ldquo; formatiert werden (wie in den mitgelieferten Mustervorlagen gezeigt).</p>
	...
	<p>Am einfachsten kann das Modul mit dem {news}-Tag verwendet werden. Dieser f&uuml;gt die Ausgabe des Moduls in ihre Vorlage oder Seite ein und zeigt die News-Eintr&auml;ge an. Der einzuf&uuml;gende Code sollte so aussehen: <code>{news number=&#039;5&#039;}</code></p>
<h3>Vorlagen</h3>
	<p>Seit Version 2.3 werden die Vorlagen des News-Moduls in der Datenbank gespeichert. Dateibasierte Vorlagen werden nicht mehr unterst&uuml;tzt. Wenn Sie noch dateibasierte Vorlagen verwenden, sollten Sie mit der folgenden Anleitung jede verwendete (dateibasierte) Vorlagen importieren:</p>
<ul>
<li>Kopieren Sie den Inhalt Ihrer Vorlagendatei in den Zwischenspeicher Ihres Rechners.</li>
<li>Erstellen Sie eine neue Datenbankvorlage <em>(je nach Bedarf f&uuml;r die Zusammenfassungs- oder Detailansicht)</em>. Geben Sie der neuen Vorlage den gleichen Namen wie die alte Vorlage (einschlie&szlig;lich der Endung .tpl). F&uuml;gen Sie den Inhalt des Zwischenspeichers ein.</li>
<li>Klicken Sie auf &bdquo;Absenden&ldquo;</li>
</ul>
<p>Mit diesem Ablauf sollte sichergestellt sein, dass Fehlermeldungen &uuml;ber Vorlagen, die nicht gefunden werden oder &auml;hnliche Smarty-Fehler, nicht auftreten, wenn auf eine CMSms-Version aktualisiert wird, die das News-Modul 2.3 oder h&ouml;her verwendet.</p>
<h4>Vorlagenvariablen</h4>
	<ul>
...
$lang['utma'] = '156861353.717462736.1147511856.1213782764.1234888676.321';
$lang['utmb'] = '156861353';
$lang['utmc'] = '156861353';
