 ...
 */
 ...
 function DoResponse($enable_thumbs, $root_url)
 {
   ...
   if ( $sCommand == 'FileUpload' ) {
     ...
     if ( isset( $_FILES['NewFile'] ) && isset( $_FILES['NewFile']['name'] ) && isset( $_FILES['NewFile']['size'] ) ) {
       if ( $_FILES['NewFile']['size'] > $GLOBALS['gCms']->config['max_upload_size'] ) {
         // It'd be nice to throw a more verbose error message in here, but that's a lot more modification, and internationalization
         $sErrorNumber = '202';
