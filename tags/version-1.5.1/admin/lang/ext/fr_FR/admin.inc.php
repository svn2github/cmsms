...
<ul>
<li><strong>item (requis)</strong> - The smarty variable to dump the contents of.</li>
...
$lang['admin']['connection_error'] = 'Les connexions sortantes http semblent ne pas fonctionner ! V&eacute;rifier le pare-feu ou les connexions externes. Vous pouvez avoir des difficult&eacute;s avec le Gestionnaire de Modules et, potentiellement, avec d&#039;autres fonctionnalit&eacute;s.';
$lang['admin']['remote_connection_timeout'] = 'Expiration du d&eacute;lai de connexion !';
$lang['admin']['search_string_find'] = 'Connection Ok !';
$lang['admin']['connection_failed'] = 'Echec de la connection !';
...
$lang['admin']['help_function_stopexpandcollapse'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Permet au contenu d&#039;&ecirc;tre affich&eacute; ou masqu&eacute;. Comme ceci :<br />
...
$lang['admin']['help_function_sitename'] = '        <h3>Que fait cette Balise ?</h3>
        ...
        <h3>Quels param&egrave;tres ?</h3>
        <p><em>(optionnel)</em> assign (string) - Enregistre le r&eacute;sultat dans une variable smarty avec le nom &#039;string&#039;.</p>';
...
$lang['admin']['help_function_oldprint'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{oldprint}</code><br></p>
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
                <li><em>(optionnel)</em> goback - D&eacute;fini &agrave; &quot;true&quot; pour montrer un lien &quot;Go Back&quot; sur la page &agrave; imprimer.</li>
                <li><em>(optionnel)</em> popup - D&eacute;fini &agrave; &quot;true&quot;, la page &agrave; imprimer sera ouverte dans une nouvelle fen&ecirc;tre.</li>
                <li><em>(optionnel)</em> script - D&eacute;fini &agrave; &quot;true&quot;, le javascript sera utilis&eacute; pour mener l&#039;impression de la page.</li>
                <li><em>(optionnel)</em> showbutton - D&eacute;fini &agrave; &quot;true&quot;, on verra une ic&ocirc;ne d&#039;imprimante au lieu d&#039;un lien en texte.</li>
                <li><em>(optionnel)</em> class - classe CSS pour le lien, par d&eacute;faut &agrave;  &quot;noprint&quot;.</li>
                <li><em>(optionnel)</em> text - Texte &agrave; utiliser &agrave; la place de &quot;Print This Page&quot; pour le lien d&#039;impression.
                <li><em>(optionnel)</em> title - Texte pour l&#039;attribut Title. Si vide, montre le param&egrave;tre text.</li>
                <li><em>(optionnel)</em> more - Place des options suppl&eacute;mentaires dans le lien <a>.</li>
                <li><em>(optionnel)</em> src_img - Montre cette image. L&#039;image par d&eacute;faut est images/cms/printbutton.gif.</li>
                <li><em>(optionnel)</em> class_img - Classe de la balise <img> si showbutton est d&eacute;fini.</li>
...
$lang['admin']['help_function_metadata'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
		<li><em>(optional)</em>showbase (true/false) - Si d&eacute;fini &agrave; false, la balise de base ne sera pas envoy&eacute;e au navigateur. D&eacute;fini par d&eacute;faut &agrave; true si use_hierarchy est d&eacute;fini &agrave; true dans config.php.</li>
	</ul>';
...
$lang['admin']['help_function_menu'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est une balise pour le <a href="listmodules.php?action=showmodulehelp&amp;module=MenuManager">module Menu Manager</a> pour simplifier la syntaxe. 
...
$lang['admin']['help_function_last_modified_by'] = '        <h3>Que fait cette Balise ?</h3>
        ...
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
                <li><em>(optionnel)</em>format - id, username, fullname</li>
        </ul>';
...
$lang['admin']['help_function_imagegallery'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Cr&eacute;e une galerie &agrave; partir d&#039;un dossier d&#039;images (.gif, .jpg or .png). 
...
$lang['admin']['utmz'] = '156861353.1213633133.148.31.utmccn=(referral)|utmcsr=forum.cmsmadesimple.org|utmcct=/index.php|utmcmd=referral';
$lang['admin']['utma'] = '156861353.1911476159.1190810560.1213860428.1213866333.154';
?>