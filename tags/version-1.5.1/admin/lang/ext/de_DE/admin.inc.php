...
<li><tt><em>(optional)</em> recurse</tt> -- Recurse a maximum number of levels through the objects providing verbose output for each item bis die maximale Anzahl der Ebenen erreicht ist.</li>
</ul>';
