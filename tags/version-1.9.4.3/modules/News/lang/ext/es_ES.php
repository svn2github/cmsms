<?php
$lang['info_detail_returnid'] = 'Esta preferencia se usa para determinar una pagina (y por ende una plantilla) para usar para la vista detallada. URLs Individualizadas para detalles de Noticias no funcionara si este parametro no est&aacute; establecido a una pagina valida. Adicionalmente, si esta preferencia est&aacute; establecida, y no se proporciona el parametro &#039;detailpage&#039; en la etiqueta de noticias, entonces este valor ser&aacute; utilizado para los enlaces de detalle.';
$lang['title_detail_returnid'] = 'Pagina por defecto para usar para las vistas detalladas';
$lang['title_submission_settings'] = 'Ajustes de envio de Noticias';
$lang['title_fesubmit_settings'] = 'Ajustes de envio a traves de la pagina frontal';
$lang['title_notification_settings'] = 'Ajustes de notificaci&oacute;n';
$lang['title_detail_settings'] = 'Ajustes de vista detallada';
$lang['error_invalidurl'] = 'URL Inv&aacute;lida <em>(puede que est&eacute; en uso, o contiene caracteres inv&aacute;lidos)</em>';
$lang['url'] = 'URL ';
...
$lang['status_asc'] = 'Status Ascendiente';
