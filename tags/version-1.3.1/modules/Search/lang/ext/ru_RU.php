...
$lang['param_action'] = 'Укажите режим работы для модуля. Допустимые значения \'по умолчанию\', и \'ключевые слова\'. Ключевые слова могут быть использованы для создания, разделенного запятыми списка слов, пригодных для использования в мета-теге keywords.';
$lang['param_count'] = 'Используя этот параметр с ключевыми словами, будет ограничен вывод указанного количества слов';
$lang['param_pageid'] = 'Применяя только с действием ключевых слов, этот параметр может использоваться, чтобы определить различные pageid, для возвращения результатов';
$lang['param_inline'] = 'Если истина, то вывод формы поиска заместит содержимое тега \'search\' в порождающем блоке контента. Используйте этот параметр, если ваш шаблон содержит несколько блоков контента, и вы не хотите чтобы вывод тега \'search\' замещал блок контента по умолчанию. ';
...
$lang['param_modules'] = 'Ограничить количество результатов поиска информацией, проиндексированной в указанных модулях (разделитель - точка с запятой)';
...
$lang['utmz'] = '156861353.1203737068.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
$lang['utma'] = '156861353.1244271357.1203737068.1204956307.1206901052.3';
?>