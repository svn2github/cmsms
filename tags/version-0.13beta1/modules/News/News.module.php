...
class News extends CMSModule
{
	...
	{
		$this->RegisterRoute('/(?P<module>News)\/(?P<articleid>[0-9]+)\/(?P<returnid>[0-9]+)$/');
		$this->RegisterRoute('/(?P<module>News)\/(?P<articleid>[0-9]+)$/', array('returnid'=>'1'));
		$this->RegisterRoute('/(?P<module>News)\/(?P<action>rss)\/(?P<category>.*?)$/', array('showtemplate'=>'false'));
		$this->RegisterRoute('/(?P<module>News)\/(?P<action>rss)$/', array('showtemplate'=>'false'));
