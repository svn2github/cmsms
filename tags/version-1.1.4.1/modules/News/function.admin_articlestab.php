...
$sortlist = array();
$sortlist['Post Date Descending']='news_date DESC';
$sortlist['Post Date Ascending']='news_date ASC';
$sortlist['Expiry Date Descending']='end_time DESC';
$sortlist['Expiry Date Ascending']='end_time ASC';
$sortlist['Title Ascending'] = 'news_title ASC';
$sortlist['Title Descending'] = 'news_title DESC';

$smarty->assign('prompt_category',$this->Lang('category'));
$smarty->assign('input_category',
		$this->CreateInputDropdown($id,'newcategory',$categorylist,-1,$newcategory));
...
$smarty->assign('input_pagelimit',
		$this->CreateInputDropdown($id,'pagelimit',
					   array('5'=>5,'25'=>25,'50'=>50,
						 '100'=>100,'500'=>500,'1000'=>1000,'unlimited'=>999999999),-1,$pagelimit));
$smarty->assign('hidden',
		$this->CreateInputHidden($id,'curcategory',$curcategory));
