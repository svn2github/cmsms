<?php
$lang['error_uploadpermissions'] = '<strong><em>ATTENZIONE:</em></strong> Permessi insufficienti per upload o installare i Temi. Potrebbe essere dovuto a permessi alle subdirectory o alla presenza del PHP Safe mode.';
