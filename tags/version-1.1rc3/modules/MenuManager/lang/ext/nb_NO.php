...
$lang['changelog'] = '	<ul>
	<li>1.1 -- Lagt til behandling av target(m&aring;l) parameteren, hovedsaklig for Link innholdstypen</li>
...
$lang['help_includeprefix'] = 'Injluder kun de punktene hvor sidealias starter med den spesifiserte forstavelsen. Denne parameteren kan ikke kombineres med excludeprefix (utelatprefiks) parameteren.';
