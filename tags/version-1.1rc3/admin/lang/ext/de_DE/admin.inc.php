...
$lang['admin']['confirmdefault'] = 'Wollen Sie wirklich die Seite - %s - als Startseite f&uuml;r die Webseite festlegen?';
...
$lang['admin']['cachenotwritable'] = 'Das Cache-Verzeichnis ist nicht beschreibbar. Das Leeren des Caches wird daher nicht funktionieren. Bitte stellen Sie sicher, dass das Verzeichnis tmp/cache die vollen Lese-/Schreib- und Ausf&uuml;hrungsrechte hat (chmod 777). Sie sollte auch den Safe-Modus Ihres Servers deaktivieren.';
...
$lang['admin']['errorinsertingcss'] = 'Beim Erstellen des Stylesheets in der Datenbank ist ein Fehler aufgetreten.';
$lang['admin']['errorinsertinggroup'] = 'Beim Erstellen der Gruppe in der Datenbank ist ein Fehler aufgetreten.';
$lang['admin']['errorinsertingtag'] = 'Beim Erstellen des benutzerdefinierten Tags in der Datenbank ist ein Fehler aufgetreten.';
$lang['admin']['errorinsertingtemplate'] = 'Beim Erstellen des Templates in der Datenbank ist ein Fehler aufgetreten.';
$lang['admin']['errorinsertinguser'] = 'Beim Erstellen des Benutzers in der Datenbank ist ein Fehler aufgetreten.';
$lang['admin']['errornofilesexported'] = 'Beim XML-Export der Datei ist ein Fehler aufgetreten.';
$lang['admin']['errorretrievingcss'] = 'Beim Erstellen des Stylesheets in der Datenbank ist ein Fehler aufgetreten.';
$lang['admin']['errorretrievingtemplate'] = 'Beim Erstellen des Templates in der Datenbank ist ein Fehler aufgetreten.';
...
$lang['admin']['helpaddtemplate'] = '<p>Templates definieren das Aussehen Ihrer Webseite.</p><p>Legen Sie hier das Layout an und f&uuml;gen &uuml;ber den Stylesheetbereich die CSS-Anweisungen f&uuml;r die verschiedenen Bereiche hinzu.</p>';
...
$lang['admin']['previewdescription'] = 'Vorschau-&Auml;nderungen';
...
$lang['admin']['htmlblobdescription'] = 'Globalen Inhaltsbl&ouml;cke sind kleine Inhaltsteile, die Sie in Seiten oder Templates einf&uuml;gen k&ouml;nnen (bei Bedarf auch mehrfach).';
$lang['admin']['templates'] = 'Templates';
$lang['admin']['templatesdescription'] = 'Hier k&ouml;nnen Sie Templates anlegen und bearbeiten. &Uuml;ber Templates wird das Aussehen Ihrer Webseite definiert.';
...
$lang['admin']['sitedownwarning'] = '<strong>Warnung:</strong> Auf Ihrer Seite wird aktuell eine Wartungsmeldung angezeigt. Um dies r&uuml;ckg&auml;ngig zu machen, m&uuml;ssen Sie die Datei %s entfernen.';
...
$lang['admin']['error_udt_name_whitespace'] = 'Fehler: Benutzerdefinierte Tags d&uuml;rfen in ihren Namen keine Leerzeichen enthalten.';
$lang['admin']['warning_safe_mode'] = '<strong><em>WARNUNG:</em></strong> Der Safe-Modus (PHP) ist auf Ihrem Server aktiviert. Aufgrund dessen kann es beim Hochladen von Bildern, Themes und Modul-XML-Dateien zu Problemen kommen. Sie sollten daher Ihren Seiten-Administrator befragen, ob er den Safe-Modus deaktiviert.';
...
$lang['admin']['utma'] = '156861353.717462736.1147511856.1178693219.1178871153.144';
$lang['admin']['utmz'] = '156861353.1178871153.144.89.utmccn=(referral)|utmcsr=forum.cmsmadesimple.org|utmcct=/index.php/topic,11977.msg59973.html|utmcmd=referral';
?>