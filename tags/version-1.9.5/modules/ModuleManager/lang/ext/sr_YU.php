...
$lang['error_module_object'] = 'Gre&scaron;ka: could not get an instance of the %s module';
$lang['error_nomatchingmodules'] = 'Gre&scaron;ka: could not find any matching modules in the repository';
$lang['error_nomodules'] = 'Gre&scaron;ka: could not retrieve list of installed modules';
$lang['upgrade_available'] = 'Dostupna je nova verzija (%s), Vi koristite (%s)';
$lang['newversions'] = 'Dostupna pobolj&scaron;anja';
$lang['notice_depends'] = '%s zavisi od sledećih akcija. Kliknite na &quot;Instaliraj&quot; da nastavite sa procedurom.';
...
$lang['msg_nodependencies'] = 'Ovaj fajl nije prijavio nikakve zavisnosti';
...
$lang['error_minimumrepository'] = 'Verzija repozitorijuma nije kompatibilna sa ovim menadžerom modula';
...
$lang['error_checksum'] = 'Gre&scaron;ka pri proveri čeksume.  Ovo verovatno znači da je fajl o&scaron;tećen - ili kada je otpremljen u repozitorij ili je problem nastao tokom preuzimanja na Va&scaron; kompjuter. (očekivana vrednost: %s a izračunata je %s)';
...
$lang['text_repository_url'] = 'URL mora biti u obliku http://www.mycmssite.com/path/soap.php?module=ModuleRepository';
...
$lang['availablemodules'] = 'Tekući status modula sa trenutnog repozitorijuma';
...
$lang['error_nosoapconnect'] = 'Neuspe&scaron;no povezivanje na SOAP server';
$lang['error_soaperror'] = 'Problem sa SOAP servisom';
