...
$lang['changelog'] = '<ul>
<li>版本 1.73.1. 十月, 2005. Initial Release.</li>
<li>版本 1.73.2. 十月, 2005. Minor bug fix with the admin panel.  The dropdown was not representing the current value from the preferences database</li>
<li>版本 1.73.3. 十月, 2005. Minor bug fix with sending html email</li>
<li>版本 1.73.4. 十一月, 2005. Form fields in preferences are larger, fixed a problem with the fromuser, and called reset within the constructor</li>
<li>版本 1.73.5. 十一月, 2005. Added the form fields and functionality for SMTP authentication.</li>
...
<li>版本 1.73.7. January, 2006. Increased field lengths in most fields</li>
<li>版本 1.73.8. January, 2006. Changed the preferences panel to be a bit more descriptive.</li>
<li>版本 1.73.9. January, 2006. Added test email capability, and confirmation on each button (except cancel)</li>
<li>版本 1.73.10. August, 2006. Modified to use lazy loading to minimize memory footprint when CMSMailer is not being used.</li>
<li>版本 1.73.13. January, 2008.  Added more permissions checks.</li>
<li>版本 2.0.1 - January, 2011 - Remove cancel button.</li>
<li>版本 2.0.2 - September, 2011 - Set default charset to utf-8.</li>
</ul>';
...
$lang['utma'] = '156861353.1346647589.1344469519.1344473502.1344483463.3';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353';
?>