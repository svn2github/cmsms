...
class FCKeditorX extends CMSModule
{
  function Install(){
    ...
    $this->SetPreference('FCKConfig.BackgroundTagsCSS', 'default');
  }
  ...
  function Uninstall(){
    ...
    $this->RemovePreference('FCKConfig.BackgroundTagsCSS'); 
  }
      ...
      //GET VALUE SELECTED FROM USER
			if (isset($_REQUEST[$id.'submit']))	{
              ...
              $this->SetPreference('FCKConfig.SkinSelected', $new_skin);
  				...
  				if (isset($_REQUEST[$id.'TagsCSS']))	{
  					$TagsCSS = $_REQUEST[$id.'TagsCSS'];
              $this->SetPreference('FCKConfig.BackgroundTagsCSS', $TagsCSS);
  				}
			...
			$xhtml = $this->GetPreference("FCKConfig.EnableXHTML");
			$context = $this->GetPreference("FCKConfig.ContextMenu");
			$TagsCSS = $this->GetPreference("FCKConfig.BackgroundTagsCSS");
...
<tr>
<td>Background color Tags to use<br/><i>leave BLANK or set DEFAULT <br/>for use PAGE CSS</i></td>
<td>:</td>
<td align="center">
<input type="text" name="<?php echo $id?>TagsCSS" 
value="<?php echo $TagsCSS ?>"></td>
</tr>
<tr>
