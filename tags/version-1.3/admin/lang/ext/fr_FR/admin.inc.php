...
$lang['admin']['clear_version_check_cache'] = 'Effacer la version en cache Coch&eacute; pour soumettre&nbsp;';
...
$lang['admin']['master_admintheme'] = 'Th&egrave;me de l&#039;administration (pour la page de connexion)&nbsp;';
...
$lang['admin']['help_function_current_date'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<ul>
		<li><em>(optional)</em>format - le format de Date/Heure utilisant les param&egrave;tres de la fonction php strftime.  Voir <a href=&quot;http://php.net/strftime&quot; target=&quot;_blank&quot;>ici</a> pour une liste des param&egrave;tres et plus d&#039;information.</li>
		<li><em>(optional)</em>ucword - Si &quot;true&quot; affiche en majuscule la premi&egrave;re lettre de cahque mot.</li>
	</ul>
	</p>';
...
<p>
    <ul>
	<li><em>(optional)</em> url         (string)     -  l&#039;URL utilis&eacute; pour la validation, si aucun n&#039;est entr&eacute;, http://validator.w3.org/check/referer est utilis&eacute;.</li>
	<li><em>(optional)</em> class       (string)     - Si d&eacute;fini, il sera utilis&eacute; comme attribut de la classe pour l&#039;&eacute;l&eacute;ment lien (a)</li>
	<li><em>(optional)</em> target      (string)     - Si d&eacute;fini, il sera utilis&eacute; comme attribut de la cible pour l&#039;&eacute;l&eacute;ment lien (a)</li>
	<li><em>(optional)</em> image       (true/false) - Si d&eacute;fini &agrave; &quot;false&quot;, un lien en texte sera utilis&eacute; &agrave; la place d&#039;une image/ic&ocirc;ne.</li>
	...
	<li><em>(optional)</em> image_class (string)     - Seulement si &#039;image&#039; n&#039;est pas sur &quot;false&quot;. Si d&eacute;fini, il sera utilis&eacute; comme attribut de la classe pour l&#039;&eacute;l&eacute;ment image (img)</li>
	<li><em>(optional)</em> src         (string)     - Seulement si &#039;image&#039; n&#039;est pas sur &quot;false&quot;. L&#039;ic&ocirc;ne &agrave; afficher. L&#039;image par d&eacute;faut est http://www.w3.org/Icons/valid-xhtml10</li>
	<li><em>(optional)</em> width       (string)     - Seulement si &#039;image&#039; n&#039;est pas sur &quot;false&quot;. Largeur de l&#039;image. Par d&eacute;faut &agrave; 88 (largeur de http://www.w3.org/Icons/valid-xhtml10)</li>
	<li><em>(optional)</em> height      (string)     - Seulement si &#039;image&#039; n&#039;est pas sur &quot;false&quot;. Hauteur de l&#039;image. Par d&eacute;faut &agrave; 31 (hauteur de http://www.w3.org/Icons/valid-xhtml10)</li>
	<li><em>(optional)</em> alt         (string)     - Seulement si &#039;image&#039; n&#039;est pas sur &quot;false&quot;. Le texte alternatif (attribut &#039;alt&#039; ) pour l&#039;image (&eacute;l&eacute;ment). Si aucun n&#039;est d&eacute;fini, le texte du lien sera utilis&eacute;.</li>
    </ul>
</p>';
...
$lang['admin']['help_function_startexpandcollapse'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{startExpandCollapse id=&quot;name&quot; title=&quot;Click Here&quot;}</code>. Also, you must use the {stopExpandCollapse} at the end of the collapseable content. Here is an example:<br />
	<br />
	<code>{startExpandCollapse id=&quot;name&quot; title=&quot;Click Here&quot;}<br />
	This is all the content the user will see when they click the title &quot;Click Here&quot; above. It will display all the content that is between the {startExpandCollapse} and {stopExpandCollapse} when clicked.<br />
	{stopExpandCollapse}
...
$lang['admin']['help_function_search'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est simplement une balise pour le <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=Search&quot;>module de recherche</a> pour rendre la syntaxe de balise plus ais&eacute;e. 
...
$lang['admin']['help_function_repeat'] = '  <h3>Que fait cette Balise ?</h3>
  ...
  <h3>Comment l&#039;utiliser ?</h3>
  <p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{repeat string=&#039;repeat this &#039; times=&#039;3&#039;}</code>
  <h3>Quels param&egrave;tres ?</h3>
  <ul>
...
$lang['admin']['help_function_googlepr'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{googlepr}</code><br>
	<br>
...
$lang['admin']['help_function_google_search'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{google_search}</code><br>
	<br>
...
$lang['admin']['help_function_embed'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{embed url=http://www.google.com/}</code><br></p>
...
$lang['admin']['tagtousegcb'] = 'Balise pour utiliser le bloc';
...
$lang['admin']['utmz'] = '156861353.1212529833.126.28.utmcsr=forum.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/index.php/topic,20744.0.html';
$lang['admin']['utma'] = '156861353.1911476159.1190810560.1212774116.1212787152.129';
