...
#(c)2008 by Nuno Costa - nuno.mfcosta@sapo.pt
#
...
<?php
	...
	echo '<div id="clean-container">';
	//LOGO
	echo '<div id="logocontainer"><img src="themes/NCleanGrey/images/logoCMS.png" alt="'. $this->cms->siteprefs['sitename'] .'" title="'. $this->cms->siteprefs['sitename'] .'" /><div class="logotext">'.lang('adminpaneltitle').' - '. $this->cms->siteprefs['sitename'] .'</div></div>';
	...
	function DisplayFooter() {
		...
		//FOOTER
		echo '<div id="footer"><a rel="external" href="http://www.cmsmadesimple.org"><b>CMS Made Simple</b></a> '.$CMS_VERSION.' "' . $CMS_VERSION_NAME . '"<br /><b>CMS Made Simple</b> is free software released under the General Public Licence.<br />Theme designed by <a rel="external" href="http://dev.cmsmadesimple.org/users/nuno/"><b>Nuno Costa</b></a>&nbsp;&nbsp; Icons by <a rel="external" href="http://www.vistaico.com">VistaICO.com</a> </div>
		</div><!--end Nclean-container-->';
		//END
	}
