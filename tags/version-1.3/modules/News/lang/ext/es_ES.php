...
$lang['none'] = 'Ninguno';
$lang['rss_destinationpage'] = 'El ID o Alias de la pagina para articulos de noticias de la transmisi&oacute;n RSS';
...
<li>Version 2.6</li>
<p>Se agregaron Campos Definidos por el Usuario, incluyendo areas de texto, ingredo de texto, cuadros de cheque, y archovos lo cual permite asociar un archivo con un articulo de noticias.</p>
<p>Capacidad de hacer cambios de categoria para articulos de noticias multiples.</p>
<p>Capacidad de borrar articulos de noticias multiples.</p>
<p>Se agreg&oacute; el permiso de &#039;Borrar Noticias&#039;. Los usuarios necesitaran este permiso para poder borrar articulos de noticias.</p>
<p>Se arregrlaron ciertas capacidades para editar desde la pagina frontal (campos extras todavia no han sido agregados)</p>
<p>Se agreg&oacute; la preferencia para permitir esconder el texto sumario para agregar o editar articulos.</p.
<p>Se quit&oacute; el tipo Content News (Obsoledo desde News 2.5.1)</p>
<p>Ahora requiere CMS 1.2 or superior</p>
<p>Se arreglaron algunas cadenas de lenguaje dentro de la pesta&ntilde;a de Articulos</p>
<p>Se agreg&oacute; la preferencia que permite especificar el numero por defecto de dias que restan para que un articulo expire.</p>
</li>
</ul>';
...
$lang['showautodiscovery'] = 'Mostrar Enlace Feed Auto-Discovery';
$lang['autodiscoverylink'] = 'Feed Auto-Discovery URL';
...
$lang['helpmakerssbutton'] = 'Hacer una bot&oacute;n con un enlace a una RSS feed del item Noticias.';
...
$lang['helpdateformat'] = 'Formato con el cual se va a mostrar la fecha de env&iacute;o del art&iacute;culo.  Esto est&aacute; basado en la funci&oacute;n <a href=&quot;http://php.net/strftime&quot; target=&quot;_blank&quot;>strftime</a> y puede ser utilizado en su plantilla con $entry->formatpostdate.  Por defecto se pone en %x, que por defecto es el formato local del servidor.';
