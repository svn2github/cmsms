...
$lang['admin']['help_function_uploads_url'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Quels param&egrave;tres ?</h3>
<li><em>(option)</em> assign (string) - Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom.sultat </li>';
...
<li><em>(option)</em> <tt>height</tt> - Hauteur pour  &ecirc;tre utilis&eacute; avec l&#039;image (aucun attribut de hauteur sera utilis&eacute; sur la sortie balise img   s&#039;il n&#039;est pas fourni.).</li>
		...
		<li><em>(option)</em> <tt>ext_info</tt> - Utilis&eacute; avec le param&egrave;tre &quot;ext&quot; par d&eacute;faut (lien externe).</li>
                         <li><em>(option)</em> <tt>assign</tt> - Attribuer les r&eacute;sultats &agrave; la variable smarty.est pas fourni.).</li>
<li><em>(option)</em> <tt>height</tt> - Hauteur pour  </li>
		<li><em>';
...
<ul>
	...
	<li><tt>jQuery UI</tt><em>(1.8.18)</em> - jquery-ui-1.8.18.min.js</li>
...
<ul>
	...
	<li><em>(option) </em><tt>append</tt> - Utilise, s&eacute;par&eacute; par des virgules(CSV), la liste des chemins des scripts que vous souhaitez ajouter. <code>&#039;/uploads/jquery.ui.nestedSortable.js,http://code.jquery.com/jquery-1.6.2.min.js&#039;par<code>&#039;</code></li>
