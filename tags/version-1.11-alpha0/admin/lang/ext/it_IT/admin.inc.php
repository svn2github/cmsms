<?php
$lang['admin']['info_smarty_cacheudt'] = 'Se abilitato, tutte le chiamate a UDT (tag definiti dall&#039;utente) saranno meorizzate in cache. Quest&#039;opzione pu&ograve; rivelarsi utile per tag che visualizzano l&#039;output di query al database. Potete disabilitarlo utilizzando il parametro nocache nella stringa dell&#039;UDT.  es.: <code>{myusertag nocache}</code>';
...
$lang['admin']['info_smarty_caching'] = 'Se abilitato, l&#039;output di vari plugin sar&agrave; memorizzato in cache per migliorare le prestazioni. Si paplica solo all&#039;output delle pagine di contenuto contrassegnate come memorizzabili in cache e solo per gli utenti non amministratori.  Nota bene: questa funzionalit&agrave; potrebbe interferire con il comportamento di alcuni moduli o plugin, o con plugin che utilizzano la modalit&agrave; non-inline.';
...
<h3>Come si usa?</h3>
<p>La prima cosa da fare &egrave; selezionare l&#039;editor WYSIWYG da utilizzare nella pagina impostazioni globali della console di amministrazione. Dopodich&egrave;, se utilizzate l&#039;editor su molte pagine, potrebbe risultare conveniente posizionare il plugin {cms_init_editor} direttamente nel template della vostra pagina.  Se vi serve che l&#039;editor sia abilitato solo in un numero limitato di pagine, potreste semplicemente posizionarlo nel campo &quot;Metadata Specifico della Pagina&quot; di ogni pagina.</p>
...
$lang['admin']['info_umask'] = 'L&#039; &amp;quot;umask&amp;quot; &egrave; un valore ottale utilizzato per specificare il permessi predefiniti per i file creati (viene utilizzato per i file nella cartella cache e quelli caricati). Per maggiori informazioni vi riportiamo all&#039;apposito <a href="http://en.wikipedia.org/wiki/Umask">articolo su wikipedia.</a>';
...
$lang['admin']['deleted_template'] = 'Cancellato Template';
...
$lang['admin']['edited_group'] = 'Modificato Gruppo';
...
$lang['admin']['deleted_css'] = 'Eliminato Foglio di Stile';
$lang['admin']['uploaded_file'] = 'Caricato File';
$lang['admin']['created_directory'] = 'Creata Cartella';
$lang['admin']['deleted_file'] = 'Eliminato File';
$lang['admin']['deleted_directory'] = 'Eliminata Cartella';
$lang['admin']['edited_template'] = 'Modificato Template';
$lang['admin']['deleted_user'] = 'Eliminato Utente';
$lang['admin']['deleted_module'] = 'Rimosso definitivamente %s';
$lang['admin']['deleted_gcb'] = 'Eliminato Blocco di Contenuto Globale';
