...
if( isset($params['submit']) ) {
  ...
  foreach( $selall as $file ) {
    // build complete path
    $fn = filemanager_utils::join_path($config['root_path'],filemanager_utils::get_cwd(),$file);
    ...
    if( filemanager_utils::is_image_file($file) ) {
      ...
      $thumb = filemanager_utils::join_path($config['root_path'],filemanager_utils::get_cwd(),'thumb_'.basename($file));
