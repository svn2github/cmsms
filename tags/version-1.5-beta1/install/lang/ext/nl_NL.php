...
$lang['test_check_disable_functions_failed'] = 'Deze lijst bevat alle uitgeschakelende PHP functies op uw server.';
...
$lang['install_admin_frontendlang'] = 'Standaard taal voor de frondend. Dit past de lokale standaard voor verschillende functies standaard datum behandeling, enz.';
...
$lang['sitedown_not_removed'] = 'Kan tmp/cache/SITEDOWN bestand niet verwijderen. Verwijder dit bestand handmatig of anders zal uw site een &quot;Site Down for Maintainence&quot; melding weergeven.';
...
$lang['upgrade_complete'] = 'Updateproces voltooid';
$lang['upgrade_end'] = 'CMS is up-to-date. Klik op %s om naar uw CMS site te gaan of ga naar %s.';
$lang['here'] = 'hier';
$lang['go_to_admin'] = 'ga naar het Administratorpaneel';
...
$lang['is_readable_false'] = 'Deze bron us niet leesbaar!';
...
$lang['upload_err_no_file'] = 'Er is geen bestand geupload.';
...
$lang['upload_err_empty'] = 'Bestand heeft geen grootte.';
$lang['upload_err_unknown'] = 'Onbekende uploadfout.';
$lang['function_file_uploads_off'] = 'file_uploads is uitgeschakeld in uw php!';
$lang['upload_file_no_readable'] = 'Bestandsupload onleesbaar.';
...
$lang['test_check_magic_quotes_gpc_failed'] = 'Enkele aanhalingstekens, dubbele aanhalingstekens en backslashes worden automatisch verwijderd. U kunt daardoor problemen krijgen bij het opslaan van templates.';
...
$lang['install_test_checksum'] = 'U kunt de echtheid van de bestanden van uw CMS vergelijken met de orginele bestanden doormiddel van een checksum. Het kan helpen met het opsporen van problemen bij uploads.';
...
$lang['upgrade_system'] = 'Upgraden van systeem';
...
$lang['install_value_exceed'] = 'Een instelling valt binnen of boven de aanbevolen drempelwaardes<br />of... een onderdeel dat <misschien> vereist is voor optionele functionaliteit is beschikbaar
';
...
$lang['test_may_not_exist'] = 'Het is mogelijk dat dit bestand niet bestaat. Wanneer deze niet bestaat, creeer een leeg bestand met deze naam. Zorg dat het webserver proces schrijfrechten heeft.';
$lang['could_not_retrieve_a_value'] = 'Geen waarde opgehaald..... verwerking gaat verder.';
$lang['displaying_the_value_originally'] = '<br />Toont de originele waarde in het configuratie-bestand (deze hoeft niet aktueel te zijn).';
...
$lang['connection_error'] = 'Uitgaande http-verbindingen niet lijken te werken! Er is een firewall of een ACL voor externe aansluitingen?. Dit kan er voor zorgen dat functies als de module manager, en mogelijk andere functies niet werken.';
...
';
$lang['test_check_memory'] = 'Controle van PHP geheugen limiet (memory_limit)';
$lang['test_check_memory_failed'] = 'Er is mischien niet genoeg geheugen beschikbaar voor PHP scripts om CMSMS correct te laten draaien, of alle gewenste uitbreidingen te gebruiken. Indien mogelijk, probeer de systeembeheerder deze waarde te laten verhogen. Ga door met de nodige voorzichtigheid.';
...
$lang['test_check_file_get_contents_failed'] = 'De file_get_contents functie is toegevoegd in PHP 4.3 en hoewel er een workaround is gebruikt waardoor de meeste functionaliteit van deze functie goed zou moeten werken in PHP 4.2, is het aan te raden up te graden naar PHP 4.3 of hoger.';
...
$lang['install_creating_table'] = '<p>Maak %s tabel...';
...
$lang['install_admin_set_sitename'] = 'Site naam wordt ingesteld... ';
...
$lang['install_admin_docroot'] = 'CMS Document root (zoals gezien vanaf de webserver)';
$lang['install_admin_docroot_path'] = 'Pad naar de Document root';
...
$lang['install_admin_sitedown'] = 'Fout: Kan het bestand tmp/cache/SITEDOWN niet verwijderen. Verwijder dit handmatig.';
...
$lang['install_admin_index_search'] = 'Indexeren voor zoek functie... ';
$lang['install_admin_clear_cache'] = 'Verwijder site cache ';
$lang['install_admin_emailing'] = 'E-mail mijn admin account informatie...';
$lang['install_admin_congratulations'] = 'Gefeliciteerd, installatie gelukt - hier is je';
$lang['could_not_connect_db'] = 'Kan database niet connecteren. Controleer de gebruikersnaam en het password, en controleer of de gebruiker rechten heeft op de opgeven database.';
$lang['cannot_write_config'] = 'Fout: Kan niet schrijven in %s.';
$lang['install_additional_modules'] = 'Installeer additionele modules';
...
Log hier in op het beheerpaneel van de site: %s';
$lang['utma'] = '156861353.3997402867425918500.1219071457.1224356934.1225609755.17';
$lang['utmz'] = '156861353.1225609755.17.10.utmccn=(referral)|utmcsr=dev.cmsmadesimple.org|utmcct=/|utmcmd=referral';
$lang['utmb'] = '156861353';
$lang['utmc'] = '156861353';
?>