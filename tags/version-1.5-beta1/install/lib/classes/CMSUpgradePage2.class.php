...
#
#$Id: CMSUpgradePage2.class.php 118 2008-11-01 19:11:48Z alby $
...
class CMSInstallerPage2 extends CMSInstallerPage
{
	...
	function assignVariables()
	{
		...
		$settings['recommended'][] = testString(0, lang('test_check_disable_functions'), 'disable_functions', lang('test_check_disable_functions_failed'), true, 'yellow', 'disable_functions_not_empty');
		...
		$settings['recommended'][] = testString(0, lang('test_check_open_basedir'), $open_basedir, lang('test_check_open_basedir_failed'), false, 'yellow', 'open_basedir_enabled');
