<?php
$lang['admin']['searchable'] = 'Diese Seite kann durchsucht werden';
...
<p>F&uuml;gen Sie den folgenden Tag in Ihrem Seiten-Template ein: <code>{content_image block=&#039;image1&#039;}</code>.</p>
<h3>Welche Parameter sind m&ouml;glich?</h3>
<ul>
  <li><tt><em>(required)</em> block</tt> -- das ist der Name f&uuml;r den zus&auml;tzlichen Inhaltsblock.
  <p>Beispiel:</p>
  ...
  <li><tt><em>(optional)</em> label</tt> -- Eine Beschriftung oder Eingabeaufforderung f&uuml;r diesen Inhaltsblock auf der Bearbeitungsseite. Ohne Vorgabe wird der Blockname verwendet.</li>
   <li><tt><em>(optional)</em> dir</tt> -- der Name eines Verzeichnisses, aus dem die Bilder ausgew&auml;hlt werden sollen (relativ zum Verzeichnis /uploads). Ohne Vorgabe wird das /uploads-Verzeichnis verwendet.
  <p>Beispiel:</p>
  <pre>{content_image block=&#039;Bild-1&#039; dir=&#039;images&#039;}</pre>
  </li>
...
$lang['admin']['notification_to_handle'] = 'Sie haben <strong>%d</strong> nicht erledigte System-Nachrichten';
...
$lang['admin']['admin_enablenotifications'] = 'Die System-Nachrichten sollen den Benutzern angezeigt werden<br /><em>(die Systen-Informationen sind dann auf jeder Seite der Administration zu sehen)</em>';
$lang['admin']['enablenotifications'] = 'Aktiviert die Anzeige von Systen-Nachrichten in der Administration';
...
$lang['admin']['help_function_stylesheet'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Holt die Stylesheets aus dem System. Standardm&auml;&szlig;ig werden alle mit dem aktuellen Template verkn&uuml;pften Stylesheets geladen.</p>
	<h3>Wie wird er eingesetzt?</h3>
...
$lang['admin']['help_function_last_modified_by'] = '        <h3>Was macht dieser Tag?</h3>
        ...
        <h3>Welche Parameter sind m&ouml;glich?</h3>
        <p><em>(optional)</em> <tt>format</tt> - ID, username, fullname</p>';
...
$lang['admin']['help_function_embed'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein:</p> <code>{embed url=&#039;http://www.google.com/&#039;}</code>
	...
	<p>F&uuml;gen Sie Ihrem Stylesheet folgendes hinzu:</p>
       ...
       <p>Auf der Seite rufen Sie den Tag mit <code>{embed url=..}</code> auf; in den &quot;Metadaten&quot; (Registerkarte Optionen) muss <code>{embed header=true}</code> eingef&uuml;gt werden. Damit dies funktioniert, sollten Sie sicherstellen, dass der <code>{metadata}</code>-Tag im head-Bereich Ihres Templates aufgerufen wird.</p>';
...
<p>Wenn Sie jetzt diese Seite bearbeiten, erscheint beim Bearbeiten der Seite ein weiterer Textbereich mit dem Namen &quot;Zweiter Inhaltsblock&quot;.</p></li>
...
$lang['admin']['help_function_contact_form'] = '<h2>HINWEIS: Dieses Plugin wird nicht mehr weiterentwickelt.</h2>
<h3> Dieses Plugin ist ab CMS made simple Version 1.5 nicht mehr im Lieferumfang enthalten.</h3>';
...
$lang['admin']['help_function_redirect_url'] = '<h3>Was macht dieser Tag?</h3>
  <p>Dieses Plugin erlaubt Ihnen, Ihre Besucher auf eine andere URL weiterzuleiten. Dies l&auml;sst sich auch gut mit Smarty-Bedingungen verwenden (zum Beispiel, wenn die Seite gerade wegen Wartungsarbeiten nicht erreichbar ist).</p>
	<h3>Wie wird er eingesetzt?</h3>
<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein:</p>  <code>{redirect_url urle=&#039;www.cmsmadesimple.org&#039;}</code>';
...
$lang['admin']['utmz'] = '156861353.1224007556.321.2.utmcsr=shiftrefresh.us|utmccn=(referral)|utmcmd=referral|utmcct=/';
$lang['admin']['utma'] = '156861353.717462736.1147511856.1225552951.1225555887.324';
