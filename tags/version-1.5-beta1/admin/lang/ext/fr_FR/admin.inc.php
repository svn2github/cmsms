...
$lang['admin']['searchable'] = 'La recherche se fera dans cette page&nbsp;';
...
$lang['admin']['error_udt_name_chars'] = 'Le nom d&#039;une balise utilisateur valide commence par une lettre ou un underscore, suivi par un nombre quelconque de lettres, de chiffres, ou underscores.';
...
$lang['admin']['text_settemplate'] = 'Modifier les pages s&eacute;lectionn&eacute;es avec un autre gabarit';
...
$lang['admin']['magic_quotes_gpc_on'] = 'Les guillements simples ou doubles sont &eacute;chapp&eacute;s avec un antislash automatiquement. Vous pouvez avoir des probl&egrave;mes avec les gabarits';
$lang['admin']['magic_quotes_runtime'] = 'Test magic_quotes_runtime';
$lang['admin']['magic_quotes_runtime_on'] = 'La plupart des fonctions qui retournent des donn&eacute;es auront &eacute;t&eacute; &eacute;chapp&eacute;es avec un anti-slash. Vous pouvez avoir des probl&egrave;mes';
...
$lang['admin']['test_remote_url'] = 'Test URL &agrave; distance';
...
$lang['admin']['connection_failed'] = 'Erreur de connection !';
$lang['admin']['notifications_to_handle'] = 'Vous avez <b>%d</b> notifications en cours';
$lang['admin']['notification_to_handle'] = 'Vous avez <b>%d</b> notification en cours';
$lang['admin']['notifications'] = 'Notifications';
$lang['admin']['dashboard'] = 'Tableau de bord';
$lang['admin']['ignorenotificationsfrommodules'] = 'Ignorer les notifications de ces modules&nbsp;';
$lang['admin']['admin_enablenotifications'] = 'Permet aux utilisateurs d&#039;afficher des notifications<br/><em>(Ces notifications seront affich&eacute;es sur chaque page d&#039;administration)</em>&nbsp;';
...
$lang['admin']['config_writable'] = 'Le fichier config.php a des droits en &eacute;criture. Il est plus s&ucirc;r si vous changez la permission en lecture seule';
...
$lang['admin']['os_session_save_path'] = 'Aucune v&eacute;rification &agrave; cause de chemin OS';
...
<p>Ce plugin va traiter les donn&eacute;es contenues dans le block &quot;pagedata&quot; des pages de contenu &agrave; travers smarty.  Il permet de sp&eacute;cifier des donn&eacute;es sp&eacute;cifiques &agrave; chaque page via smarty sans avoir &agrave; changer le gabarit de chaque page.</p>
<h3>Comment l&#039;utiliser ?</h3>
<ol>
...
$lang['admin']['pagedata_codeblock'] = 'Balise Smarty sp&eacute;cifiques pour cette page&nbsp;';
$lang['admin']['error_uploadproblem'] = 'Une erreur s&#039;est produite dans le transfert';
...
$lang['admin']['extra1'] = 'Attributs suppl&eacute;mentaires page1&nbsp;';
$lang['admin']['extra2'] = 'Attributs suppl&eacute;mentaires page 2&nbsp;';
$lang['admin']['extra3'] = 'Attributs suppl&eacute;mentaires page 3&nbsp;';
$lang['admin']['start_upgrade_process'] = 'D&eacute;but du processus d&#039;upgrade';
$lang['admin']['warning_upgrade'] = '<em><strong>ATTENTION</strong></em>&nbsp;: CMSMS a besoin d&#039;une mise &agrave; jour';
$lang['admin']['warning_upgrade_info1'] = 'Vous utilisez le sch&eacute;ma version %s. et vous devez upgrader au sch&eacute;ma version %s';
$lang['admin']['warning_upgrade_info2'] = 'Merci de cliquer sur le lien suivant : %s.';
$lang['admin']['warning_mail_settings'] = 'Vos param&egrave;tres de messagerie n&#039;ont pas &eacute;t&eacute; configur&eacute;. Cela pourrait interf&eacute;rer avec la capacit&eacute; de votre site pour envoyer des messages par email. Vous devriez aller sur <a href="moduleinterface.php?module=CMSMailer">Extensions-CMSMailer</a> et configurer les param&egrave;tres email avec les informations fournies par votre h&eacute;bergeur.';
...
$lang['admin']['phpversion'] = 'Version PHP courante';
...
$lang['admin']['help_function_current_date'] = '	<h3>Que fait cette Balise ?</h3>
...
<p>
    <ul>
        <li><em>(optionnel)</em> url         (string)     - l&#039;URL utilis&eacute; pour la validation, si aucun n&#039;est entr&eacute;, http://jigsaw.w3.org/css-validator/check/referer est utilis&eacute;.</li>
	<li><em>(option)</em> class       (string)     - Si d&eacute;fini, il sera utilis&eacute; comme attribut de la classe pour l&#039;&eacute;l&eacute;ment lien (a)</li>
	<li><em>(option)</em> target      (string)     - Si d&eacute;fini, il sera utilis&eacute; comme attribut de la cible pour l&#039;&eacute;l&eacute;ment lien (a)</li>
	<li><em>(option)</em> image       (true/false) - Si d&eacute;fini &agrave; &quot;false&quot;, un lien en texte sera utilis&eacute; &agrave; la place d&#039;une image/ic&ocirc;ne.</li>
...
$lang['admin']['help_function_stopexpandcollapse'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Permet au contenu d&#039;&ecirc;tre regroup&eacute; ou d&eacute;group&eacute;. Comme ceci :<br />
	<a href="#expand1" onClick="expandcontent(&#039;expand1&#039;)" style="cursor:hand; cursor:pointer">Cliquez ici pour plus d&#039;informations</a><span id=&quot;expand1&quot; class=&quot;expand&quot;><a name="help"></a> - Voici toutes les informations requises...</a></span></p>
	...
	<br />
	<br />
	Note: Si vous souhaitez utiliser cette fonctionnalit&eacute; plus d&#039;une fois par page, chaque tag startExpandCollapse doit avoir un unique id.</p>
	...
	&nbsp; &nbsp;id - L&#039;identifiant <u>unique</u> d&#039;une section grouper/d&eacute;grouper.<br />
	&nbsp; &nbsp;title - Le texte affich&eacute; pour grouper/d&eacute;grouper le contenu.<br />
...
$lang['admin']['help_function_sitemap'] = '    <h3>Avertissement</h3>
    <p>Ce plugin est obsol&egrave;te. Nous recommandons d&#039;utiliser la balise <code>{site_mapper}</code>.</p>
    ...
    <p>
        <ul>
            <li><em>(optionel)</em> <tt>class</tt> - Une classe css (css_class) pour le tag ul qui inclus le sitemap complet.</li>
            <li><em>(optionel)</em> <tt>start_element</tt> - La hi&eacute;rarchie primaire de l&#039;&eacute;l&eacute;ment (ex : 1.2 ou 3.5.1). Ce param&egrave;tre d&eacute;fini la racine du menu. Vous pouvez utiliser l&#039;alias de la page au lieu du num&eacute;ro hi&eacute;rarchique.</li>
            <li><em>(optionel)</em> <tt>number_of_levels</tt> - Un entier, le nombre de niveaux que vous souhaitez afficher dans le menu. Doit &ecirc;tre d&eacute;fini &agrave; 2 en utilisant un s&eacute;parateur.</li>
            <li><em>(optionel)</em> <tt>delimiter</tt> - Texte pour s&eacute;parer les entr&eacute;e qui ne sont pas de niveau 1 du sitemap (ex 1.1, 1.2). Pratique pour afficher les entr&eacute;es de niveau 2 c&ocirc;te &agrave; c&ocirc;te (css display:inline).</li>
            <li><em>(optionel)</em> <tt>initial 1/0</tt> - Si param&eacute;tr&eacute; &agrave; 1, liste &eacute;galement les entr&eacute;es qui ne sont pas de niveau 1 avec un s&eacute;parateur (ex 1.1, 2.1).</li>
            <li><em>(optionel)</em> <tt>relative 1/0</tt> - N&#039;affiche pas la page courante (dans le sitemap) - On ne montre que ses enfants (&eacute;l&eacute;ments de niveau inf&eacute;rieurs).</li>
            <li><em>(optionel)</em> <tt>showall 1/0</tt> - Affiche toutes les pages si activ&eacute;, sinon, n&#039;affiche que les pages avec une entr&eacute;e de menu active.</li>
            <li><em>(optionel)</em> <tt>add_elements</tt> - Une liste d&#039;alias de pages s&eacute;par&eacute;e par des virgules qui seront ajout&eacute;s aux pages affich&eacute;es avec les entr&eacute;es de menu actives (showall non activ&eacute;).</li>
        </ul>
        </p>';
$lang['admin']['help_function_adsense'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Google adsense est un programme de publicit&eacute; pour les sites internet. Ce tag reprend les param&egrave;tres basiques fournis par ce programme et permet de les int&eacute;grer plus facilement dans les gabarits.  Voir <a href="http://www.google.com/adsense" target="_blank">ici</a> pour plus de d&eacute;tails sur adsense.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Tout d&#039;abord, inscrivez-vous sur google et r&eacute;cup&eacute;rez vos param&egrave;tres. Puis ins&eacute;rez le tag sur votre page/gabarit comme ceci : <code>{adsense ad_client=&quot;pub-random#&quot; ad_width=&quot;120&quot; ad_height=&quot;600&quot; ad_format=&quot;120x600_as&quot;}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
...
$lang['admin']['help_function_sitename'] = '        <h3>Que fait cette Balise ?</h3>
        ...
        <h3>Quels param&egrave;tres ?</h3>
        <p><em>(optionel)</em> assign (string) - Enregistre le r&eacute;sultat dans une variable smarty avec le nom &#039;string&#039;.</p>';
$lang['admin']['help_function_search'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est une balise pour le <a href="listmodules.php?action=showmodulehelp&amp;module=Search">module de recherche</a> afin de rendre la syntaxe de balise plus ais&eacute;e. 
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise <code>{search}</code> dans votre votre gabarit o&ugrave; la bo&icirc;te de recherche doit appara&icirc;tre. Pour de l&#039;aide &agrave; propos du module de recherche, r&eacute;f&eacute;rez-vous &agrave; <a href="listmodules.php?action=showmodulehelp&amp;module=Search">l&#039;aide du module recherche</a>.';
...
$lang['admin']['help_function_repeat'] = '  <h3>Que fait cette Balise ?</h3>
  ...
  <h3>Comment l&#039;utiliser ?</h3>
  <p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{repeat string=&#039;r&eacute;p&eacute;ter &ccedil;a &#039; times=&#039;3&#039;}</code>
  <h3>Quels param&egrave;tres ?</h3>
  <ul>
...
$lang['admin']['help_function_recently_updated'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
	 <li><p><em>(optionel)</em> number=&#039;10&#039; - Nombre des pages &agrave; afficher.</p><p>Exemple: <pre>{recently_updated number=&#039;15&#039;}</pre> affichera 15 pages...</p></li>
 	 <li><p><em>(optionel)</em> leadin=&#039;Last changed&#039; - Texte &agrave; afficher &agrave; gauche de la date de modification.</p><p>Exemple: <pre>{recently_updated leadin=&#039;Derni&egrave;re Modification&#039;}</pre></p></li>
 	 <li><p><em>(optionel)</em> showtitle=&#039;true&#039; - Affiche l&#039;attribut titre si d&eacute;fini (true|false).</p><p>Exemple: <pre>{recently_updated showtitle=&#039;true&#039;}</pre></p></li>											 	
	 <li><p><em>(optionel)</em> css_class=&#039;some_name&#039; - Ajoute une balise div d&eacute;finie avec cette classe autour de la liste.</p><p>Example: <pre>{recently_updated css_class=&#039;nom_de_classe&#039;}</pre></p></li>											 	
	 <li><p><em>(optionel)</em> dateformat=&#039;d.m.y h:m&#039; - Par d&eacute;faut d.m.y h:m , utilisez le format de votre choix (voir php -date- format)</p><p>Exemple: <pre>{recently_updated dateformat=&#039;D M j G:i:s T Y&#039;}</pre></p></li>											 	
	</ul>
...
$lang['admin']['help_function_print'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est simplement une balise pour le <a href="listmodules.php?action=showmodulehelp&amp;module=Printing">module d&#039;impression</a> afin de rendre la syntaxe de balise plus ais&eacute;e. 
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{print}</code>. Pour plus de d&eacute;tails sur les options et param&egrave;tres, merci de consulter l&#039;<a href="listmodules.php?action=showmodulehelp&amp;module=Printing">aide du module d&#039;impression personnalis&eacute;e</a>.';
...
$lang['admin']['help_function_news'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est simplement une balise pour le <a href="listmodules.php?action=showmodulehelp&amp;module=News">module de news</a> afin de rendre la syntaxe de balise plus ais&eacute;e. 
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{news}</code>. Pour de l&#039;aide &agrave; propos du module de news/articles, les param&egrave;tres etc..., merci de se r&eacute;f&eacute;rer &agrave; <a href="listmodules.php?action=showmodulehelp&amp;module=News">l&#039;aide du module news</a>.';
...
$lang['admin']['help_function_menu'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est actuellement une balise pour <a href="listmodules.php?action=showmodulehelp&amp;module=MenuManager">Menu Manager module</a> to make the tag syntax easier. 
	Instead of having to use <code>{cms_module module=&#039;MenuManager&#039;}</code> you can now just use <code>{menu}</code> to insert the module on pages and templates.
	</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{menu}</code>. For help about the Menu Manager module, what parameters it takes etc., please refer to the <a href="listmodules.php?action=showmodulehelp&amp;module=MenuManager">Menu Manager module help</a>.';
...
$lang['admin']['help_function_iamge'] = '  <h3>Que fait cette Balise ?</h3>
  <p>Creates an image tag to an image stored within your images directory</p>
  <h3>Comment l&#039;utiliser ?</h3>
  <p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{image src=&quot;something.jpg&quot;}</code></p>
  <h3>Quels param&egrave;tres ?</h3>
  <ul>
...
$lang['admin']['help_function_google_search'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<p>Note: Google needs to have your website indexed for this to work. You can submit your website to google <a href="http://www.google.com/addurl.html">here</a>.</p>
...
$lang['admin']['help_function_global_content'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{global_content name=&#039;myblob&#039;}</code>, where name is the name given to the block when it was created.</p>
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
...
$lang['admin']['help_function_description'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>JIns&eacute;rer la balise dans votre page ou votre gabarit : <code>{description}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<p>Aucun pour le moment.</p>';
...
$lang['admin']['help_function_content'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
		<li><em>(option)</em>block - Allows you to have more than one content block per page.  When multiple content tags are put on a template, that number of edit boxes will be displayed when the page is edited.
<p>Example:</p>
...
<p>Now, when you edit a page there will a textarea called &quot;Second Content Block&quot;.</li>
		<li><em>(option)</em>wysiwyg (true/false) - If set to false, then a wysiwyg will never be used while editing this block.  If true, then it acts as normal.  Only works when block parameter is used.</li>
		<li><em>(option)</em>oneline (true/false) - If set to true, then only one edit line will be shown while editing this block.  If false, then it acts as normal.  Only works when block parameter is used.</li>
<li><em>(optional)</em>default - Allows you to specify default content content for this content blocks (additional content blocks only).</li>
		<li><em>(option)</em>assign - Assigns the content to a smarty parameter, which you can then use in other areas of the page, or use to test whether content exists in it or not.
...
$lang['admin']['help_function_contact_form'] = '  <h2>NOTE : Ce plugin est obsol&egrave;te</h2>
    <p>Cette balise (&quot;smarty plugin&quot;) est obsol&egrave;te;, et ne sera plus inclus dans les versions futures de CMS Made Simple. Nous recommandons d&#039;utiliser le module Formbuilder et son formulaire de contact.</p>
	<h3>Que fait cette Balise ?</h3>
	<p>Affiche un formulaire de contact. Celui-ci peut &ecirc;tre utilis&eacute; par vos visiteurs pour envoyer un mail &agrave; une adresse spe&eacute;cifi&eacute;e.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page comme : <code>{contact_form email=&quot;yourname@yourdomain.com&quot;}</code><br>
	<br>
	Si vous souhaiter envoyer le mail &agrave; plusieurs adresses, s&eacute;parer ces adresses par une virgule.</p>
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
		<li>email - l&#039;adresse ou le message sera envoy&eacute;.</li>
		<li><em>(option)</em>style - true/false, utiliser les styles pr&eacute;d&eacute;finis. Par D&eacute;faut est &agrave; &#039;true&#039;</li>
		<li><em>(option)</em>subject_get_var - Cha&icirc;ne de caract&egrave;res pour sp&eacute;cifier le sujet par d&eacute;faut.
             ...
             <p>Puis appeler la page avec une url comme : /index.php?page=contact&amp;subject=test+subject</p>
             <p>a Cha&icirc;ne de caract&egrave;res appara&icirc;t dans la case &quot;Sujet du message&quot; : &quot;test mon_sujet&quot;
           </li>
		<li><em>(option)</em>captcha - true/false, pour utiliser l&#039;image Captcha (le module Captcha module doit &ecirc;tre install&eacute;). Par D&eacute;faut est &agrave; &#039;false&#039;</li>
	</ul>
	</p>';
$lang['admin']['help_function_cms_versionname'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Cette balise est utilis&eacute; pour inserer le nom de la version courante de CMS dans votre page ou votre gabarit.  Il n&#039;affiche rien d&#039;autre que le nom de version.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>C&#039;est une balise basique. Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{cms_versionname}</code>
	<h3>Quels param&egrave;tres ?</h3>
...
$lang['admin']['help_function_cms_version'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>C&#039;est une balise basique.  Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{cms_version}</code>
	<h3>Quels param&egrave;tres ?</h3>
	<p>Il n&#039;y a besoin d&#039;aucun param&egrave;tre.</p>';
...
$lang['admin']['help_function_cms_selflink'] = '		<h3>Que fait cette Balise ?</h3>
		...
		<ul>
		<li><em>(option)</em> <tt>page</tt> - Page ID or alias to link to.</li>
		<li><em>(option)</em> <tt>dir anchor (internal links)</tt> - New option for an internal page link. If this is used then <tt>anchorlink</tt> should be set to your link. </li> <!-- Russ - 25-04-2006 -->
		<li><em>(option)</em> <tt>anchorlink</tt> - New paramater for an internal page link. If this is used then <tt>dir =&quot;anchor&quot;</tt> should also be set. No need to add the #, because it is added automatically.</li> <!-- Russ - 25-04-2006 -->
		<li><em>(option)</em> <tt>urlparam</tt> - Specify additional parameters to the URL.  <strong>Do not use this in conjunction with the <em>anchorlink</em> parameter</strong></li>
		<li><em>(option)</em> <tt>tabindex =&quot;a value&quot;</tt> - Set a tabindex for the link.</li> <!-- Russ - 22-06-2005 -->
		<li><em>(option)</em> <tt>dir start/next/prev/up (previous)</tt> - Links to the default start page or the next or previous page, or the parent page (up). If this is used <tt>page</tt> should not be set.</li> <!-- mbv - 21-06-2005 -->
		<B>Note!</B> Only one of the above may be used in the same cms_selflink statement!!
		<li><em>(option)</em> <tt>text</tt> - Text to show for the link.  If not given, the Page Name is used instead.</li>
		<li><em>(option)</em> <tt>menu 1/0</tt> - If 1 the Menu Text is used for the link text instead of the Page Name</li> <!-- mbv - 21-06-2005 -->
		<li><em>(option)</em> <tt>target</tt> - Optional target for the a link to point to.  Useful for frame and javascript situations.</li>
		<li><em>(option)</em> <tt>class</tt> - Class for the <a> link </a>. Useful for styling the link.</li> <!-- mbv - 21-06-2005 -->
		<li><em>(option)</em> <tt>lang</tt> - Display link-labels  (&quot;Next Page&quot;/&quot;Previous Page&quot;) in different languages (0 for no label.) Danish (dk), English (en) or French (fr), for now.</li> <!-- mbv - 21-06-2005 -->
		<li><em>(option)</em> <tt>id</tt> - Optional css_id for the <a> link </a>.</li> <!-- mbv - 29-06-2005 -->
		<li><em>(optional)</em> <tt>more</tt> - place additional options inside the <a> link </a>.</li> <!-- mbv - 29-06-2005 -->
		<li><em>(option)</em> <tt>label</tt> - Label to use in with the link if applicable.</li>
		<li><em>(option)</em> <tt>label_side left/right</tt> - Side of link to place the label (defaults to &quot;left&quot;).</li>
		<li><em>(option)</em> <tt>title</tt> - Text to use in the title attribute.  If none is given, then the title of the page will be used for the title.</li>
		<li><em>(option)</em> <tt>rellink 1/0</tt> - Make a relational link for accessible navigation.  Only works if the dir parameter is set and should only go in the head section of a template.</li>
		<li><em>(option)</em> <tt>href</tt> - If href is used only the href value is generated (no other parameters possible). <strong>Example:</strong> <a href="{cms_selflink href="alias"}"><img src=&quot;&quot;></a></li>
		<li><em>(option)</em> <tt>image</tt> - A url of an image to use in the link. <strong>Example:</strong> {cms_selflink dir=&quot;next&quot; image=&quot;next.png&quot; text=&quot;Next&quot;}</li>
		<li><em>(option)</em> <tt>alt</tt> - Alternative text to be used with image (alt=&quot;&quot; will be used if no alt parameter is given).</li>
		<li><em>(option)</em> <tt>imageonly</tt> - If using an image, whether to suppress display of text links. If you want no text in the link at all, also set lang=0 to suppress the label. <B>Example:</B> {cms_selflink dir=&quot;next&quot; image=&quot;next.png&quot; text=&quot;Next&quot; imageonly=1}</li>
		<li><em>(option)</em> <tt>ext</tt> - For external links, will add class=&quot;external and info text. <strong>warning:</strong> only text, target and title parameters are compatible with this parameter</li>
		<li><em>(option)</em> <tt>ext_info</tt> - Used together with &quot;ext&quot; defaults to (external link)</li>
		</ul>
		';
...
<li><em>(option)</em> <tt>starttext</tt> - Texte &agrave; mettre au d&eacute;but de la liste du petit poucet, comme &quot;Vous &ecirc;tes ici&quot;.</li>
</ul>
';
...
$lang['admin']['help_function_site_mapper'] = '<h3>Que fait cette Balise ?</h3>
  <p>C&#039;est une balise pour le <a href="listmodules.php?action=showmodulehelp&amp;module=MenuManager">module Menu Manager</a> afin de rendre la syntaxe de balise plus ais&eacute;e, et ainsi simplifier la cr&eacute;ation d&#039;un plan de site.</p>
<h3>Comment l&#039;utiliser ?</h3>
  <p>Ins&eacute;rer la balise <code>{site_mapper}</code> dans votre page ou votre gabarit. Pour l&#039;aide sur le module &quot;Menu Manager&quot;, quels param&egrave;tres utiliser, se r&eacute;f&eacute;rer &agrave; <a href="listmodules.php?action=showmodulehelp&amp;module=MenuManager">Menu Manager module help</a>.</p>
...
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{redirect_url urle=&#039;www.cmsmadesimple.org&#039;}</code></p>';
...
$lang['admin']['confirmdefault'] = '&Ecirc;tes-vous s&ucirc;r de vouloir mettre  - %s - en tant que page par d&eacute;faut du site&nbsp;?';
$lang['admin']['confirmdeletedir'] = '&Ecirc;tes-vous s&ucirc;r de vouloir supprimer ce dossier ainsi que tout son contenu&nbsp;?';
...
$lang['admin']['editcsssuccess'] = 'La feuille de style a &eacute;t&eacute; mise &agrave; jour avec succ&eacute;s.';
...
$lang['admin']['modulesnotwritable'] = 'Le dossier des modules n&#039;est pas accessible en &eacute;criture. Si vous d&eacute;sirez installer des modules par t&eacute;l&eacute;chargement d&#039;un fichier XML, vous devez donner la permission totale (lecture/&eacute;criture/ex&eacute;cution) sur le dossier des modules (chmod 777). Le Safe mode pourrait aussi &ecirc;tre en cause.';
...
$lang['admin']['uninstallconfirm'] = '&Ecirc;tes-vous s&ucirc;r de vouloir d&eacute;sinstaller ce module&nbsp;?';
$lang['admin']['up'] = 'Haut';
$lang['admin']['upgrade'] = 'Mise &agrave; jour';
$lang['admin']['upgradeconfirm'] = '&Ecirc;tes-vous s&ucirc;r de vouloir mettre &agrave; jour&nbsp;?';
...
$lang['admin']['irc'] = 'IRC ';
$lang['admin']['module_help'] = 'Aide &agrave; propos des modules';
$lang['admin']['managebookmarks'] = 'Gestion des favoris';
$lang['admin']['editbookmark'] = '&Eacute;dition des favoris';
...
$lang['admin']['utmz'] = '156861353.1225700010.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)';
$lang['admin']['utma'] = '156861353.1159139803.1225700010.1225717802.1225730862.3';
