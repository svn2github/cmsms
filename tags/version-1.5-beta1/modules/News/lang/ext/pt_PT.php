<?php
$lang['helprsscategory'] = 'Para utilizar com o par&acirc;metro makerssbutton, esse par&acirc;metro permite especificar uma categoria &uacute;nica para utiliza&ccedil;&atilde;o do RSS';
$lang['unlimited'] = 'Ilimitado';
$lang['none'] = 'Nenhum';
$lang['rss_destinationpage'] = 'Id ou Alias da p&aacute;gina de destino a partir de artigos de not&iacute;cias RSS feed';
...
$lang['showautodiscovery'] = 'Mostrar Feed Auto-Discovery Link';
$lang['autodiscoverylink'] = 'Feed Auto-Discovery URL (em branco for defeito)';
...
<li>\&quot;category_i&quot; - Id of the category for this article</li>
...
';
$lang['helpnumber'] = 'N&uacute;mero m&aacute;ximo de itens a exibir =- deixando vazio ir&aacute; mostrar todos os itens.';
$lang['helpstart'] = 'Comece com o en&eacute;simo item - deixando vazio ter&atilde;o in&iacute;cio no primeiro item.';
$lang['helpmakerssbutton'] = 'Bot&atilde;o para linkar um feed RSS de itens de Not&iacute;cias.';
...
$lang['helpdateformat'] = 'Formato para exibir a data de postarem do artigo. Este &eacute; baseado na fun&ccedil;&atilde;o <b>http://php.net/strftime</b> e pode ser usado em seu tamplate com $entry->formatpostdate. O padr&atilde;o &eacute; %x, que &eacute; o formato padr&atilde;o da data para o local do servidor.';
