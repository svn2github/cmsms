<?php
$lang['notice'] = 'Notice';
$lang['general_notice'] = 'The versions displayed here represent the latest XML files uploaded to your selected repository (usually the CMS <a href=\"dev.cmsmadesimple.org\">forge</a>).  They may or may not represent the latest available versions.  You may want to view the available file releases on the repository you have selected.  If you are using the default repository, you can do this by typing in the module name into the search box on the <a href=\"dev.cmsmadesimple.org\">forge</a> and clicking on the &quot;Files&quot; button.';
