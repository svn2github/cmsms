...
$this->smarty->assign('dateformat_input', $this->CreateInputText($id,"dateformat",$dateformat,30));
$this->smarty->assign('timeformat_input', $this->CreateInputText($id,"timeformat",$timeformat,30));
...
$toolbar1 = $this->GetPreference('toolbar1',"cut,paste,pastetext,copy,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,styleselect,formatselect,fontselect,fontsizeselect");
...
$front_toolbar1 = $this->GetPreference('front_toolbar1',"cut,paste,pastetext,copy,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,styleselect,formatselect,fontselect,fontsizeselect");
...
$customdropdown=$this->GetPreference('customdropdown',
	   "Start expand/collapse-area|{startExpandCollapse}
