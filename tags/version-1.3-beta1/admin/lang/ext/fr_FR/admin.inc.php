...
$lang['admin']['help_function_current_date'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{current_date format=&quot;%A %d-%b-%y %T %Z&quot;}</code></p>
...
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{valid_xhtml}</code></p>
<h3>Quels param&egrave;tres ?</h3>
<p>
    <ul>
...
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{valid_css}</code></p>
<h3>Quels param&egrave;tres ?</h3>
<p>
    <ul>
...
$lang['admin']['help_function_title'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{title}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<p><em>(optional)</em> assign (string) - Assign the results to a smarty variable with that name.</p>';
$lang['admin']['help_function_stylesheet'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Gets stylesheet information from the system.  By default, it grabs all of the stylesheets attached to the current template.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit dans l&#039;ent&ecirc;te : <code>{stylesheet}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
...
$lang['admin']['help_function_stopexpandcollapse'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit :<br />
	<br />
...
$lang['admin']['help_function_startexpandcollapse'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{startExpandCollapse id=&quot;name&quot; title=&quot;Click Here&quot;}</code>. Also, you must use the {stopExpandCollapse} at the end of the collapseable content. Here is an example:<br />
	<br />
	<code>{startExpandCollapse id=&quot;name&quot; title=&quot;Click Here&quot;}<br />
	This is all the content the user will see when they click the title &quot;Click Here&quot; above. It will display all the content that is between the {startExpandCollapse} and {stopExpandCollapse} when clicked.<br />
	{stopExpandCollapse}
...
$lang['admin']['help_function_sitemap'] = '    <h3>Avertissement</h3>
    ...
    <h3>Comment l&#039;utiliser ?</h3>
    <p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{sitemap}</code></p>
    <h3>Quels param&egrave;tres ?</h3>
    <p>
        <ul>
...
$lang['admin']['help_function_sitename'] = '        <h3>Que fait cette Balise ?</h3>
        ...
        <h3>Comment l&#039;utiliser ?</h3>
        <p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{sitename}</code></p>
        <h3>Quels param&egrave;tres ?</h3>
        <p><em>(optional)</em> assign (string) - Assign the results to a smarty variable with that name.</p>';
$lang['admin']['help_function_search'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est en fait simplement une balise pour le <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=Search&quot;>module de recherche</a> pour rendre la syntaxe de balise plus ais&eacute;e. 
	Au lieu d&#039;avoir &agrave; utiliser <code>{cms_module module=&#039;Search&#039;}</code> vous pouvez maintenant juste utiliser <code>{search}</code> pour ins&eacute;rer le module dans un gabarit.
	</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag  <code>{search}</code> dans votre votre gabarit o&ugrave; la bo&icirc;te de recherche doit appara&icirc;tre. Pour de l&#039;aide &agrave; propos du module de recherche, r&eacute;f&eacute;rez-vous &agrave; <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=Search&quot;>l&#039;aide du module recherche</a>.';
$lang['admin']['help_function_root_url'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Prints the root url location for the site.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{root_url}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<p>Aucun pour le moment.</p>';
$lang['admin']['help_function_repeat'] = '  <h3>Que fait cette Balise ?</h3>
  <p>Repeats a specified sequence of characters, a specified number of times</p>
  <h3>Comment l&#039;utiliser ?</h3>
  <p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{repeat string=&#039;repeat this &#039; times=&#039;3&#039;}</code>
  <h3>Quels param&egrave;tres ?</h3>
  <ul>
...
$lang['admin']['help_function_recently_updated'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{recently_updated}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
...
$lang['admin']['help_function_print'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est en fait simplement un tag pour le <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=Printing&quot;>module d&#039;impression</a>afin de rendre la syntaxe de balise plus ais&eacute;e. 
	Instead of having to use <code>{cms_module module=&#039;Printing&#039;}</code> you can now just use <code>{print}</code> to insert the module on pages and templates.
	</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{print}</code>. For help about the Printing module, what parameters it takes etc., please refer to the <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=Printing&quot;>Printing module help</a>.';
$lang['admin']['help_function_oldprint'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Creates a link to only the content of the page.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{oldprint}</code><br></p>
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
...
$lang['admin']['login_info'] = 'A partir de ce point prendre en consid&eacute;ration les param&egrave;tres suivants';
$lang['admin']['login_info_params'] = '<ol> 
  <li>Les cookies sont autoris&eacute;s dans votre navigateur</li> 
  <li>Le Javascript est activ&eacute; dans votre navigateur</li> 
  <li>Fen&ecirc;tres popup active &agrave; l&#039;adresse suivante :&nbsp;</li> 
</ol>';
$lang['admin']['help_function_news'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est en fait simplement un tag pour le <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=News&quot;>module de news</a> afin de rendre la syntaxe de balise plus ais&eacute;e. 
	Instead of having to use <code>{cms_module module=&#039;News&#039;}</code> you can now just use <code>{news}</code> to insert the module on pages and templates.
	</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{news}</code>. For help about the News module, what parameters it takes etc., please refer to the <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=News&quot;>News module help</a>.';
$lang['admin']['help_function_modified_date'] = '        <h3>Que fait cette Balise ?</h3>
        <p>Prints the date and time the page was last modified.  If no format is given, it will default to a format similar to &#039;Jan 01, 2004&#039;.</p>
        <h3>Comment l&#039;utiliser ?</h3>
        <p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{modified_date format=&quot;%A %d-%b-%y %T %Z&quot;}</code></p>
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
                <li><em>(optional)</em>format - Date/Time format using parameters from php&#039;s strftime function.  See <a href=&quot;http://php.net/strftime&quot; target=&quot;_blank&quot;>here</a> for a parameter list and information.</li>
        </ul>';
$lang['admin']['help_function_metadata'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{metadata}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
...
$lang['admin']['help_function_menu_text'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>JIns&eacute;rer le tag dans votre page ou votre gabarit : <code>{menu_text}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<p>None at this time.</p>';
$lang['admin']['help_function_menu'] = '	<h3>Que fait cette Balise ?</h3>
	<p>C&#039;est actuellement un tag pour <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=MenuManager&quot;>Menu Manager module</a> to make the tag syntax easier. 
	Instead of having to use <code>{cms_module module=&#039;MenuManager&#039;}</code> you can now just use <code>{menu}</code> to insert the module on pages and templates.
	</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{menu}</code>. For help about the Menu Manager module, what parameters it takes etc., please refer to the <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=MenuManager&quot;>Menu Manager module help</a>.';
$lang['admin']['help_function_last_modified_by'] = '        <h3>Que fait cette Balise ?</h3>
        <p>Prints last person that edited this page.  If no format is given, it will default to a ID number of user .</p>
        <h3>Comment l&#039;utiliser ?</h3>
        <p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{last_modified_by format=&quot;fullname&quot;}</code></p>
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
...
$lang['admin']['help_function_iamge'] = '  <h3>Que fait cette Balise ?</h3>
  ...
  <h3>Comment l&#039;utiliser ?</h3>
  <p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{image src=&quot;something.jpg&quot;}</code></p>
  <h3>Quels param&egrave;tres ?</h3>
  <ul>
...
$lang['admin']['help_function_imagegallery'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : </p>
...
$lang['admin']['help_function_googlepr'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{googlepr}</code><br>
	<br>
...
$lang['admin']['help_function_google_search'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{google_search}</code><br>
	<br>
...
$lang['admin']['help_function_global_content'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{global_content name=&#039;myblob&#039;}</code>, where name is the name given to the block when it was created.</p>
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
...
$lang['admin']['help_function_get_template_vars'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{get_template_vars}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
											  <p>Aucun pour le moment</p>';
$lang['admin']['help_function_embed'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{embed url=http://www.google.com/}</code><br></p>
...
$lang['admin']['help_function_edit'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{edit}</code><br></p>
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
...
$lang['admin']['help_function_description'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>JIns&eacute;rer le tag dans votre page ou votre gabarit : <code>{description}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<p>None at this time.</p>';
$lang['admin']['help_function_created_date'] = '        <h3>Que fait cette Balise ?</h3>
        <p>Prints the date and time the page was created.  If no format is given, it will default to a format similar to &#039;Jan 01, 2004&#039;.</p>
        <h3>Comment l&#039;utiliser ?</h3>
        <p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{created_date format=&quot;%A %d-%b-%y %T %Z&quot;}</code></p>
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
                <li><em>(optional)</em>format - Date/Time format using parameters from php&#039;s strftime function.  See <a href=&quot;http://php.net/strftime&quot; target=&quot;_blank&quot;>here</a> for a parameter list and information.</li>
        </ul>';
$lang['admin']['help_function_content'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre gabarit : <code>{content}</code>.</p>
	<h3>Quels param&egrave;tres ?</h3>
	<ul>
...
$lang['admin']['help_function_contact_form'] = '  <h2>NOTE : Ce plugin est obsol&egrave;te</h2>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer le tag dans votre page comme : <code>{contact_form email=&quot;yourname@yourdomain.com&quot;}</code><br>
	<br>
...
$lang['admin']['help_function_cms_versionname'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>C&#039;est un tag basique. Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{cms_versionname}</code>
	<h3>Quels param&egrave;tres ?</h3>
...
$lang['admin']['help_function_cms_version'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>C&#039;est un tag basique.  Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{cms_version}</code>
	<h3>Quels param&egrave;tres ?</h3>
	<p>Il n&#039;y a besoin d&#039;aucun param&egrave;tre.</p>';
...
$lang['admin']['help_function_cms_selflink'] = '		<h3>Que fait cette Balise ?</h3>
		...
		<h3>Comment l&#039;utiliser ?</h3>
		<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{cms_selflink page=&quot;1&quot;}</code> or  <code>{cms_selflink page=&quot;alias&quot;}</code></p>
		<h3>Quels param&egrave;tres ?</h3>
		<p>
		<ul>
		...
		<li><em>(option)</em> <tt>urlparam</tt> - Specify additional parameters to the URL.  <strong>Do not use this in conjunction with the <em>anchorlink</em> parameter</em></strong>
...
$lang['admin']['help_function_cms_module'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<h3>Comment l&#039;utiliser ?</h3>
	<p>C&#039;est une balise basique. Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{cms_module module=&quot;somemodulename&quot;}</code>
	<h3>Quels param&egrave;tres ?</h3>
	<p>Un seul param&egrave;tre est requis. tous les autres param&egrave;tres sont transmis par le module.
	<ul>
...
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer le tag dans votre page ou votre gabarit : <code>{breadcrumbs}</code></p>
<h3>Quels param&egrave;tres ?</h3>
<p>
<ul>
<li><em>(option)</em> <tt>delimiter</tt> - Text to seperate entries in the list (default &quot;>>&quot;).</li>
<li><em>(optio)</em> <tt>initial</tt> - 1/0 If set to 1 start the breadcrumbs with a delimiter (default 0).</li>
<li><em>(option)</em> <tt>root</tt> - Page alias of a page you want to always appear as the first page in
    the list. Can be used to make a page (e.g. the front page) appear to be the root of everything even though it is not.</li>
<li><em>(option)</em> <tt>root_url</tt> - Override the URL of the root page. Useful for making link be to &#039;/&#039; instead of &#039;/home/&#039;. This requires that the root page be set as the default page.</li>

<li><em>(option)</em> <tt>classid</tt> - The CSS class for the non current page names, i.e. the first n-1 pages in the list. If the name is a link it is added to the <a href> tags, otherwise it is added to the <span> tags.</li>
<li><em>(option)</em> <tt>currentclassid</tt> - The CSS class for the <span> tag surrounding the current page name.</li>
<li><em>(option)</em> <tt>starttext</tt> - Text to append to the front of the breadcrumbs list, something like &quot;You are here&quot;.</li>
</ul>
</p>';
...
$lang['admin']['help_function_site_mapper'] = '<h3>Que fait cette Balise ?</h3>
  <p>C&#039;est en fait simplement une balise pour le <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=MenuManager&quot;>module Menu Manager</a> afin de rendre la syntaxe de balise plus ais&eacute;e, et ainsi simplifier la cr&eacute;ation d&#039;un plan de site.</p>
<h3>Comment l&#039;utiliser ?</h3>
  <p>Ins&eacute;rer <code>{site_mapper}</code> dans votre page ou votre gabarit. Pour l&#039;aide sur le module &quot;Menu Manager&quot;, quels param&egrave;tres utiliser, se r&eacute;f&eacute;rer &agrave; <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=MenuManager&quot;>Menu Manager module help</a>.</p>
...
$lang['admin']['help_function_redirect_page'] = '<h3>Que fait cette Balise ?</h3>
 <p>Ce plugin vous permet de faire une redirection vers une autre page.  It is handy inside of smarty conditional logic (for example, redirect to a login page if the user is not logged in.)</p>
<h3>Comment l&#039;utiliser ?</h3>
...
$lang['admin']['date_format_string_help'] = '<em>&nbsp;strftime</em> Date sous la forme d&#039;une cha&icirc;ne format&eacute;e. Rechercher sur Google &#039;strftime&#039; ';
...
$lang['admin']['msg_defaultcontent'] = 'Ajouter du code ici ajoutera du code par d&eacute;faut dans le contenu de toutes les nouvelles pages';
$lang['admin']['msg_defaultmetadata'] = 'Ajouter du code ici ajoutera du code dans la section des m&eacute;tadonn&eacute;es de toutes les nouvelles pages';
...
$lang['admin']['uninstallconfirm'] = '&Ecirc;tes-vous s&ucirc;r de vouloir d&eacute;sinstaller&nbsp;?';
$lang['admin']['up'] = 'Haut';
...
$lang['admin']['tagtousegcb'] = 'Tag pour utiliser le bloc';
...
$lang['admin']['utmz'] = '156861353.1212060927.121.27.utmccn=(referral)|utmcsr=forum.cmsmadesimple.org|utmcct=/index.php/topic,21846.0.html|utmcmd=referral';
$lang['admin']['utma'] = '156861353.1911476159.1190810560.1212046498.1212060927.121';
