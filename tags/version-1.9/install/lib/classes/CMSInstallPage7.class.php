...
#
#$Id: CMSInstallPage7.class.php 296 2010-10-17 22:31:18Z calguy1000 $
...
class CMSInstallerPage7 extends CMSInstallerPage
{
	...
	function preContent()
	{
		...
		$newconfig['ssl_url'] = str_replace('http://','https://',$newconfig['root_url']);
		...
		$newconfig['ssl_uploads_url'] = str_replace('http://','https://',$newconfig['uploads_url']);
