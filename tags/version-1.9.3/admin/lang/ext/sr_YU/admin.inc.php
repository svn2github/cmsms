...
$lang['admin']['clearcache_taskname'] = 'Isprazni ke&scaron;irane datoteke';
...
$lang['admin']['listtemplates_pagelimit'] = 'Broj prikazanih redova po stranici u toku pregleda predložaka';
$lang['admin']['liststylesheets_pagelimit'] = 'Broj prikazanih redova po stranici u toku pregleda lista stilova';
$lang['admin']['listgcbs_pagelimit'] = 'Broj prikazanih redova po stranici u toku pregleda Globalnih blokova sadržaja';
...
$lang['admin']['session_use_cookies'] = 'Sesijama je dozvoljeno da koriste kolačiće';
...
$lang['admin']['info_preview_notice'] = 'Upozorenje: Ovaj pregledni panel se pona&scaron;a slično kao prozor Browsera, omogućavajući vam da se udaljite od izvorne stranice koju pregledate. Ukoliko to uradite, može doći do neočekivanog pona&scaron;anja. Ako se udaljite od izvornog prikaza i vratite se nazad, možda nećete videti ';
$lang['admin']['sitedownexcludes'] = 'Isključi ove adrese iz Sitedown poruka';
$lang['admin']['info_sitedownexcludes'] = 'Ovaj parametar omogućava prikaz spiska IP adresa odvojenih zapetom ili mreža koje ne bi trebale da budu pogođene mehanizmom privremene deaktivacije sajta. Ovo omogućava administratorima da rade na stranici, dok anonimni posetioci dobijaju poruku o provremenoj neaktivnosti sajta.<br/><br/>Adrese mogu biti navedene u sledećim formatima:<br/>
...
$lang['admin']['setup'] = 'Napredne postavke';
$lang['admin']['handle_404'] = 'Rad sa prilagođenim stranama 404';
...
<p>Ubacite oznaku u predložak, na primer: <code>{page_attr key=&quot;extra1&quot;}</code>.</p>
<h3>Koji parametri su dostupni?</h3>
<ul>
  <li><strong>key [required]</strong> Ključ za vraćanje atributa.</li>
</ul>';
$lang['admin']['forge'] = 'Radionica (Forge)';
$lang['admin']['disable_wysiwyg'] = 'Isključi WYSIWYG urednik na ovoj stranici (bez obzira na predložak ili korisničke postavke)';
$lang['admin']['help_function_page_image'] = '<h3>&Scaron;ta ovo radi?</h3>
<p>Ovaj tag može da se koristi za prikaz vrednosti polja za slike ili umanjene slike određene strane.</p>
<h3>Kako se koristi?</h3>
<p>Ubacite oznaku u predložak, na primer: <code>{page_image}</code>.</p>
<h3>Koji parametri su dostupni?</h3>
<ul>
  <li>thumbnail - Opciono prikazuje vrednost postavki umanjene slike umesto postavki slike.</li>
</ul>';
...
$lang['admin']['moduleinstallmessage'] = 'Poruka za postavu %s Modula';
$lang['admin']['moduleuninstallmessage'] = 'Poruka za deinstalaciju  %s Modula';
$lang['admin']['admintheme'] = 'Administratorska Tema';
$lang['admin']['addstylesheet'] = 'Dodaj Stylesheet';
$lang['admin']['editstylesheet'] = 'Uredi Stylesheet';
$lang['admin']['addcssassociation'] = 'Dodaj Stylesheet asocijaciju';
$lang['admin']['attachstylesheet'] = 'Priloži ovaj Stylesheet';
...
$lang['admin']['templatecss'] = 'Dodeli &scaron;ablone Stylesheet-u';
$lang['admin']['plugins'] = 'Plugins';
$lang['admin']['movecontent'] = 'Premesti Stranice';
$lang['admin']['module'] = 'Modul';
$lang['admin']['usertags'] = 'User Defined Tag-ovi';
$lang['admin']['htmlblobs'] = 'Global Content Blockovi';
$lang['admin']['adminhome'] = 'Administration Home';
$lang['admin']['liststylesheets'] = 'Stylesheet-ovi';
$lang['admin']['preferencesdescription'] = 'Ovo je mesto gde možete podesiti razne ob&scaron;irne preferencije';
...
$lang['admin']['usersdescription'] = 'Ovo je mesto gde možete upravljati korisnike.';
$lang['admin']['groups'] = 'Groupe';
$lang['admin']['groupsdescription'] = 'Ovo je mesto gde možete upravljati grupe.';
$lang['admin']['groupassignments'] = 'Zadatki grupa';
...
$lang['admin']['pagesdescription'] = 'Ovo je mesto gde se dodaju i izmene stranice i drugih sadržaji.';
$lang['admin']['htmlblobdescription'] = 'Global Content Blockovi su delovi sadržaja koje možete postaviti u va&scaron;e stranice ili &scaron;ablone.';
$lang['admin']['templates'] = '&Scaron;ablone';
$lang['admin']['templatesdescription'] = 'Ovo je mesto gde se dodaju i izmenjuju &scaron;ablone. &Scaron;abloni defini&scaron;u izgled i stil va&scaron;eg sajta.';
$lang['admin']['stylesheets'] = 'Stylesheet-ovi';
$lang['admin']['stylesheetsdescription'] = 'Stylesheet uprava je napredni način kako se rukuje s kaskadnim stilovima (CSS) nezavisno od &scaron;ablona.';
...
$lang['admin']['stylesheetexists'] = 'Stylesheet postoji';
$lang['admin']['errorcopyingstylesheet'] = 'Gre&scaron;ka u kopiranju Stylesheet-a';
$lang['admin']['copystylesheet'] = 'Kopiraj Stylesheet';
$lang['admin']['newstylesheetname'] = 'Novo Stylesheet ime';
...
$lang['admin']['event_desc_contentpostrender'] = 'Poslato pre nego &scaron;to je kombiniran HTML  poslat Browseru';
...
$lang['admin']['recoveryemailsent'] = 'E-mail poslat na adresu. Molimo proverite po&scaron;tansko sanduče za dalja uputstva.';
$lang['admin']['errorsendingemail'] = 'Do&scaron;lo Je do gre&scaron;ke prilikom slanja e-po&scaron;te. Obratite se administratoru.';
$lang['admin']['passwordchangedlogin'] = 'Lozinka promenjena. Molimo vas prijavite se koristeći novi akreditive.';
$lang['admin']['nopasswordforrecovery'] = 'E-mail adresa nije navedena za ovog korisnika.  Povratak lozinke nije moguć. Molimo kontaktirajte svog administratora.';
...
$lang['admin']['utmz'] = '156861353.1292514844.633.43.utmcsr=forum.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/index.php';
$lang['admin']['utma'] = '156861353.1164361908.1285153768.1292680905.1292690152.654';
$lang['admin']['utmc'] = '156861353';
$lang['admin']['utmb'] = '156861353.5.10.1292690152';
?>