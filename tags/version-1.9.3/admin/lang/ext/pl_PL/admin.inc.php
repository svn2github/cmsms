...
$lang['admin']['info_content_thumbnailfield_path'] = 'Relatywna do ścieżki dla wgrywany obraz&oacute;w, podaj nazwę folderu kt&oacute;ry zawiera ściężki dla plik&oacute;w dla pola obrazu (image field) Zazwyczaj taka sama jak w polu powyżej';
$lang['admin']['contentimage_path'] = 'Scieżka dla tagu {content_image} ';
$lang['admin']['info_contentimage_path'] = 'Relatywna do ścieżki dla wgrywany obraz&oacute;w, podaj nazwę folderu kt&oacute;ry zawiera ściężki dla plik&oacute;w dla {content_image}.  Ta wartość jest używana jako domyślna dla parametru dir';
$lang['admin']['editcontent_settings'] = 'Ustawienia edycji treści';
$lang['admin']['help_page_url'] = 'Określa alternatywny URL (relatywny względem gł&oacute;wnego adresu twojej strony) kt&oacute;ry będzie użyty do identyfikacji tej strony,  np.: path/to/mypage.  Adres ten zostanie użyty tylko jeśli aktywne są przyjazne linki.';
$lang['admin']['help_page_alias'] = 'Alias jest używany jako alternatywa dla id strony do unikalnej identyfikacji strony. Musi być unikatowa i nie powtarzać się na żadnej innej stronie. Alias jest także używany przy tworzeniu adresu URL dla tej strony.';
...
$lang['admin']['help_page_cachable'] = 'Szybkość może zostać zwiększona poprzez ustawienie tej opcji włączonej dla tak wielu stron jak to tylko możliwe.  Jednak nie może zostać to użyte dla stron dla kt&oacute;rych zawartość może zmienić się  na jednostkę oczekiwań.';
...
';
$lang['admin']['utma'] = '156861353.130117701.1281030249.1295177118.1295193590.37';
$lang['admin']['utmz'] = '156861353.1294575657.29.23.utmcsr=dev.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/project/files/69';
