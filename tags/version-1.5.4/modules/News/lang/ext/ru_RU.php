...
$lang['helprsscategory'] = 'Для использования с параметром makerssbutton , этот параметр позволяет определить единую категорию для использования в rss-канале ';
$lang['unlimited'] = 'Неограничено';
$lang['none'] = 'Ничто';
$lang['rss_destinationpage'] = 'ID страницы или алиас для отображения новостей в формате RSS';
...
$lang['showautodiscovery'] = 'Показать ссылку автооткрытия ленты';
$lang['autodiscoverylink'] = 'URL автооткрытия ленты (пусто для значения по умолчанию)';
...
$lang['utma'] = '156861353.1781493382045874700.1227792799.1228903388.1228909115.17';
$lang['utmz'] = '156861353.1228474680.12.5.utmccn=(referral)|utmcsr=estetman.ru|utmcct=/admin/systeminfo.php|utmcmd=referral';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353';
?>