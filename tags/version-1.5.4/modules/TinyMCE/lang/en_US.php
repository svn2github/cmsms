...
$lang['toolbar_help'] = 'These options should contain a comma separated list of button/control names to insert into the toolbar. The char | can be used instead of the word \'seperator\'';
