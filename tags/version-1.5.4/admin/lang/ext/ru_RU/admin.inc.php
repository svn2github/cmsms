...
$lang['admin']['disable_wysiwyg'] = 'WYSIWYG не разрешен для этой страницы';
...
$lang['admin']['hidefrommenu'] = 'Скрыть в меню';
...
$lang['admin']['check_ini_set_off'] = 'У вас могут возникнуть затруднения ели будет отключена данная возможность. Эта проверка может не проходить, если включен режим safe_mode';
$lang['admin']['file_uploads'] = 'File uploads';
$lang['admin']['test_remote_url'] = 'Проверка удаленного URL';
...
$lang['admin']['test_check_open_basedir_failed'] = 'Ограничение open_basedir  в силе. С этим ограничением вы можете испытывать трудности с некоторыми дополнительными функциональными возможностями';
$lang['admin']['config_writable'] = 'config.php имеет права на запись. Безопаснее дать право только для чтения.';
$lang['admin']['caution'] = 'Предупреждение';
...
$lang['admin']['itsbeensincelogin'] = 'Вы были %s с момента вашего последнего входа';
...
$lang['admin']['login_info'] = 'Для работы консоли Администратора должны быть';
...
$lang['admin']['utma'] = '156861353.746925404.1205391775.1234334596.1234793043.55';
$lang['admin']['utmc'] = '156861353';
$lang['admin']['utmz'] = '156861353.1234793043.55.46.utmccn=(referral)|utmcsr=forum.cmsmadesimple.org|utmcct=/index.php/topic,27626.0.html|utmcmd=referral';
