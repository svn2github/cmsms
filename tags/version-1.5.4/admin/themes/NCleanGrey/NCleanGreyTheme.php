...
<?php
	...
	function DisplayFooter() {
		...
		# removed since VistaICO.com have  Malware
		#echo '<br /> Icons by <a rel="external" href="http://www.cmsmadesimple.org/visaico-license.pdf">VistaICO.com</a> 		</div><!--end Nclean-container-->';
		echo '</div>';
		echo '</div><!--end Nclean-container-->';
		//END
	}
