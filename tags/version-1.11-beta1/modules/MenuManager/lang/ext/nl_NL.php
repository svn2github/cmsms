<?php
$lang['help_action'] = 'Bepaal het gedrag van deze module. Er zijn twee mogelijke opties voor deze parameter:
<ul>
  <li>default <em>(standaard)</em> - Wordt gebruikt voor het opbouwen van het navigatiemenu.</li>
  <li>breadcrumbs - Kan worden gebruikt voor het genereren van een breadcrumb spoor voor de pagina die momenteel wordt weergegeven.  <strong>Opmerking: {cms_breadcrumbs}</strong> is een kortere manier om deze actie aan te roepen.</li>
</ul>';
$lang['help_root'] = 'Alleen van toepassing op de breadcrumbs actie, deze tag staat toe het beginlevel op te geven dat niet hetzelfde is als de standaardpagina.';
$lang['youarehere'] = 'U bent hier';
...
$lang['help'] = '	<h3>Wat doet het?</h3>
	...
	<p>Als u een speciale versie van een sjabloon wilt maken, kunt u deze in de database importeren en vervolgens aanpassen via het beheerpaneel in CMSMS. Dit gaat als volgt in zijn werk:
		<ol>
			...
			<li>Klik vervolgens op de Importeerknop achter een bestaande bestandsnaam, bijvoorbeeld die achter simple_navigation.tpl.</li>
...
$lang['utma'] = '156861353.1232860636.1322776962.1322776962.1322776962.1';
$lang['utmz'] = '156861353.1322776962.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
