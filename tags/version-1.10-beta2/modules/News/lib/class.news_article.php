...
class news_article
{
  private static $_keys = array('id','author_id','title','content','summary','extra','news_url','postdate','startdate','enddate',
				'category_id','status','author','authorname','category','canonical','fields','fieldsbyname','printlink',
				'useexp','printurl','returnid','params');
  ...
  public function set_field(news_field $field)
  {
    ...
    // todo: verify that this field exists.
    $name = $field->name;
