...
$lang['admin']['info_umask'] = 'Die &quot;umask&quot; ist eine Oktalzahl, welche die Berechtigungen neu erzeugter Dateien festlegt (betrifft die Dateien im Cache-Verzeichnis und hochgeladene Dateien)  Weitere Information finden Sie im entsprechenden <a href="http://de.wikipedia.org/wiki/Unix-Dateirechte">Wikipedia Artikel.</a>';
...
$lang['admin']['modulehelp_english'] = 'In Englisch anzeigen';
...
<p>Dieses Plugin erkennt die vom Browser akzeptierten Sprachen, gibt diese aus und referenziert sie auf eine Liste mit &quot;erlaubten&quot; Sprachen, um die Sprache f&uuml;r diese Session festzulegen.</p>
...
<ul>
<li><tt><em>(erforderlich)</em> accepted</tt>  -  eine durch Kommata getrennte Liste mit den akzeptierten Sprachen (2-Zeichen-K&uuml;rzel).</li>
<li><tt><em>(optional)</em> default</tt>  --  die vorgegebene Sprache, die verwendet/ausgegeben wird, wenn durch den Browser keine der akzeptierten Sprachen unterst&uuml;tzt wird. Wurde kein Wert vorgegeben, wird &quot;en&quot; verwendet.</li>
<li><tt><em>(optional)</em> assign</tt>  --  der Name der Smarty-Variablen, der das Ergebnis der Abfrage zugewiesen wird. Ohne Zuweisung wird das Ergebnis dieser Funktion direkt ausgegeben.</li>
</ul>';
...
$lang['admin']['info_content_imagefield_path'] = 'Geben Sie hier den Namen des Verzeichnisses an, in dem die Dateien f&uuml;r das Bild-Feld zu finden sind (relativ zum /uploads/images-Pfad).';
$lang['admin']['content_thumbnailfield_path'] = 'Pfad f&uuml;r das Vorschaubild-Feld';
$lang['admin']['info_content_thumbnailfield_path'] = 'Geben Sie hier den Namen des Verzeichnisses an, in dem die Dateien f&uuml;r das Vorschaubild-Feld zu finden sind (relativ zum /uploads/images-Pfad). Dies sollte im Normalfall der gleiche Pfad wie oben sein.';
$lang['admin']['contentimage_path'] = 'Pfad f&uuml;r den {content_image}-Tag';
$lang['admin']['info_contentimage_path'] = 'Geben Sie hier den Namen des Verzeichnisses an, in dem die Dateien f&uuml;r den {content_image} Tag zu finden sind (relativ zum /uploads-Pfad). Dieser Wert wird als Standard f&uuml;r dessen Parameter &quot;dir&quot; verwendet.';
$lang['admin']['editcontent_settings'] = 'Einstellungen f&uuml;r die Inhaltsbearbeitung';
$lang['admin']['help_page_url'] = 'Geben Sie hier eine alternative URL an (relativ zum Wurzelverzeichnis Ihrer Webseite), &uuml;ber die diese Seite eindeutig identifiziert werden kann, z.Bsp. Pfad/zu/meiner/Seite. Die seitenspezifische URL ist nur dann n&uuml;tzlich, wenn in der config.php die Option &quot;Pretty URL&quot; aktiviert ist.';
...
$lang['admin']['help_page_cachable'] = 'Die Performance der Webseite kann erh&ouml;ht werden, wenn f&uuml;r die Seite die Option &quot;Seite zwischenspeichern&quot; aktiviert wird. Dies sollte jedoch NICHT f&uuml;r Seiten verwendet werden, deren Inhalte dynamisch / erst auf Anfrage erstellt werden.';
...
$lang['admin']['lctitle_url'] = 'URL suffix f&uuml;r Inhaltsseiten. Wenn gesetzt';
...
$lang['admin']['adminlog_1day'] = '1 Tag';
$lang['admin']['adminlog_1week'] = '1 Woche';
$lang['admin']['adminlog_2weeks'] = '2 Wochen';
$lang['admin']['adminlog_1month'] = '1 Monat';
$lang['admin']['adminlog_3months'] = '3 Monate';
$lang['admin']['adminlog_6months'] = '6 Monate';
...
<h3>Welche Parameter sind m&ouml;glich?</h3>
<ul>
  <li><tt><em>(optional)</em> thumbnail</tt> (true/false) -- Mit diesem Parameter wird anstatt des Bildes das Vorschaubild angezeigt.</li>
</ul>';
...
<ul>
  ...
  <p>Beispiel: Verwendung von Bildern aus dem Verzeichnis /uploads/images</p>
  <pre>{content_image block=&#039;Bild_1&#039; dir=&#039;images&#039;}</pre><br />
  </li>
  ...
  <li><tt><em>(optional)</em> alt</tt> -- ein alternativer Text, falls das Bild nicht gefunden werden konnte.</li>
  <li><tt><em>(optional)</em> urlonly</tt> -- es wird nur die URL des Bildes ausgegeben. Alle anderen Parameter wie id, name, width, height usw. werden ignoriert.</li>
</ul>';
...
$lang['admin']['utma'] = '156861353.602660572.1314000716.1314088054.1314097275.6';
$lang['admin']['utmz'] = '156861353.1314000716.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)';
$lang['admin']['qca'] = 'P0-1209344414-1263563671334';
$lang['admin']['utmb'] = '156861353.1.10.1314097275';
