...
$lang['help'] = '	<h3>Hva gj&oslash;r denne?</h3>
	...
	<p>Bare sett inn taggen i din mal/side som: <code>{cms_module module=&#039;menumanager&#039;}</code>.  Parameterne den godtar listes nedenfor.</p>
	<h3>Hvorfor bry seg om maler?</h3>
	<p>Menu Manager bruker maler for visningslogikk.  Den kommer med tre standard maler navnet bulletmenu.tpl, cssmenu.tpl og ellnav.tpl. I basis s&aring; lager de alle en enkel usortert liste med sider, ved &aring; bruke forskjellige classes og ID&#039;er for styling med CSS.  De er lik meny systemene inkludert i tidligere versjoner: bulletmenu, CSSMenu og EllNav.</p>
	...
	<p>N&aring; kan du enkelt endre malen for dine behov for dette nettstedet.  Sett inn classes, id&#039;er og andre tagger s&aring; formateringen blir akkurat slik du vil. N&aring; kan du sette den inn p&aring; ditt nettsted med {cms_module module=&#039;menumanager&#039; template=&#039;Test Mal&#039;}. Husk at .tpl filendelsen m&aring; inkluderes om en mal brukes.</p>
...
$lang['utma'] = '156861353.469342802.1148076752.1149426566.1149940101.10';
$lang['utmz'] = '156861353.1149426566.9.6.utmccn=(referral)|utmcsr=helminsen.no|utmcct=/admin/editcontent.php|utmcmd=referral';
$lang['utmc'] = '156861353';
?>