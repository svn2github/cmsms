...
if ($params['searchinput'] != '')
{
	...
	$query = "SELECT DISTINCT module_name, content_id, extra_attr, COUNT(*) AS nb, SUM(count) AS total_weight FROM ".cms_db_prefix()."module_search_index WHERE (".$searchphrase.") GROUP BY module_name, content_id, extra_attr ORDER BY nb DESC, total_weight DESC";
	$result =& $db->Execute($query, array($words));
