<?php
$lang['sendtestmailconfirm'] = 'Dies wird eine Testnachricht an eine festgelegte Adresse versenden. Wenn der Versand erfolgreich war, kehren sie zu dieser Seite zur&uuml;ck. Wollen sie fortfahren?';
$lang['settingsconfirm'] = 'Sollen die aktuellen Werte in die Einstellungen von CMSMailer geschrieben werden?';
$lang['testsubject'] = 'CMSMailer Testnachricht';
$lang['testbody'] = 'Mit dieser Nachricht soll die G&uuml;ltigkeit der Einstellungen des  CMSMailer-Moduls &uuml;berpr&uuml;ft werden.
Wenn sie diese empfangen haben, funktioniert alles bestens.';
...
$lang['host'] = 'SMTP-Hostname oder Adresse';
...
$lang['info_host'] = 'SMTP-Hostname (nur g&uuml;ltig f&uuml;r die SMTP-Mailmethode)';
$lang['info_port'] = 'SMTP-Portnummer (&uuml;blicherweise 25) (nur g&uuml;ltig f&uuml;r die SMTP-Mailmethode)';
$lang['info_from'] = 'Adresse, mit der alle Emails versandt werden';
$lang['info_fromuser'] = 'Username, mit dem alle Emails versandt werden';
$lang['info_sendmail'] = 'Der komplette Pfad zu ihrem sendmail-Programm (nur g&uuml;ltig f&uuml;r die SMTP-Mailmethode)';
$lang['info_timeout'] = 'Anzahl der Sekunden f&uuml;r die SMTP-Konversation, bevor eine Fehlermeldung erscheint (nur g&uuml;ltig f&uuml;r die SMTP-Mailmethode)';
$lang['info_smtpauth'] = 'Ben&ouml;tigt ihr SMTP-Host eine Authentifizierungs (nur g&uuml;ltig f&uuml;r die SMTP-Mailmethode)';
$lang['info_username'] = 'SMTP-Authentifizierungs-Username (nur g&uuml;ltig f&uuml;r die SMTP-Mailmethode, wenn SMTP-Authentifizierung gew&auml;hlt wurde)';
$lang['info_password'] = 'SMTP-Authentifizierungs-Passwort (nur g&uuml;ltig f&uuml;r die SMTP-Mailmethode, wenn SMTP-Authentifizierung gew&auml;hlt wurde)';
...
$lang['error'] = 'Fehler!';
$lang['upgraded'] = 'Module auf Version %s aktualisiert.';
$lang['title_mod_prefs'] = 'Moduleinstellungen';
$lang['title_mod_admin'] = 'Administration des Moduls ';
...
<p>Dieses Modul hat keine Funktionalit&auml;t f&uuml;r den Endverbraucher. Es dient dazu, um anderen Modulen die Ressourcen zum Versand von Emails zur Verf&uuml;gung zu stellen.</p>
<h3>Wie wird es eingesetzt ?</h3>
<p>Dieses Modul liefert einen einfachen Wrapper f&uuml;r alle Methoden und Variablen von PHPmailer. Es wurde zur Unterst&uuml;tzung f&uuml;r andere Entwickler konzipiert. Weiter unten finden sie ein Beispiel und eine kurze API-Referenz. F&uuml;r weitere Informationen lesen Sie bitte die Dokumentation zu PHPmailer.</p>
<h3>Ein Beispiel</h3>
<pre>
