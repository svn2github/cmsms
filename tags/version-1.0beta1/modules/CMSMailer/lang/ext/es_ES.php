...
$lang['smtpauth'] = 'Autenticación SMTP';
$lang['mailer'] = 'Método de eenvio';
$lang['host'] = 'Host SMTP<br/><i>(o dirección IP)</i>';
$lang['port'] = 'Puerto del servidor SMTP';
$lang['from'] = 'Dirección "de:"';
$lang['fromuser'] = 'Usuario "de:"';
$lang['sendmail'] = 'Localización';
$lang['timeout'] = 'Tiempo de espera SMTP';
$lang['submit'] = 'Enviar';
$lang['cancel'] = 'Cancelar';
$lang['info_mailer'] = 'Protocolo a usar (sendmail, smtp, mail).  Normalmente se usa SMTP.';
$lang['info_host'] = 'Nombre de Host SMTP (sólo valido para el protocolo SMTP)';
$lang['info_port'] = 'Puerto SMTP (normalmente 25) (sólo valido para el protocolo SMTP)';
$lang['info_from'] = 'Dirección desde donde enviar los mensajes';
$lang['info_fromuser'] = 'Nombre del usuario que envia los mensajes';
$lang['info_sendmail'] = 'Path completo del ejectable sendamil (sólo valido para el protocolo sendmailer)';
$lang['info_timeout'] = 'Número de segundosen una conversación SMTP antes de ocurrir un error (sólo valido para el protocolo SMTP)';
$lang['info_smtpauth'] = 'Tu Host SMTP requiere autenticación (sólo valido para el protocolo SMTP)';
