<?php
$lang['available_updates'] = 'Modules disponibles pour mise &agrave; jour';
$lang['all_modules_up_to_date'] = 'Il n&#039;y a pas de nouveaux modules disponibles dans le d&eacute;pot s&eacute;lectionn&eacute;';
$lang['error_module_object'] = 'Erreur : Ne peut pas obtenir une instance du module %s';
$lang['error_nomatchingmodules'] = 'Erreur : Ne pas trouver des modules dans le d&eacute;pot s&eacute;lectionn&eacute;';
$lang['error_nomodules'] = 'Erreur : Ne peut pas r&eacute;cup&eacute;rer la liste des modules install&eacute;s';
$lang['upgrade_available'] = 'Nouvelle version disponible (%s), vous avez la (%s)';
$lang['newversions'] = 'Modules install&eacute;s';
$lang['error_depends'] = 'Une ou plusieures d&eacute;pendances ne sont pas install&eacute;es. Vous devez installer d&#039;abord les d&eacute;pendances !';
...
$lang['compatibility_disclaimer'] = 'Les modules affich&eacute;s ici sont fournis par les d&eacute;veloppeurs de CMS, et des tiers ind&eacute;pendants. Nous ne pouvons garantir que les modules offerts ici soit fonctionnels, test&eacute;s, ou compatibles avec votre syst&egrave;me. Vous &ecirc;tes encourag&eacute;s &agrave; lire les informations qui se trouvent dans l&#039;aide et sur les liens pour chaque module avant l&#039;installation.';
$lang['notice'] = 'Avertissement';
$lang['general_notice'] = 'Les version affich&eacute;es ici repr&eacute;sentent les derniers fichiers au format XML de votre d&eacute;pot s&eacute;lectionn&eacute; (CMSMS %s). Ils peuvent &ecirc;tre ou non la derniere version disponible.';
...
$lang['error_permissions'] = '<strong><em>ATTENTION :</em></strong>Vous n&#039;avez pas les permissions suffisantes pour installer les modules. Vous pouvez avoir des prob&egrave;mes avec PHP Safe mode. Merci de v&eacute;rifier que le safe mode est OFF, et que les permissions des fichiers sont suffisantes.';
$lang['error_minimumrepository'] = 'La version du d&eacute;pot de modules n&#039;est pas compatible avec ce &quot;module manager&quot;';
...
$lang['preferencessaved'] = 'Les pr&eacute;f&eacute;rences ont &eacute;t&eacute; mises &agrave; jour';
...
$lang['really_uninstall'] = '\u00CAtes-vous s\u00FBr de vouloir d\u00E9sinstaller ce module ? Vous allez perdre toutes ses fonctionalit\u00E9s.';
...
This version should reduce the memory requirements of this module, and trade it off for performance on the server, and mroe requests to the server.
   <ul>
    ...
    <li>Add support for requestion only the newest versions of the modules</li></ul>
...
$lang['utma'] = '156861353.253230781.1241719083.1241719083.1241719083.1';
$lang['utmc'] = '156861353';
$lang['utmz'] = '156861353.1241719083.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
$lang['utmb'] = '156861353';
?>