...
$lang['help'] = '	<h3>Vad g&ouml;r den h&auml;r modulen?</h3>
	...
	<p>Anv&auml;nd taggen i en mall/p&aring; en sida enligt f&ouml;ljande: <code>{cms_module module=&#039;menumanager&#039;}</code>.  De parametrar som modulen tar listas l&auml;ngre ner.</p>
	<h3>Varf&ouml;r ska jag bry mig om mallar?</h3>
	<p>Menyhanteraren anv&auml;nder mallar som best&auml;mmer hur menyn ska visas. Modulen kommer med sex standardmallar som heter bulletmenu.tpl, cssmenu.tpl och ellnav.tpl, och dess tillg&auml;ngliga motsvarigheter med -accessible p&aring; slutet. I princip skapar de en enkel lista av sidorna, och anv&auml;nder olika klasser och ID&#039;s som kan anpassas genom CSS. De enkla versionerna av mallarna ger samma HTML-kod som menysystemen i tidigare versioner av CMSMS: bulletmenu, CSSMenu och EllNav.</p>
	...
	<p>Om du vill anv&auml;nda en specialversion av en mall kan du enkelt importera mallen till databasen och sedan redigera mallen direkt i CMSMS-administrationen.  G&ouml;r d&aring; s&aring; h&auml;r:
		<ol>
			...
			<li>Klicka p&aring; tabben Mallar fr&aring;n fil, och klicka p&aring; knappen Importera mall till databas bredvid bulletmenu.tpl.</li>
	...
	<p>Nu kan du enkelt modifiera mallen efter dina behov. L&auml;gg till klasser, id&#039;s och andra taggar s&aring; att formateringen &auml;r precis som du vill. Nu kan du anv&auml;nda taggen p&aring; din sida s&aring; h&auml;r: {cms_module module=&#039;menumanager&#039; template=&#039;Testmall&#039;}. Observera att fil&auml;ndelsen .tpl m&aring;ste anv&auml;ndas om en filbaserad mall anv&auml;nds.</p>
...
$lang['utma'] = '156861353.566397030.1147555099.1149700038.1149796966.20';
$lang['utmz'] = '156861353.1149619132.18.9.utmccn=(referral)|utmcsr=dev.cmsmadesimple.org|utmcct=/admin/approve-pending.php|utmcmd=referral';
?>