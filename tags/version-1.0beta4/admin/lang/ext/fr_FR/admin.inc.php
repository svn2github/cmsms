<?php
$lang['admin']['event_desc_moduleupgraded'] = 'Envoyer apr&egrave;s la mise &agrave; jour d&#039;un module';
$lang['admin']['event_desc_moduleinstalled'] = 'Envoyer apr&egrave;s l&#039;installation d&#039;un module';
$lang['admin']['event_desc_moduleuninstalled'] = 'Envoyer apr&egrave;s la d&eacute;sinstallation d&#039;un module';
$lang['admin']['event_desc_edituserdefinedtagpost'] = 'Envoyer apr&egrave;s la mise &agrave; jour d&#039;un tag utilisateur';
$lang['admin']['event_desc_edituserdefinedtagpre'] = 'Envoyer avant la mise &agrave; jour d&#039;un tag utilisateur';
$lang['admin']['event_desc_deleteuserdefinedtagpre'] = 'Envoyer avant qu&#039;un tag utilisateur soit supprim&eacute;';
$lang['admin']['event_desc_deleteuserdefinedtagpost'] = 'Envoyer apr&egrave;s qu&#039;un tag utilisateur soit supprim&eacute;';
$lang['admin']['event_desc_adduserdefinedtagpost'] = 'Envoyer apr&egrave;s qu&#039;un tag utilisateur soit ins&eacute;r&eacute;';
$lang['admin']['event_desc_adduserdefinedtagpre'] = 'Envoyer avant qu&#039;un tag utilisateur soit supprim&eacute;';
$lang['admin']['global_umask'] = 'Masque de cr&eacute;ation de fichier (umask)';
$lang['admin']['errorcantcreatefile'] = 'Impossible de cr&eacute;er un fichier (probl&egrave;me de permissions?)';
...
$lang['admin']['errorinstallfialed'] = 'L&#039;installation du module a &eacute;chou&eacute;';
...
$lang['admin']['reorderpages'] = 'R&eacute;ordonner les pagers';
...
$lang['admin']['no_orders_changed'] = 'Vous avez choisi des r&eacute;ordonner les pages, mais vous n&#039;avez chang&eacute; l&#039;ordre d&#039;aucune d&#039;entre elles. Les pages n&#039;ont pas &eacute;t&eacute; r&eacute;ordonn&eacute;es.';
...
$lang['admin']['user_tag'] = 'Tag utilisateur';
...
$lang['admin']['contentdeleted'] = 'Le contenu a &eacute;t&eacute; supprim&eacute; avec succ&egrave;s.';
$lang['admin']['success'] = 'Avec succ&egrave;s';
...
$lang['admin']['aliasalreadyused'] = 'Cet alias est d&eacute;j&agrave; utilis&eacute; par une autre page';
...
$lang['admin']['cantremovefiles'] = 'Probl&egrave;me lors de la suppression de fichiers (permissions?)';
$lang['admin']['confirmcancel'] = '&Ecirc;tes-vous s&ucirc;r de vouloir annuler vos changements? Cliquez OK pour annuler tous les changements. Cliquez Annuler pour continuer &agrave; &eacute;diter.';
$lang['admin']['canceldescription'] = 'Annuler les changements';
$lang['admin']['clearadminlog'] = 'Effacer le journal';
$lang['admin']['code'] = 'Code';
$lang['admin']['confirmdefault'] = 'Etes-vous s&ucirc;r de vouloir mettre cette page en tant que page par d&eacute;faut ?';
$lang['admin']['confirmdeletedir'] = 'Etes-vous s&ucirc;r de vouloir supprimer ce dossier ainsi que tout son contenu ?';
...
$lang['admin']['deleteconfirm'] = 'Etes-vous s&ucirc;r de vouloir supprimer ?';
...
$lang['admin']['usertagadded'] = 'Le tag utilisateur a &eacute;t&eacute; ajout&eacute; avec succ&egrave;s.';
$lang['admin']['usertagupdated'] = 'Le tag utilisateur a &eacute;t&eacute; mis &agrave; jour avec succ&egrave;s.';
$lang['admin']['usertagdeleted'] = 'Le tag utilisateur a &eacute;t&eacute; supprim&eacute; avec succ&egrave;s.';
$lang['admin']['email'] = 'Adresse Email';
$lang['admin']['errorattempteddowngrade'] = 'L&#039;installation de ce module r&eacute;sulterait en version ant&eacute;rieure. Op&eacute;ration annul&eacute;e.';
...
$lang['admin']['errorcouldnotparsexml'] = 'Erreur lors du rendu du fichier XML';
...
$lang['admin']['errordirectorynotwritable'] = 'Aucune permission en &eacute;criture dans le dossier';
...
$lang['admin']['cachenotwritable'] = 'Le dossier cache n&#039;est pas accessible en &eacute;criture. Le vidage du cache ne va pas fonctionner. Veuillez d&eacute;finir le dossier tmp/cache pour qu&#039;il aie la permission totale (lecture/&eacute;criture/ex&eacute;cution = chmod 777)';
$lang['admin']['modulesnotwritable'] = 'Le dossier des modules n&#039;est pas accessible en &eacute;criture. Si vous d&eacute;sirez installer des modules par t&eacute;l&eacute;chargement d&#039;un fichier XML, vous devez donner la permission totale (lecture/&eacute;criture/ex&eacute;cution) sur le dossier des modules (chmod 777) ';
...
$lang['admin']['errorinsertingtag'] = 'Erreur lors de la cr&eacute;ation du tag utilisateur';
...
$lang['admin']['errorupdatingusertag'] = 'Erreur lors de la mise &agrave; jour du tag utilisateur';
...
$lang['admin']['eventhandlerdescription'] = 'Associer les tag utilisateur avec les &eacute;v&egrave;nements';
...
$lang['admin']['handler'] = 'Gestionnaire (Tag utilisateur)';
$lang['admin']['headtags'] = 'Tags d&#039;ent&ecirc;te';
...
$lang['admin']['helplisttemplate'] = '<p>Cette section vous permet d&#039;&eacute;diter, supprimer et cr&eacute;er des gabarits.</p><p>Pour cr&eacute;er un nouveau gabarit, cliquez sur le bouton <u>Ajouter un nouveau gabarit</u>.</p><p>Si vous d&eacute;sirez que toutes vos pages utilisent le m&ecirc;me gabarit, cliquez sur le lien <u>Choisir pour tous les contenus</u>.</p><p>Si vous d&eacute;sirez copier un gabarit, cliquer sur l&#039;icone <u>Copier</u> et l&#039;on vous demandera un nom pour la nouvelle copie.</p>';
...
$lang['admin']['removeconfirm'] = 'Cette action va supprimer d&eacute;finitivement les fichiers constituant le module de cette installation.>n&Ecirc;tes-vous s&ucirc;r de vouloir continuer?';
...
$lang['admin']['setfalse'] = 'D&eacute;finir en faux';
$lang['admin']['type'] = 'Type';
$lang['admin']['typenotvalid'] = 'Le type n&#039;est pas valide.';
$lang['admin']['uninstall'] = 'D&eacute;sinstaller';
$lang['admin']['uninstallconfirm'] = 'Etes-vous s&ucirc;r de vouloir d&eacute;sinstaller?';
$lang['admin']['up'] = 'Haut';
$lang['admin']['upgrade'] = 'Mise &agrave; jour';
$lang['admin']['upgradeconfirm'] = 'Etes-vous s&ucirc;r de vouloir mettre &agrave; jour?';
...
$lang['admin']['usertagexists'] = 'Un Tag existe d&eacute;j&agrave; avec le m&ecirc;me nom, veuillez en choisir un autre.';
...
$lang['admin']['blobexists'] = 'Ce nom de Blob Html existe d&eacute;j&agrave;';
...
$lang['admin']['htmlblobdescription'] = 'HTML Blobs sont des morceaux de contenu &agrave; placer dans vos pages ou gabarits.';
...
$lang['admin']['tagdescription'] = 'Les Tags sont de petits morceaux de fonctionnalit&eacute;s qui peuvent &ecirc;tre ajout&eacute;s &agrave; votre contenu et/ou vos gabarits.';
$lang['admin']['usertagdescription'] = 'Tags que vous pouvez cr&eacute;er/modifier vous-m&ecirc;me pour ex&eacute;cuter des t&acirc;ches sp&eacute;cifiques, directement depuis votre navigateur.';
$lang['admin']['installdirwarning'] = '<em><strong>Attention&nbsp;:</strong></em> le dossier d&#039;installation est toujours pr&eacute;sent. Veuillez l&#039;effacer compl&egrave;tement.';
...
$lang['admin']['irc'] = 'IRC';
$lang['admin']['module_help'] = 'Aide du module';
...
$lang['admin']['mediatype_all'] = 'Tous: compatible pour tous les appareils.';
...
$lang['admin']['mediatype_embossed'] = 'embossed&nbsp;: &agrave; l&#039;attention des imprimates braille.';
...
$lang['admin']['sitedownwarning'] = '<strong>Attention&nbsp;:</strong> Votre site affiche le message &quot;Site Down for Maintainence&quot;.  Veuillez supprimer le fichier %s pour r&eacute;soudre cela.';
$lang['admin']['deletecontent'] = 'Supprimer le contenu';
$lang['admin']['deletepages'] = 'Supprimer ces pages?';
...
$lang['admin']['stylesheetstodelete'] = 'Ces feuilles de styles vont &ecirc;tre supprim&eacute;s';
...
$lang['admin']['event_desc_loginpost'] = 'Envoyer apr&egrave;s la connexion d&#039;un utilisateur dans le panneau d&#039;administration';
$lang['admin']['event_desc_logoutpost'] = 'Envoyer apr&egrave;s la d&eacute;connexion d&#039;un utilisateur du panneau d&#039;administration';
$lang['admin']['event_desc_adduserpre'] = 'Envoyer avant qu&#039;un nouvel utilisateur soit cr&eacute;&eacute;';
$lang['admin']['event_desc_adduserpost'] = 'Envoyer apr&egrave;s qu&#039;un nouvel utilisateur aie &eacute;t&eacute; cr&eacute;&eacute;';
$lang['admin']['event_desc_edituserpre'] = 'Envoyer avant que l&#039;&eacute;dition d&#039;un utilisateur soit enregistr&eacute;e';
$lang['admin']['event_desc_edituserpost'] = 'Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un utilisateur aie &eacute;t&eacute; enregistr&eacute;e';
$lang['admin']['event_desc_deleteuserpre'] = 'Envoyer avant qu&#039;un utilisateur soit supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_deleteuserpost'] = 'Envoyer apr&egrave;s qu&#039;un utilisateur aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_addgrouppre'] = 'Envoyer avant qu&#039;un nouveau groupe soit cr&eacute;&eacute;';
$lang['admin']['event_desc_addgrouppost'] = 'Envoyer apr&egrave;s qu&#039;un nouveau groupe aie &eacute;t&eacute; cr&eacute;&eacute;';
$lang['admin']['event_desc_editgrouppre'] = 'Envoyer avant que l&#039;&eacute;dition d&#039;un groupe soit enregistr&eacute;e';
$lang['admin']['event_desc_editgrouppost'] = 'Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un groupe aie &eacute;t&eacute; enregistr&eacute;e';
$lang['admin']['event_desc_deletegrouppre'] = 'Envoyer avant qu&#039;un groupe soit supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_deletegrouppost'] = 'Envoyer apr&egrave;s qu&#039;un groupe aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_addstylesheetpre'] = 'Envoyer avant qu&#039;une nouvelle feuille de style soit cr&eacute;&eacute;e';
$lang['admin']['event_desc_addstylesheetpost'] = 'Envoyer apr&egrave;s qu&#039;une nouvelle feuille de style aie &eacute;t&eacute; cr&eacute;&eacute;e';
$lang['admin']['event_desc_editstylesheetpre'] = 'Envoyer avant que l&#039;&eacute;dition d&#039;une feuille de style soit enregistr&eacute;e';
$lang['admin']['event_desc_editstylesheetpost'] = 'Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;une feuille de style aie &eacute;t&eacute; enregistr&eacute;e';
$lang['admin']['event_desc_deletestylesheetpre'] = 'Envoyer avant qu&#039;une feuille de style soit supprim&eacute;e du syst&egrave;me';
$lang['admin']['event_desc_deletestylesheetpost'] = 'Envoyer apr&egrave;s qu&#039;une feuille de style aie &eacute;t&eacute; supprim&eacute;e du syst&egrave;me';
$lang['admin']['event_desc_addtemplatepre'] = 'Envoyer avant qu&#039;un nouveau gabarit soit cr&eacute;&eacute;';
$lang['admin']['event_desc_addtemplatepost'] = 'Envoyer apr&egrave;s qu&#039;un nouveau gabarit aie &eacute;t&eacute; cr&eacute;&eacute;';
$lang['admin']['event_desc_edittemplatepre'] = 'Envoyer avant que l&#039;&eacute;dition d&#039;un gabarit soit enregistr&eacute;e';
$lang['admin']['event_desc_edittemplatepost'] = 'Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un gabarit aie &eacute;t&eacute; enregistr&eacute;e';
$lang['admin']['event_desc_deletetemplatepre'] = 'Envoyer avant qu&#039;un gabarit soit supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_deletetemplatepost'] = 'Envoyer apr&egrave;s qu&#039;un gabarit aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_templateprecompile'] = 'Envoyer avant qu&#039;un gabarit soit envoy&eacute; &agrave; Smarty pour &ecirc;tre trait&eacute;';
$lang['admin']['event_desc_templatepostcompile'] = 'Envoyer apr&egrave;s qu&#039;un gabarit aie &eacute;t&eacute; trait&eacute; par Smarty';
$lang['admin']['event_desc_addglobalcontentpre'] = 'Envoyer avant qu&#039;un nouveau bloc de contenu global soit cr&eacute;&eacute;';
$lang['admin']['event_desc_addglobalcontentpost'] = 'Envoyer apr&egrave;s qu&#039;un nouveau bloc de contenu global aie &eacute;t&eacute; cr&eacute;&eacute;';
$lang['admin']['event_desc_editglobalcontentpre'] = 'Envoyer avant que l&#039;&eacute;dition d&#039;un bloc de contenu global soit enregistr&eacute;e';
$lang['admin']['event_desc_editglobalcontentpost'] = 'Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un bloc de contenu global aie &eacute;t&eacute; enregistr&eacute;e';
$lang['admin']['event_desc_deleteglobalcontentpre'] = 'Envoyer avant qu&#039;un bloc de contenu global soit supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_deleteglobalcontentpost'] = 'Envoyer apr&egrave;s qu&#039;un bloc de contenu global aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_globalcontentprecompile'] = 'Envoyer avant qu&#039;un bloc de contenu global soit envoy&eacute; &agrave; Smarty pour &ecirc;tre trait&eacute;';
$lang['admin']['event_desc_globalcontentpostcompile'] = 'Envoyer apr&egrave;s qu&#039;un bloc de contenu global aie &eacute;te trait&eacute; par Smarty';
$lang['admin']['event_desc_contenteditpre'] = 'Envoyer avant que l&#039;&eacute;dition d&#039;un contenu soit enregistr&eacute;e';
$lang['admin']['event_desc_contenteditpost'] = 'Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un contenu aie &eacute;t&eacute; enregistr&eacute;e';
$lang['admin']['event_desc_contentdeletepre'] = 'Envoyer avant qu&#039;un contenu soit supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_contentdeletepost'] = 'Envoyer apr&egrave;s qu&#039;un contenu aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me';
$lang['admin']['event_desc_contentstylesheet'] = 'Envoyer avant qu&#039;une feuille de style soit envoy&eacute;e au navigateur';
$lang['admin']['event_desc_contentprecompile'] = 'Envoyer avant qu&#039;un contenu soit envoy&eacute; &agrave; Smarty pour &ecirc;tre trait&eacute;';
$lang['admin']['event_desc_contentpostcompile'] = 'Envoyer apr&egrave;s qu&#039;un contenu aie &eacute;te trait&eacute; par Smarty';
$lang['admin']['event_desc_contentpostrender'] = 'Envoyer avant que le code html combin&eacute; soit envoy&eacute; au navigateur';
$lang['admin']['event_desc_smartyprecompile'] = 'Envoyer avant que tout contenu destin&eacute; &agrave; Smarty lui soit envoy&eacute; pour &ecirc;tre trait&eacute;';
$lang['admin']['event_desc_smartypostcompile'] = 'Envoyer apr&egrave;s que tout contenu destin&eacute; &agrave; Smarty aie &eacute;t&eacute; trait&eacute;';
$lang['admin']['event_help_loginpost'] = '<p>Envoyer apr&egrave;s la connexion d&#039;un utilisateur dans le panneau d&#039;administration.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet utilisateur concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_logoutpost'] = '<p>Envoyer apr&egrave;s la d&eacute;connexion d&#039;un utilisateur du panneau d&#039;administration.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet utilisateur concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_adduserpre'] = '<p>Envoyer avant qu&#039;un nouvel utilisateur soit cr&eacute;&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet utilisateur concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_adduserpost'] = '<p>Envoyer apr&egrave;s qu&#039;un nouvel utilisateur aie &eacute;t&eacute; cr&eacute;&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet utilisateur concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_edituserpre'] = '<p>Envoyer avant que l&#039;&eacute;dition d&#039;un utilisateur soit enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet utilisateur concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_edituserpost'] = '<p>Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un utilisateur aie &eacute;t&eacute; enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet utilisateur concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deleteuserpre'] = '<p>Envoyer avant qu&#039;un utilisateur soit supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet utilisateur concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deleteuserpost'] = '<p>Envoyer apr&egrave;s qu&#039;un utilisateur aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet utilisateur concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_addgrouppre'] = '<p>Envoyer avant qu&#039;un nouveau groupe soit cr&eacute;&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet groupe concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_addgrouppost'] = '<p>Envoyer apr&egrave;s qu&#039;un nouveau groupe aie &eacute;t&eacute; cr&eacute;&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet groupe concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_editgrouppre'] = '<p>Envoyer avant que l&#039;&eacute;dition d&#039;un groupe soit enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet groupe concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_editgrouppost'] = '<p>Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un groupe aie &eacute;t&eacute; enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet groupe concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deletegrouppre'] = '<p>Envoyer avant qu&#039;un groupe soit supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet groupe concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deletegrouppost'] = '<p>Envoyer apr&egrave;s qu&#039;un groupe aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet groupe concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_addstylesheetpre'] = '<p>Envoyer avant qu&#039;une nouvelle feuille de style soit cr&eacute;&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet feuille de style concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_addstylesheetpost'] = '<p>Envoyer apr&egrave;s qu&#039;une nouvelle feuille de style aie &eacute;t&eacute; cr&eacute;&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet feuille de style concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_editstylesheetpre'] = '<p>Envoyer avant que l&#039;&eacute;dition d&#039;une feuille de style soit enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet feuille de style concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_editstylesheetpost'] = '<p>Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;une feuille de style aie &eacute;t&eacute; enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet feuille de style concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deletestylesheetpre'] = '<p>Envoyer avant qu&#039;une feuille de style soit supprim&eacute;e du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet feuille de style concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deletestylesheetpost'] = '<p>Envoyer apr&egrave;s qu&#039;une feuille de style aie &eacute;t&eacute; supprim&eacute;e du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet feuille de style concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_addtemplatepre'] = '<p>Envoyer avant qu&#039;un nouveau gabarit soit cr&eacute;&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet gabarit concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_addtemplatepost'] = '<p>Envoyer apr&egrave;s qu&#039;un nouveau gabarit aie &eacute;t&eacute; cr&eacute;&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet gabarit concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_edittemplatepre'] = '<p>Envoyer avant que l&#039;&eacute;dition d&#039;un gabarit soit enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet gabarit concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_edittemplatepost'] = '<p>Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un gabarit aie &eacute;t&eacute; enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet gabarit concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deletetemplatepre'] = '<p>Envoyer avant qu&#039;un gabarit soit supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet gabarit concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deletetemplatepost'] = '<p>Envoyer apr&egrave;s qu&#039;un gabarit aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet gabarit concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_templateprecompile'] = '<p>Envoyer avant qu&#039;un gabarit soit envoy&eacute; &agrave; Smarty pour &ecirc;tre trait&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte du gabarit concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_templatepostcompile'] = '<p>Envoyer apr&egrave;s qu&#039;un gabarit aie &eacute;te trait&eacute; par Smarty.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte du gabarit concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_addglobalcontentpre'] = '<p>Envoyer avant qu&#039;un nouveau bloc de contenu global soit cr&eacute;&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet bloc de contenu global concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_addglobalcontentpost'] = '<p>Envoyer apr&egrave;s qu&#039;un nouveau bloc de contenu global aie &eacute;t&eacute; cr&eacute;&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet bloc de contenu global concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_editglobalcontentpre'] = '<p>Envoyer avant que l&#039;&eacute;dition d&#039;un bloc de contenu global soit enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet bloc de contenu global concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_editglobalcontentpost'] = '<p>Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un bloc de contenu global aie &eacute;t&eacute; enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet bloc de contenu global concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deleteglobalcontentpre'] = '<p>Envoyer avant qu&#039;un bloc de contenu global soit supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet bloc de contenu global concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_deleteglobalcontentpost'] = '<p>Envoyer apr&egrave;s qu&#039;un bloc de contenu global aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet bloc de contenu global concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_globalcontentprecompile'] = '<p>Envoyer avant qu&#039;un bloc de contenu global soit envoy&eacute; &agrave; Smarty pour &ecirc;tre trait&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte du bloc de contenu global concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_globalcontentpostcompile'] = '<p>Envoyer apr&egrave;s qu&#039;un bloc de contenu global aie &eacute;te trait&eacute; par Smarty.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte du bloc de contenu global concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_contenteditpre'] = '<p>Envoyer avant que l&#039;&eacute;dition d&#039;un contenu soit enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet contenu concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_contenteditpost'] = '<p>Envoyer apr&egrave;s que l&#039;&eacute;dition d&#039;un contenu aie &eacute;t&eacute; enregistr&eacute;e.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet contenu concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_contentdeletepre'] = '<p>Envoyer avant qu&#039;un contenu soit supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet contenu concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_contentdeletepost'] = '<p>Envoyer apr&egrave;s qu&#039;un contenu aie &eacute;t&eacute; supprim&eacute; du syst&egrave;me.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence &agrave; l&#039;objet contenu concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_contentstylesheet'] = '<p>Envoyer avant qu&#039;une feuille de style soit envoy&eacute;e au navigateur.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte de la feuille de style concern&eacute;e.</li>
</ol>
';
$lang['admin']['event_help_contentprecompile'] = '<p>Envoyer avant qu&#039;un contenu soit envoy&eacute; &agrave; Smarty pour &ecirc;tre trait&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte du contenu concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_contentpostcompile'] = '<p>Envoyer apr&egrave;s qu&#039;un contenu aie &eacute;te trait&eacute; par Smarty.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte du contenu concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_contentpostrender'] = '<p>Envoyer avant que le code html combin&eacute; soit envoy&eacute; au navigateur.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte html.</li>
</ol>
';
$lang['admin']['event_help_smartyprecompile'] = '<p>Envoyer avant que tout contenu destin&eacute; &agrave; Smarty lui soit envoy&eacute; pour &ecirc;tre trait&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte concern&eacute;.</li>
</ol>
';
$lang['admin']['event_help_smartypostcompile'] = '<p>Envoyer apr&egrave;s que tout contenu destin&eacute; &agrave; Smarty aie &eacute;t&eacute; trait&eacute;.</p>
<h4>Param&egrave;tres</h4>
<ol>
<li>R&eacute;f&eacute;rence au texte concern&eacute;.</li>
</ol>
...
$lang['admin']['utma'] = '156861353.441775673.1149914315.1154749500.1154790541.36';
$lang['admin']['utmz'] = '156861353.1154790541.36.14.utmccn=(referral)|utmcsr=wiki.cmsmadesimple.org|utmcct=/index.php|utmcmd=referral';
