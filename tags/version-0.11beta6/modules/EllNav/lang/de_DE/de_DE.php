...
$lang['help'] = '<h3>Was macht dieses Modul?</h3>
	<p>Dieses Modul erzeugt CSS-formatierte hierarchische Menus, welche auf der Seite basieren, die der User sich gerade anschaut.
    ...
    <p>Dieser Navigationsansatz hat ein horizontales Menu, in welchem sich der Toplevel-Inhalt befindet, und
    ein vertikales Menu, in welchem sich die Hierarchie der aktuellen Seite entfaltet. Dies l&auml;sst sich am besten 
    ...
    <ul><li>Personen
        ...
        <li>Jobs
        <ul><li>Management<ul><li>Erbsenzähler</li><li>Erbsensortierer</li></ul></li>
    ...
    ein Menu mit dem Inhalt "Strauss", "M&uuml;ller" and "Holzmann" &ouml;ffnen. Nach einem weiteren Klick auf "M&uuml;ller" w&uuml;rde die linke Navigation so 
   aussehen:</p>
    <ul><li>Strauss</li>
        <li>M&uuml;ller<ul><li>Klaus</li><li>Werner</li><li>Peter</li></ul></li>
        <li>Holzmann</li>
        </ul>
        <p>Und so weiter. So gibt es einige Optionen, um das Verhalten des Menus anzupassen. Weiter unten finden Sie hierzu mehr.</p>
	<h3>Wie wird es eingesetzt ?</h3>
	<P>(Bitte lesen Sie das README im "docs"-Verzeichnis dieses Moduls für ein Beispiel-Template.)</p>
	...
	<p>
	<ul>
		<li><em>(optional)</em> <tt>cssid</tt> - string, CSS-ID für das Menu (&lt;ul>-Tag im Toplevel). Standardmäßig ist keine ID vergeben.</li>
		...
		<li><em>(optional)</em> <tt>horizontal</tt> - 1/0, wenn Sie ein horizontales Menu haben m&ouml;chten. Aktuell
        ändert dies nur die Stylesheet-Information. (Standard = 0)</li>
		<li><em>(optional)</em> <tt>showtoplevel</tt> - 1/0, wenn Sie wollen, dass das Menu immer die gesamte Hierarchie ausgehend
        vom Toplevel anzeigt. Wenn Sie also ausgehend von dem oben mitgelieferten Beispiel "Personen" im linksseitigen Menu mit einbeziehen m&ouml;chten, sollten
        ...
        so wie das horizontale Menu unten im Beispiel beschrieben. (Standard = 0)</li>
        ...
        Dies ist besonders für Leute interessant, die mod_rewrite verwenden, so dass die Linknamen
        ...
        das Bulletmenu-Plugin. (Standard = 0)</li>
	</ul>
	</p>
	<h3>Stylesheet</h3>
	<p>Die Menus werden in einer einfachen, unsortierten Liste erzeugt. Die Toplevel &lt;ul>-Tags haben je nach Orientierungflag entweder die Klasse
    "menu_vert" oder
...
<h3>Support</h3>
<p>Dieses Modul beinhaltet keinen kommerziellen Support. Sie k&ouml;nnen jedoch über folgende Möglichkeiten Hilfe zu dem Modul erhalten:</p>
<ul>
<li>Für die letzte Version dieses Moduls, FAQs, dem Versand eines Fehlerreports oder dem Kauf kommerziellen Support besuchen Sie bitte SjG\'s
...
<p>Nach der GPL wird diese Software so ver&ouml;ffentlicht, wie sie ist. Bitte lesen Sie den Lizenztext für den vollen Haftungsausschluss.</p>
