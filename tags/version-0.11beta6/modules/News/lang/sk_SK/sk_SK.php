...
$lang['help'] = <<<EOF
	...
	<p>Novinky sú modul pre zobrazovanie udalostí na Vašich stránkach, podobne ako blogové zápisy, iba s viacej možnosťami! Po insťalácii modulu je vložená daľšia položka do administračného menu a to Vám umožní vybrať alebo vložiť kategóriu noviniek. Po vytvoření alebo zvolení kategórie je zobrazený zoznam noviniek pre túto kategóriu. Odtiaľto môžete pridávať, upravovať alebo mazať novinky konkrétnej kategórie.</p>
	<h3>Bezpečnosť</h3>
