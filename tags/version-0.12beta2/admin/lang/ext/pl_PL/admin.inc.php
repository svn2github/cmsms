...
$lang['admin']['assignments'] = 'Przypisz użytkowników';
...
$lang['admin']['back'] = 'Wróć do menu';
$lang['admin']['backtoplugins'] = 'Wróc do listy wtyczek';
...
$lang['admin']['editusertag'] = 'Edycja własnych znaczników';
...
$lang['admin']['errornofilesexported'] = 'Błąd przy eksporcie plików do xml';
...
$lang['admin']['headtags'] = 'Nagłówki';
$lang['admin']['help'] = 'Pomoc';
$lang['admin']['helpaddtemplate'] = '<p>Szablon jest tym, co kontroluje wygląd Twojego serwisu.</p><p>Możesz tutaj stworzyć układ serwisu i dodać CSS w sekcji Arkusze styli, aby kontrolować wygląd różnych elementów.</p>';
...
$lang['admin']['imagemanagement'] = 'Menadżer obrazków';
...
$lang['admin']['missingparams'] = 'Brakuje niektórych parametrów lub są nieprawidłowe';
...
$lang['admin']['passwordagain'] = 'Hasło (powtórz)';
...
$lang['admin']['siteprefs'] = 'Ustawienia ogólne';
...
$lang['admin']['filemanager'] = 'Menadżer plików';
$lang['admin']['imagemanager'] = 'Menadżer obrazków';
...
$lang['admin']['preferencesdescription'] = 'Tutaj ustawia się różne preferencje dotyczące całego serwisu.';
$lang['admin']['adminlogdescription'] = 'Wyświetla dziennik kto i co robił administracyjnie';
$lang['admin']['mainmenu'] = 'Menu główne';
...
$lang['admin']['groupassignmentdescription'] = 'Przypisywanie użytkowników do grup';
$lang['admin']['groupperms'] = 'Uprawnienia grup';
$lang['admin']['grouppermsdescription'] = 'Ustawianie uprawnień i poziomów dostępu dla grup';
$lang['admin']['pagesdescription'] = 'Dodawanie i edycja stron i innych treści';
$lang['admin']['htmlblobdescription'] = 'Binarne obiekty HTML są fragmentami treści, które możesz umieścić na swoich stronach lub w szablonach.';
...
$lang['admin']['stylesheetsdescription'] = 'Zarządzanie arkuszami styli jest zaawansowaną techniką utrzymywania arkuszy CSS oddzielnie od szablonów';
$lang['admin']['filemanagerdescription'] = 'Wgrywanie i zarządzanie plikami';
$lang['admin']['imagemanagerdescription'] = 'Wgrywanie, edycja i usuwanie obrazków';
$lang['admin']['moduledescription'] = 'Moduły rozszerzają CMS Made Simple i dostarczają zróżnicowaną funkcjonalność.';
$lang['admin']['tagdescription'] = 'Znaczniki są małymi fragmentami funkcjonalnymi, które mogą być dodane do Twojej treści i/lub szablonów';
$lang['admin']['usertagdescription'] = 'Znaczniki, które możesz tworzyć i modydikować sam, aby wykonać specyficzne zadania wprost z przeglądarki';
...
$lang['admin']['usersgroupsdescription'] = 'Elementy odnoszące się do użytkowników i grup';
...
$lang['admin']['admincallout'] = 'Skróty administratora';
...
$lang['admin']['indent'] = 'Rób wcięcia w liście stron aby uwydatnić hierarchię';
...
$lang['admin']['adminpaging'] = 'Ilość elementów zawartości do pokazania na stronie w liście stron';
...
$lang['admin']['myaccountdescription'] = 'Tutaj możesz zaktualizować szczegóły dotyczące Twojego konta osobistego.';
...
$lang['admin']['langparam'] = 'Ten parametr jest używany do określenia którego języka używać do wyświetlania frontendu. Nie wszystkie moduły wspierają to i nie wszystkie tego potrzebują.';
...
$lang['admin']['xml'] = 'XML';
$lang['admin']['xmlmodulerepository'] = 'URL serwera Repozytorium Modułów';
