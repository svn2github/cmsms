...
<li>1.5 - Changement de version pour &ecirc;tre compatible avec la 1.1 seulement, et ajout du SetParameterTypes</li>
	<li>1.4.1 -- Fixe un probleme sur le menu si includeprefix n&#039;est pas sp&eacute;cifi&eacute;.
	...
	<li>Version: 1.1 -- Ajout du support de l&#039;attribut target, principalement pour le type de contenu &quot;lien&quot;</li> 
	<li>Version: 1.0 -- Version initiale</li> 
	</ul> ';
...
$lang['help_includeprefix'] = 'Inclu seulement les items dont la page alias contient le dit pr&eacute;fixe indiqu&eacute; (virgule comme s&eacute;parateur). Ce param&egrave;tre ne peut pas &ecirc;tre combin&eacute; avec le param&egrave;tre excludeprefix.';
$lang['help_excludeprefix'] = 'Exclu tous les items (et leurs enfants) dont la page alias contient le dit pr&eacute;fixe indiqu&eacute; (virgule comme s&eacute;parateur). Ce param&egrave;tre ne peut pas &ecirc;tre combin&eacute; avec le param&egrave;tre includeprefix.';
...
$lang['help_show_all'] = 'Cette option afichera tous les niveaux si ils sont coch&eacute;s visibles dans le menu. Il n&#039;affichera pas les pages inactives.';
...
$lang['help'] = '	<h3>Que fait ce module&nbsp;?</h3>
	...
	<p>Les param&egrave;tres pour l&#039;&eacute;l&eacute;ment $node utilis&eacute;s dans un gabarit sont les suivants&nbsp;:
		<ul>
			...
			<li>$node->target -- Cible du lien. Sera vide si non-d&eacute;fini dans le contenu</li>
