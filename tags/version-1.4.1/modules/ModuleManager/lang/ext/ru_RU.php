...
$lang['compatibility_disclaimer'] = 'Отображаемые здесь модули сделаны как и разработчиками CMS, так и независимыми пользователями системы.  Мы не даем никаких гарантий, что доступные здесь модули являются функциональными, протестированы или совместимы с Вашей системой. Для установки модулей Вам рекомендуется прочитать помощь и информацию доступную по ссылке, напротив каждого модуля.';
$lang['notice'] = 'Уведомление';
$lang['general_notice'] = 'Версии, представленных здесь модулей, соответствуют последним версиям XML файлов, выложенных на на выбранном Вами сервере (по умолчанию CMS %s).  Они могут не являться последними анонсированными версиями.  Возможно Вы захотите посмотреть все версии файлов, выложенных на сервере.  Если Вы используете сервер по умолчанию, Вы можете сделать это задав название модуля в поисковой форме на  %s и нажав на кнопку "Files".';
...
$lang['utma'] = '156861353.1046687432.1205149796.1217001458.1217003903.122';
$lang['utmz'] = '156861353.1216932234.120.39.utmcsr=forum.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/index.php';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353';
?>