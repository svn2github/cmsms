...
$lang['admin']['extra1'] = 'Страница 1 с дополнительными атрибутами';
$lang['admin']['extra2'] = 'Страница 2 с дополнительными атрибутами';
$lang['admin']['extra3'] = 'Страница 3 с дополнительными атрибутами';
...
$lang['admin']['warning_mail_settings'] = 'Ваши настройки почты не сконфигурированы. Это может сказаться на способности вашего сайта отправлять сообщения по электронной почте.  Вы должны перейти в <a href="moduleinterface.php?module=CMSMailer">Extensions >> CMSMailer</a> и настроить параметры почты согласно информации, представленной вашим хостером.';
