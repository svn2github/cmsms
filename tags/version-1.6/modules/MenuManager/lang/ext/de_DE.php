	...
	<p>Die im Template zu verwendeten Parameter f&uuml;r das $node-Objekts lauten wie folgt:
		<ul>
			...
			<li>$node->titleattribute -- Beschreibung oder Titel-Attribut (Titel), falls definiert</li>
                        <li>$node->extra1 -- Zus&auml;tzliches Seiten-Attribut 1</li>
                        <li>$node->extra2 -- Zus&auml;tzliches Seiten-Attribut 2</li>
                        <li>$node->extra3 -- Zus&auml;tzliches Seiten-Attribut 3</li>
			...
			<li>$node->menutext -- Men&uuml;text</li>
                        <li>$node->image -- Bild f&uuml;r einen grafischen Link
                        <li>$node->thumbnail -- Vorschaubild f&uuml;r einen grafischen Link
...
$lang['utma'] = '156861353.717462736.1147511856.1242330211.1242482532.357';
