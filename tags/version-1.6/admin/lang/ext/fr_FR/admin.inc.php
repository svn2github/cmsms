...
$lang['admin']['info_autoalias'] = 'Si ce champ est vide, un alias se cr&eacute;er automatiquement.';
...
$lang['admin']['warning_upgrade'] = '<em><strong>ATTENTION</strong></em>&nbsp;: CMSMS a besoin d&#039;une mise &agrave; jour - Le dossier /install doit &ecirc;tre pr&eacute;sent !';
...
$lang['admin']['help_function_embed'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Inclu une autre application dans votre CMS. le plus utilis&eacute; est par exemple un forum. 
	Cette application utilise IFRAMES, mais des anciens avigateurs peuvent avoir des probl&egrave;mes. D&eacute;sol&eacute; mais c&#039;est la seule mani&egrave;re de fonctionner sans l&#039;application externe.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<ul>
        <li>a) Ajouter la balise <code>{embed header=true}</code> dans la section &quot;Head&quot;  de votre gabarit de page, ou dans la section &quot;M&eacute;tadonn&eacute;es sp&eacute;cifiques pour cette page&quot; dans l&#039;onglet option de votre page.  Cela permettra de s&#039;assurer que le javascript est inclu. Si vous ins&eacute;rez cette balise dans la section des &quot;M&eacute;tadonn&eacute;es&quot; dans l&#039;onglet option de votre page, vous devez vous assurer que la balise
<code>{metadata}</code> est bien dans votre gabarit de page.</li>
        <li>b) Ajouter la balise <code>{embed url=&quot;http://www.google.com&quot;}</code> dans votre page ou dans le corps du gabarit e la page.</li>
        </ul>
        <br/>
	...
	<p>Ajouter le code suivant dans votre feuille de style CSS :</p>
        ...
        <ul>
            ...
            <li>(option) name - une option pour utiliser le nom de l&#039;iframe (au lieu de myframe).<p>Si cette option est utilis&eacute;e, elle doit &ecirc;tre identique dans les deux appel, ex : {embed header=true name=foo} and {embed name=foo url=http://www.google.com}.</p></li>
        </ul>';
$lang['admin']['help_function_edit'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{edit}</code><br></p>
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
                <li><em>(option)</em> showbutton - Mis &agrave; &quot;true&quot;  fera appara&icirc;tre une icone plut&ocirc;t qu&#039;un lien texte</li>
        </ul>';
...
$lang['admin']['help_function_created_date'] = '        <h3>Que fait cette Balise ?</h3>
        ...
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
                <li><em>(option)</em> format - Date/Time utiliise le format de la fonction PHP strftime. Voir <a href="http://php.net/strftime" target="_blank">ici</a> pour un param&egrave;tre et les informations.</li>
        </ul>';
...
<p>Exemple de passage d&#039;une page de contenu des tags d&eacute;finis par l&#039;utilisateur comme un param&egrave;tre :</p>
<pre>
...
$lang['admin']['nopasswordforrecovery'] = 'Aucune adrresse email pour cet utilisateur. R&eacute;cup&eacute;ration de Mot de passe impossible. Merci de contactez votre administrateur.';
$lang['admin']['lostpw'] = 'Mot de passe oubli&eacute; ?';
$lang['admin']['lostpwemailsubject'] = '[%s] R&eacute;cup&eacute;ration du Mot de passe';
$lang['admin']['lostpwemail'] = 'Vous recevez cet email parce qu&#039;une demande a &eacute;t&eacute; faite pour modifier le mot de passe (%s) associ&eacute; &agrave; ce compte d&#039;utilisateur (%s). Si vous souhaitez r&eacute;initialiser le mot de passe pour ce compte, cliquez simplement sur le lien ci-dessous ou collez-le dans la barre d&#039;adresse de votre navigateur pr&eacute;f&eacute;r&eacute; :
%s

Si vous pensez qu&#039;il sagit d&#039;une erreur, ignorer tout simplement le message.';
$lang['admin']['utmz'] = '156861353.1242718691.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
$lang['admin']['utma'] = '156861353.2078807911.1242718691.1242718691.1242752972.2';
