...
$lang['none'] = 'Ž&aacute;dn&eacute;';
$lang['ssl'] = 'SSL';
$lang['tls'] = 'TLS';
$lang['secure'] = 'K&oacute;dovac&iacute; mechanismus';
$lang['info_secure'] = 'Použiteln&eacute; jen na SMTP metodu odes&iacute;l&aacute;n&iacute;, tato volba povoluje nastaven&iacute; jin&eacute;ho k&oacute;dovac&iacute;ho mechanismu pro připojen&iacute;';
$lang['info_cmsmailer'] = 'Tento modul je využ&iacute;v&aacute;n množstv&iacute;m dal&scaron;&iacute;ch modulů pro zas&iacute;l&aacute;n&iacute; emailů. Mus&iacute; b&yacute;t spr&aacute;vně nakonfigurov&aacute;n dle nastaven&iacute; Va&scaron;eho hostitele. Použijte pros&iacute;m informace poskytnut&eacute; Va&scaron;&iacute;m hostitelem pro nastaven&iacute; těchno hodnot. Pokud V&aacute;m nejdou st&aacute;le odes&iacute;lat testovac&iacute; zpr&aacute;vy, zkuste kontaktovat Va&scaron;eho hostitele pro pomoc.';
...
$lang['changelog'] = '<ul>
<li>Version 1.73.1. ř&iacute;jen, 2005. Prvn&iacute; vyd&aacute;n&iacute;.</li>
<li>Version 1.73.2. ř&iacute;jen, 2005. Odstraněn&iacute; drobn&yacute;ch chyb v Administračn&iacute;m panelu. Vysouvac&iacute; pole neodpov&iacute;dalo aktu&aacute;ln&iacute; hodnotě uložen&eacute; v datab&aacute;zi</li>
<li>Version 1.73.3. ř&iacute;jen, 2005. Odstraněn&iacute; drobn&yacute;ch chyb při odes&iacute;l&aacute;n&iacute; html emailu</li>
...
<li>Version 1.73.5. listopad, 2005. Přid&aacute;na funkcionalita a formul&aacute;řov&aacute; pole pro SMTP ověřen&iacute;.</li>
<li>Version 1.73.6. prosinec, 2005. V&yacute;choz&iacute; metoda maileru po instalaci je SMTP, vylep&scaron;en&aacute; dokumentace a při resetu se resetuj&iacute; i př&iacute;lohy, adresy atd.</li>
<li>Version 1.73.7. leden, 2006. Zvět&scaron;ena d&eacute;lka vět&scaron;iny pol&iacute;</li>
<li>Version 1.73.8. leden, 2006. Změněn panel vlastnost&iacute;, aby byl o trochu v&iacute;c informativněj&scaron;&iacute;.</li>
<li>Version 1.73.9. leden, 2006. Přid&aacute;na možnost testovac&iacute;ho emailu a přid&aacute;no potvrzen&iacute; na každ&eacute; tlač&iacute;tko (kromě storno)</li>
<li>Version 1.73.10. srpen, 2006. Modul upraven na &quot;l&iacute;n&eacute; nač&iacute;t&aacute;n&iacute;&quot;, aby se zmen&scaron;ilo využit&iacute; paměti když CMSMailer nen&iacute; použ&iacute;v&aacute;n.</li>
<li>Version 1.73.13. leden, 2008.  Přid&aacute;no v&iacute;ce kontrol opr&aacute;vněn&iacute;.</li>
<li>Version 2.0.1 - leden, 2011 - Odstraněno tlač&iacute;tko storno.</li>
<li>Version 2.0.2 - z&aacute;ř&iacute;, 2011 - V&yacute;choz&iacute; znakov&aacute; sada nastavena na utf-8.</li>
</ul>';
$lang['help'] = '<h3>Co děl&aacute; tento modul?</h3>
<p>Tento modul neposkytuje ž&aacute;dnou funkci pro použit&iacute; uživatelem. Je určen pro začleněn&iacute; do ostatn&iacute;ch modulů a umožňuje odes&iacute;l&aacute;n&iacute; emailů. To je v&scaron;e, nic v&iacute;c.</p>
<h3>Jak mohu modul použ&iacute;t</h3>
<p>Tento modul poskytuje jednoduch&yacute; wrapper metod a proměnn&yacute;ch PHPMaileru. Je určen pro v&yacute;voj&aacute;ře modulů. n&iacute;že je uveden př&iacute;klad a stručn&aacute; reference API. Pros&iacute;m přečtěte si přiloženou dokumentaci PHPMaileru pro dal&scaron;&iacute; informace.</p>
