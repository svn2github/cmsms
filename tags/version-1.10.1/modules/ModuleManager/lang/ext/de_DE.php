...
$lang['info_disable_caching'] = '<strong>Nicht empfohlen!</strong> Aus Performance-Gr&uuml;nden werden die vom ModulManager abgerufenen Daten zwischengespeichert (voreingestellt f&uuml;r 1 Stunde)';
$lang['operation_results'] = 'Ergebnisse der Operation';
$lang['error_noresults'] = 'Von der abgefragten Operation wurden einige Ergebnisse erwartet, es wurde aber nichts gefunden. Bitte versuchen Sie, dies zu reproduzieren, und leiten dann die Ergebnisse Ihrer Analyse f&uuml;r weitere Diagnosen an Ihren Support weiter';
$lang['versionsformodule'] = 'Verf&uuml;gbare Versionen des %s-Moduls';
$lang['yourversion'] = 'Ihre Version';
$lang['latestdepends'] = 'Immer die neuesten Module installieren';
$lang['info_latestdepends'] = 'Werden Module mit Abh&auml;ngigkeiten von anderen Modulen installiert, kann mit dieser Option sichergestellt werden, dass immer nur die letzte Version der Abh&auml;ngigkeiten installiert werden';
...
$lang['notice_depends'] = '%s ist von den weiteren Aktionen abh&auml;ngig. Klicken Sie zum Weitermachen auf &quot;Installieren&quot;.';
...
$lang['error_skipping'] = 'Aufgrund von Fehlern in den Einstellungen der Abh&auml;ngigkeiten wurde die Installation/Aktualisierung von %s &uuml;bersprungen. Bitte schauen Sie sich die nachfolgenden Hinweise an und versuchen es dann noch einmal.';
...
$lang['error_permissions'] = '<strong><em>WARNUNG:</em></strong> Die Berechtigungen des Verzeichnisses sind f&uuml;r die Installation von Modulen nicht ausreichend. Eventuell k&ouml;nnten auch Probleme mit dem PHP-Safe-Modus Ihres Servers auftreten. Bitte stellen Sie sicher, dass der Safe-Modus Ihres Servers deaktiviert ist und die Dateiberechtigungen ausreichend sind.';
$lang['error_minimumrepository'] = 'Die ModulRepository-Version ist mit diesem ModulManager nicht kompatibel';
$lang['prompt_reseturl'] = 'Die URL auf die programmseitige Voreinstellung zur&uuml;cksetzen';
...
$lang['error_unsatisfiable_dependency'] = 'Konnte das erforderliche Modul &quot;%s&quot; (Version %s oder h&ouml;her) im Moduldepot nicht finden. Es wird von %s ben&ouml;tigt; dies k&ouml;nnte auf ein Problem mit der im Moduldepot vorhandenen Version des Moduls hinweisen. Bitte kontaktieren Sie den Autor des Moduls. Vorgang abgebrochen.';
...
$lang['text_repository_url'] = 'Die URL sollte folgendes Format haben:  http://www.meine-webseite.de/ModuleRepository/request/v2';
...
$lang['time_warning'] = 'Wenn die Installationsliste mehr als zwei Module enth&auml;lt, kann die Installation ein paar Minuten in Anspruch nehmen. Bitte haben Sie etwas Geduld!';
$lang['helptxt'] = 'Hilfe';
...
$lang['moddescription'] = 'Ein Client f&uuml;r das Modul &quot;ModulRepository&quot;. Dieses Modul erlaubt die Vorschau und die Modul-Installation von Remote-Seiten aus, ohne dass diese &uuml;ber FTP auf den Server geladen oder entpackt werden m&uuml;ssen. Die XML-Moduldateien werden &uuml;ber die SOAP-Technologie herunter geladen, auf Integrit&auml;t &uuml;berpr&uuml;ft und automatisch entpackt.';
...
<p>Ein Client f&uuml;r das Modul &quot;ModulRepository&quot;. Dieses Modul erlaubt die Vorschau und die Modul-Installation von Remote-Seiten aus, ohne dass diese per FTP auf den Server geladen oder entpackt werden m&uuml;ssen. Die XML-Modul-Dateien werden &uuml;ber die SOAP-Technologie herunter geladen, auf Integrit&auml;t &uuml;berpr&uuml;ft und automatisch entpackt.</p>
<h3>Wie wird es eingesetzt ?</h3>
<p>Zur Verwendung dieses Moduls ben&ouml;tigen Sie die Berechtigung &#039;Modify Modules&#039; und die URL einer &#039;ModulRepository&#039;-Installation. Diese URL k&ouml;nnen Sie auf der Seite &#039;Erweiterungen > ModulManager > Einstellungen&#039; festlegen.</p>
...
$lang['utma'] = '156861353.1689361602.1315895785.1315895785.1315895785.1';
$lang['utmz'] = '156861353.1315895785.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
