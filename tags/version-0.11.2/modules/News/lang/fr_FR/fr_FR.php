...
$lang['detailtemplate'] = 'Gabarit du détail de l\'article';
...
$lang['helpsummarytemplate'] = 'Utilise un gabarit séparé pour l\'affichage du sommaire des articles.  Il doit se trouver dans modules/News/templates.';
$lang['helpdetailtemplate'] = 'Utilise un gabarit séparé pour l\'affichage du détail des articles.  Il doit se trouver dans modules/News/templates.';
...
$lang['helpdateformat'] = 'Format d\'affichage de la date de l\'article.  Ceci est basé sur la fonction <a href="http://php.net/strftime" target="_blank">strftime</a> et peut être utilisé dans votre gabarit avec $entry->formatpostdate.';
$lang['help'] = <<<EOF
	...
	<p>La façon la plus facile de l'utiliser est en conjonction avec la balise cms_module.  Cela insérera votre module dans votre gabarit ou votre page page où vous le désirez, et y affichera les articles.  Exemple de synthaxe: <code>{cms_module module="news" number="5" category="beer"}</code></p>
EOF;
?>