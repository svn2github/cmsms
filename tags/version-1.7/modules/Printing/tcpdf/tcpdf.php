...
if (!class_exists('TCPDF')) {
	 ...
	 */ 
	define('PDF_PRODUCER', 'TCPDF 4.6.006_PHP4 (http://www.tcpdf.org)');
	...
	*/
	class TCPDF {
		...
		* @since 4.6.005 (2009-04-24)
		*/
		function setSignature($signing_cert='', $private_key='', $private_key_password='', $extracerts='') {
