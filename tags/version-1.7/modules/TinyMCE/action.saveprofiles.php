...
if (isset($params["submitbasic"])) {
  ...
  if (isset($params['toolbar3'])) $this->SetPreference('toolbar3', $params['toolbar3'] );
  ...
  if (isset($params['showfilemanagement'])) $this->SetPreference('showfilemanagement', 1 ); else $this->SetPreference('showfilemanagement', 0 );
  if (isset($params['restrictdirs'])) $this->SetPreference('restrictdirs', 1 ); else $this->SetPreference('restrictdirs', 0 );
...
if (isset($params["submitadvancedprofile"])) {
	if (isset($params['advanced_toolbar1'])) $this->SetPreference('advanced_toolbar1', $params['advanced_toolbar1'] );
	if (isset($params['advanced_toolbar2'])) $this->SetPreference('advanced_toolbar2', $params['advanced_toolbar2'] );
  if (isset($params['advanced_toolbar3'])) $this->SetPreference('advanced_toolbar3', $params['advanced_toolbar3'] );
	if (isset($params['advanced_allow_tables'])) $this->SetPreference('advanced_allow_tables', $params['advanced_allow_tables'] ); else $this->SetPreference('advanced_allow_tables', "0");
  ...
  if (isset($params['advanced_showfilemanagement'])) $this->SetPreference('advanced_showfilemanagement', 1 ); else $this->SetPreference('advanced_showfilemanagement', 0 );
...
if (isset($params["submitfront"])) {
  ...
  if (isset($params['front_toolbar3'])) $this->SetPreference('front_toolbar3', $params['front_toolbar3'] );
