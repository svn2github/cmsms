...
$this->CreateInputText($id, 'advanced_toolbar1', $advanced_toolbar1, 120 ));

$this->smarty->assign('advanced_toolbar2_input',
$this->CreateInputText($id, 'advanced_toolbar2', $advanced_toolbar2, 120 ));

$this->smarty->assign('advanced_toolbar3_input',
$this->CreateInputText($id, 'advanced_toolbar3', $advanced_toolbar3, 120 ));
