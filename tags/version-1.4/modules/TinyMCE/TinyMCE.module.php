...
class TinyMCE extends CMSModule {
	...
	function ResetSettings($whatsettings="all") {
		...
		if ($whatsettings=="all" || $whatsettings=="toolbars") {
			...
			$this->SetPreference('front_toolbar1',"cut,paste,copy,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,styleselect,formatselect,fontselect,fontsizeselect");
