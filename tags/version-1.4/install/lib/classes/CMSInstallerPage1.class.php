...
class CMSInstallerPage1 extends CMSInstallerPage
{
	...
	function assignVariables()
	{
		...
		{
			$settings['required'][] = testCreateDirAndFile(1, lang('test_create_dir_and_file'), lang('info_create_dir_and_file'));
		}
		...
		else
		{
			...
			$settings['recommended'][] = testDirWrite(0, lang('test_check_session_save_path'), $session_save_path, lang('test_check_session_save_path_failed', $session_save_path), 1);
		}
