<?php
$lang['admin']['create_dir_and_file'] = 'Проверка, может ли httpd процесс создать файл внутри созданного им каталога';
$lang['admin']['os_session_save_path'] = 'Проверка невозможна из-за OS path';
$lang['admin']['unlimited'] = 'Неограничено';
$lang['admin']['open_basedir'] = 'Опция open_basedir';
...
$lang['admin']['page_metadata'] = 'Metadata для данной страниц';
...
$lang['admin']['info_generate_cksum_file'] = 'Эта функция позволит Вам создать контрольную сумму файла и сохранить его на локальном компьютере для последующей проверки. Это должно быть сделано непосредственно перед запусков веб-сайта и / или после каких-либо обновлений и значительных изменений.';
$lang['admin']['info_validation'] = 'Эта функция сравнивает контрольную сумму из загруженного файла с файлами на текущей установке. Она может помочь в поиске проблем при загрузке, или точно установить, какие файлы были изменены, если ваша система была взломанна. Контрольная сумма файла генерируется для каждого выпуска CMS Made Simple начиная с версии 1.4 и выше.';
$lang['admin']['download_cksum_file'] = 'Загрузить контрольную сумму файла';
$lang['admin']['perform_validation'] = 'Произвести проверку';
$lang['admin']['upload_cksum_file'] = 'Отправить контрольную сумму файла';
$lang['admin']['checksumdescription'] = 'Проверить целостность CMS-файлов, путем сравнивания контрольных сумм';
$lang['admin']['system_verification'] = 'Контроль системы';
$lang['admin']['extra1'] = 'Страница 1 с дополнительными аттрибутами';
$lang['admin']['extra2'] = 'Страница 2 с дополнительными аттрибутами';
$lang['admin']['extra3'] = 'Страница 3 с дополнительными аттрибутами';
...
$lang['admin']['warning_upgrade_info1'] = 'В настоящее время работает схема версии %s. и вы должны обновить её до версии %s';
...
$lang['admin']['server_information'] = 'Онформация о сервере';
...
$lang['admin']['safe_mode'] = 'PHP безопасный режим';
...
$lang['admin']['systeminfo_copy_paste'] = 'Скопируйте и вставьте выделенный текст для размещения в вашем форуме';
$lang['admin']['help_systeminformation'] = 'Информация отображаемая ниже собрана из конфигурационных данных Вашего сервера и представлена здесь в сжатом виде, для того, чтобы вы сразу могли увидеить все настройки, при при попытке диагностировать проблему или обращении за помощью с вашей установкой.';
$lang['admin']['systeminfo'] = 'Информация о системе';
$lang['admin']['systeminfodescription'] = 'Показ различной информации о Вашей системе, которая может быть полезна при диагностике проблемы.';
...
$lang['admin']['nogcbwysiwyg'] = 'Запретить WYSIWYG редакторы в глобальном контенте блоков';
...
$lang['admin']['login_info'] = 'С этой точки следует принять во внимание следующие параметры';
...
$lang['admin']['jsdisabled'] = 'Извините, данная функция требует чтобы у вас был включен Javascript.';
...
$lang['admin']['frontendwysiwygtouse'] = 'Фронтенд wysiwyg';
$lang['admin']['all_groups'] = 'Все группы';
$lang['admin']['utmz'] = '156861353.1217434714.126.41.utmcsr=forum.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/index.php';
$lang['admin']['utma'] = '156861353.1046687432.1205149796.1217434714.1217665944.127';
