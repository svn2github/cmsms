...
#
#$Id: CMSUpgradePage2.class.php 239 2009-10-03 17:32:59Z calguy1000 $
...
class CMSInstallerPage2 extends CMSInstallerPage
{
	...
	function assignVariables()
	{
		...
		$settings['recommended'][] = testBoolean(0, 'session.use_cookies', 'session.use_cookies', lang('session.use_cookies'));
