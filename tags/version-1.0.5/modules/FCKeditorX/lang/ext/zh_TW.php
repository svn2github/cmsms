...
$lang['postinstall'] = '務必設定「修改 FCKeditorX」許可來使用這套元件！';
$lang['postuninstall'] = '解除安裝後';
$lang['uninstalled'] = '模組己解除安裝。';
$lang['installed'] = '模組己安裝的版本 %s 。';
$lang['prefsupdated'] = '模組的偏愛設定已更新。';
$lang['accessdenied'] = 'Access Denied. Please check your permissions.';
$lang['error'] = 'Error!';
$lang['upgraded'] = '模組己升級到版本 %s.';
$lang['title_mod_prefs'] = '模組的偏愛設定';
