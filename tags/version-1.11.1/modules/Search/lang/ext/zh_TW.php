...
$lang['search'] = '搜尋';
$lang['param_submit'] = '將文字放到提交按鈕';
$lang['param_searchtext'] = '將文字放到提交欄位';
...
than, too, very';
$lang['prompt_resetstopwords'] = '從以下語言加載默認的停止詞';
$lang['input_resetstopwords'] = '加載';
$lang['searchresultsfor'] = '搜索結果';
$lang['noresultsfound'] = '沒有！';
...
$lang['options'] = '選項';
$lang['eventdesc-SearchInitiated'] = '搜索開始時發送。';
$lang['eventdesc-SearchCompleted'] = '搜索完成時發送。';
...
$lang['eventhelp-SearchInitiated'] = '<p>搜索開始時發送。</p>
<h4>參數</h4>
<ol>
<li>被搜尋的文字。</li>
</ol>';
$lang['eventhelp-SearchCompleted'] = '<p>搜索完成時發送。</p>
<h4>參數</h4>
<ol>
<li>被搜尋的文字。</li>
<li>完成結果的陣列。</li>
