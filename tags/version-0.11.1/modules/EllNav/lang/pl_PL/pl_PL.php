...
$lang['uninstalled'] = 'Moduł niezainstalowany.'; // Module Uninstalled.';
$lang['installed'] = 'Zainstalowany moduł w wersji %s'; // 'Module version %s installed.';
$lang['upgraded'] = 'Moduł zaktualizowany do wersji %s'; // 'Module upgraded to version %s.';
$lang['changelog'] = '<ul>
...
$lang['help'] = '<h3>Do czego to służy ?</h3>
	<p>Moduł ten tworzy hierarchiczne menu sformatowane w CSS, bazujące na stronie, którą użytkownik ogląda.
	Zwykle jest to używane do podziału zawartości serwisu na "komory", np. tradycyjna, przystępna nawigacja
	w kształcie litery L.</p>
	<p>Ten typ nawigacji posiada poziome menu, które obejmuje zawartość najwyższego poziomu oraz
	pionowe menu, które rozwija hierarchię która zawiera obecną stronę. Najlepiej wyjaśnić to na przykładzie.
	Wyobraź sobie następującą hierarchię:</p>
    <ul><li>Ludzie
    ...
    <p>Najwyższy poziom nawigacji (menu poziome) będzie zawierał "Ludzie", "Zawody" i "Lokalizacje".
    Kliknięcie w "Ludzie" spowoduje otwarcie menu z lewej strony, które będzie zawierać "Lavonne", "Yehudit" i "Horatio".
    Kliknięcie w "Yehudit" spowoduje, że lewe menu będzie wyglądać tak:</p>
    <ul><li>Lavonne</li>
        <li>Yehudit<ul><li>Beulah</li><li>Pakasit</li><li>Abdullah</li></ul></li>
        <li>Horatio</li>
        </ul>
        <p>i tak dalej. Są też opcje, aby dostosować zachowanie elementów modułu. Zobacz poniżej.</p>
	<h3>Jak się tego używa ?</h3>
	<p>(Przeczytaj proszę plik README znajdujący się w katalogu "docs" dla przykładowych szablonów)</p>
	<p>Należy po prostu wstawić kod modułu do strony lub szablonu. Kod powinien wyglądać mniej więcej tak: <code>{cms_module module=\'EllNav\'}</code></p>
