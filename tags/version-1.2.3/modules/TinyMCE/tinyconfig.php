...
?>			
			entity_encoding : "<?php echo $tiny->GetPreference('entityencoding','raw') ?>", 
      ...
      theme : "advanced",
			...
			theme_advanced_blockformats : "<?php echo $tiny->GetPreference("dropdownblockformats",$tiny->defaultblockformats);?>",
			document_base_url : "<?php echo $gCms->config['root_url']?>/",
			relative_urls : "true",
			language: "<?php
			if (isset($_SESSION["tiny_live_language"])) echo $_SESSION["tiny_live_language"]; else echo "en";?>",
			dialog_type: "modal",
			...
			file_browser_callback : 'TinyMCE_SimpleBrowserPlugin_browse',
			<?php 
