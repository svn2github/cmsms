...
$lang['help_includeprefix'] = 'Omvat alle items waarvan de pagina alias overeen komt met een van de opgegeven (comma separated) prefixen. Deze parameter mag niet samen met de sluit uit prefix parameter gebruikt worden.';
$lang['help_excludeprefix'] = 'Sluit alle items uit (en hun subitems) waarvan de pagina alias overeen komt met een van de opgegeven (comma separated) prefixen. Deze parameter mag niet samen met de omvat prefix parameter gebruikt worden.';
...
$lang['help_show_all'] = 'Deze optie laat alle knoppen in het menu zien, zelfs als deze op onzichtbaar staan. Het laat echter niet de niet actieve pagina&#039;s zien.';
