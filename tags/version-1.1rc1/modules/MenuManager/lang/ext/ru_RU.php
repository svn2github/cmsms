...
$lang['help_show_root_siblings'] = 'Эту опцию полезно использовать только если используются start_element или start_page. Она отобразит элементы одного уровня по стороне отобранного start_page/element.';
