...
//cannot require admin-login as it should work for
...
if ($tiny->GetPreference("includeonlyscreencss",0)==1) {
	$query.="AND (c.media_type = ? OR c.media_type = 'all')";
	$params=array($templateid,$mediatype);
}
...
$stripbackground = $tiny->GetPreference("striptags");
