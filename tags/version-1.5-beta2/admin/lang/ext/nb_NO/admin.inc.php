...
$lang['admin']['noncachable'] = 'Ikke mellomlagres';
...
$lang['admin']['magic_quotes_runtime_on'] = 'De fleste funksjoner som returnerer data vill ha g&aring;se&oslash;yne beskyttet med backslash. Du kan f&aring; problemer';
...
$lang['admin']['test_allow_url_fopen_failed'] = 'N&aring;r allow url fopen er sl&aring;tt av vil du ikke kunne f&aring; tilgang til URL object som fil ved &aring; benytte ftp eller http protokollen.';
$lang['admin']['connection_error'] = 'Utg&aring;ende http tilkoblinger ser ikke ut til &aring; virke! Er det en brannmur eller noe ACL for eksterne tilkoblinger aktivt? Dette vil resultere i at module manager, og potensielt annen funktionalitet feiler.';
...
$lang['admin']['admin_enablenotifications'] = 'Tillat brukere &aring; se varsler p&aring; adminsidene<br/><em>(nvarsler vil bli vist p&aring; alle administrasjonsider)<7em>';
...
$lang['admin']['error_retrieving_file_list'] = 'Feil ved henting av fil listen';
...
<p>Denne plugin vil prosessere data i &quot;Smarty data eller logikk...&quot;(pagedata) blokken for innholdsider gjennom smarty. Dette tillater deg &aring; spesifisere sidespesifik data til smarty uten &aring; endre malen for hver side.</p>
<h3>Hvordan benytter jeg denne?</h3>
<ol>
...
<h3>Hvilke parametere tar denne?</h3>
<p>Ingen n&aring;</p>';
$lang['admin']['page_metadata'] = 'Sidespesifik Metadata';
$lang['admin']['pagedata_codeblock'] = 'Smarty data eller logikk som er spesifik for denne siden';
...
$lang['admin']['info_validation'] = 'Denne funksjon vil sammenligne checksums funnet i den opplastede filen med filene i n&aring;v&aelig;rende installasjon. Dette kan hjelpe med &aring; finne problemer med opplastinger, eller eksakt hvilke filer som er endret om ditt system er hakket. En sjekksumfil blir generert for hver utgivelse av CMS Made simple fra versjon 1.4 og utover.';
...
$lang['admin']['warning_mail_settings'] = 'Dine epostinnstillinger har ikke blitt konfigurert enn&aring;. Dette kan medf&oslash;re at ditt nettsted ikke kan sende epost. Du b&oslash;r g&aring; til <a href="moduleinterface.php?module=CMSMailer">Utvidelser >> CMSMailer</a> og konfigurere epostinnstillingene med n&oslash;dvendig informasjon. Du b&oslash;r ha f&aring;tt dette fra din nettstedstilbyder.';
...
$lang['admin']['copy_paste_forum'] = 'Klikk her for &aring; klipp/lim inn i et forum innlegg';
...
$lang['admin']['help_function_current_date'] = '<h3>Hva gj&oslash;r denne?</h3>
...
<p>
    <ul>
	<li><em>(optional)</em> url         (string)     - URL&#039;en som bruke til validering, dresom ingen, brukes http://validator.w3.org/check/referer.</li>
...
<h3>Hvordan bruker jeg denne?</h3>
	...
	<h3>Hvilke parametere tar denne?</h3>
	<ul>
		<li><em>(optional)</em>name - I stedet for &aring; hente alle stilark tilknyttet gjeldende side s&aring; vil den hente kun en spesifik etter navn, om det er tilknyttet gjeldende mal eller ikke.</li>
...
$lang['admin']['help_function_recently_updated'] = '	<h3>Hva gj&oslash;r denne?</h3>
	...
	<h3>Hvordan bruker jeg den?</h3>
	<p>Sett denen koden inn i dun mal/side slik: <code>{recently_updated}</code></p>
...
$lang['admin']['help_function_oldprint'] = '	<h3>Hva gj&oslash;r denne?</h3>
	...
	<p>Sett bare inn taggen p&aring; din mal/side slik: <code>{print}</code><br></p>
        ...
        <ul>
                ...
                <li><em>(optional)</em> showbutton - Sett tilo &quot;true&quot; og det vil vises et printer ikon istedenfor en tekst lenke.</li>
                ...
                <li><em>(optional)</em> class_img - Class attributt for &amp;lt;img&amp;gt; taggen dersom showbutton er satt.</li>
...
$lang['admin']['help_function_modified_date'] = '        <h3>Hva gj&oslash;r denne?</h3>
        <p>Skriver dato og tid siden siste ble oppdatert.  Dersom intet format oppgis, vil standardfomat v&aelig;re slik som dette: &#039;Jan 01, 2004&#039;.</p>

        <h3>Hvordan bruker jeg denne?</h3>
        <p>Sett bare inn taggen i din mal/side slik: <code>{modified_date format=&quot;%A %d-%b-%y %T %Z&quot;}</code></p>
        <h3>Hvilke pareametre tar den?</h3>
        <ul>
                <li><em>(optional)</em>format - Dato/Tid format med parametre fra php&#039;s strftime funksjon.  Se <a href="http://php.net/strftime" target="_blank">her</a> for parameterliste og infomasjon.</li>
        </ul>';
...
$lang['admin']['help_function_menu_text'] = '	<h3>Hva gj&oslash;r denne?</h3>
	...
	<h3>Hvike parametre tar denne?</h3>
	<p>Ingen.</p>';
$lang['admin']['help_function_menu'] = '<h3>Hva gj&oslash;r denne?</h3>
	<p>Dette er bare en forenklet tagg for <a href="listmodules.php?action=showmodulehelp&amp;module=MenuManager">Menu Manager module</a> for &aring; gj&oslash;re tagg syntaksen enklere. 
...
<h3>Hvordan bruker jeg denne?</h3>
	<p>Bare sett inn <code>{menu}</code> i en side eller i en mal. For hjelp med Meny bahandler(Menu Manager) modulen, hvilke parametere tar den osv., vennligst se i <a href="listmodules.php?action=showmodulehelp&amp;module=MenuManager"> Meny behandler(Menu Manager) modul helpen</a>.';
...
$lang['admin']['help_function_global_content'] = '	<h3>Hva gj&oslash;r denne?</h3>
	<p>Setter inn en Global innholdsblokk(global content block) i din mal elelr side.</p>
	<h3>Hvordan bruker jeg denne?</h3>
...
$lang['admin']['help_function_content'] = '	<h3>Hva gj&oslash;r denne?</h3>
	...
	<h3>Hvilke parametere tar denne?</h3>
	<ul>
		<li><em>(optional)</em>block - Tillater deg &aring; ha mer enn en innholdsblokk per side. N&aring;r flere innholdsblokker settes inn i en mal, vil det antall av redigeringsbokser bli vist n&aring;r siden redigeres.
<p>Eksempel:</p>
...
<p>N&aring;, n&aring;r du redigerer en side vil det vises et tekstomr&aring;de med navn &quot;Second Content Block&quot;.</li>
		...
		<li><em>(optional)</em>assign - Tilegner(Assigns) innholdet til en smarty parameter, som du kan s&aring; benytte i andre omr&aring;der p&aring; siden, eller benytte for &aring; teste om innhold eksisterer i den eller ikke.
...
<li><em>(optional)</em> <tt>initial</tt> - 1/0 Om satt til 1 startes br&oslash;dsmulene med an avskiller (standard 0).</li>
...
$lang['admin']['adminpaneltitle'] = 'Administrasjonskonsoll';
...
$lang['admin']['warning_safe_mode'] = '<strong><em>ADVARSEL:</em></strong> PHP Safe mode er sl&aring;tt p&aring;.  Dette medf&oslash;rer problemer med filer som lastes opp via nettleser grensesnittet, inkludert bilder, tema og modul XML-pakker.  Du r&aring;des til &aring; kontakte din nettstedsadministrator for &aring; h&oslash;re om safe mode kan sl&aring;s av.';
...
$lang['admin']['utma'] = '156861353.4516254727077762000.1214829895.1227789508.1228112527.42';
$lang['admin']['utmz'] = '156861353.1224511322.39.4.utmcsr=forum.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/index.php';
