<?php
$lang['sendtestmailconfirm'] = 'Esto envia un mensaje de prueba a la direcci&oacute;n especificada. Si todo va bien, seras redirigido a esta pagina.  &iquest;Quieres continuar?';
...
Si lo has recibido, to funciona correctamente.';
...
$lang['mailer'] = 'M&eacute;todo de eenvio';
$lang['host'] = 'Host SMTP<br/><i>(o direcci&oacute;n IP)</i>';
$lang['port'] = 'Puerto del servidor SMTP';
$lang['from'] = 'Direcci&oacute;n &quot;de:&quot;';
$lang['fromuser'] = 'Usuario &quot;de:&quot;';
...
$lang['info_timeout'] = 'N&uacute;mero de segundosen una conversaci&oacute;n SMTP antes de ocurrir un error (s&oacute;lo valido para el protocolo SMTP)';
$lang['info_smtpauth'] = 'Tu Host SMTP requiere autenticaci&oacute;n (s&oacute;lo valido para el protocolo SMTP)';
$lang['info_username'] = 'Usuario autenticacion SMTP (valido para el metodo smtp, cuando esta activa la autenticacion)';
$lang['info_password'] = 'Clave autenticacion SMTP (valido solo para el metodo smtp, cuando esta activa la autenticacion)';
...
$lang['moddescription'] = 'Esto es un simple wrapper sobre PHPMailer, tiene un API equivalente (funci&oacute;n a funci&oacute;n) y una interface simple.';
