<?php
$lang['admin']['info_browser_cache_expiry'] = 'Zadajte vrjeme (u minutama) kroz koje će browseri zadržavati stranice u priručnoj memoriji (cache).  Postavljanje vrijednosti na 0 blokira ovu funkcionalnost.';
$lang['admin']['browser_cache_expiry'] = 'Browser Cache Expiry Period (minuta)</em>';
$lang['admin']['info_browser_cache'] = 'Primjenjive samo na stranice koje se mogu stavljati u priručnu memoriju, ove postavke ukazuju da browseri mogu do proteka zadanog vrijemena zadržavati stranice u priručnoj memoriji.  Ako je opcija omogućena posjetiteljima koji se vraćaju na va&scaron;e stranice promjene u sadržaju stranica možda neće odmah biti vidljive.';
$lang['admin']['allow_browser_cache'] = 'Dozvolite da browser zadržava stranice u priručnoj memoriji';
$lang['admin']['server_cache_settings'] = 'Server Cache postavke';
$lang['admin']['browser_cache_settings'] = 'Browser Cache postavke';
$lang['admin']['help_function_browser_lang'] = '<h3>&Scaron;to radi?</h3>
  <p>Ovaj dodatak (plugin) detektira i vraća jezik koji korisnikov preglednik prihvaća, i uparuje rezultat s listom dozvoljenih jezika da bi se odredio jezik kojeg će se koristiti za sjednicu (session).</p>
<h3>Kako radi?</h3>
<p>Ubacite  tag rano u predložak (template) stranice <em>(možete ga  ubaciti iznad <head> sekcije ako želite)</em> i zadajte ime predodređenog jezika, i dozvoljenih jezika (dozvoljene su samo dvoslovčane oznake jezika), onda napravite ne&scaron;to s rezultatom.  npr.:</p>
<pre><code>{browser_lang accept=de,fr,en,es default=en assign=tmp}{session_put var=lang val=$tmp}</code></pre>
<p><em>({session_put} je dodatak uključen u CGSimpleSmarty modul)</em></p>
<h3>Koje parametre prima?</h3>
<ul>
<li><strong>accepted <em>(required)</em></strong><br/> - Lista dvoslovčanih, zarezom odvojenih, kodova jezika koji su dozvoljeni.</li>
<li>default<br/>- <em>(optional)</em> Predodređeni jezik koji se koristi ako niti jedan od dozvoljenih jezika nije podržan od strane preglednika.  en se koristi ako druga vrijednost nije navedena.</li>
<li>assign<br/>- <em>(optional)</em> Ime smarty variable kojoj treba pridijeliti dobiveni rezultat.  Ako nije zadana rezultati ove funkcije se vraćaju.</li>
</ul>';
$lang['admin']['info_target'] = 'Ovu opciju može koristiti Menu Manager da naznači kada i kako se mogu otvarati novi okviri (frames) i prozori.  Neki menu manager predlo&scaron;ci mogu ignorirati ovu opciju.';
...
$lang['admin']['info_content_imagefield_path'] = 'Relativno u odnosu na upload putanju za slike, specificirajte ime direktorija koje uključuje putanju &scaron;to sadrži datoteke za polje slika';
$lang['admin']['content_thumbnailfield_path'] = 'Putanja za polje sličica';
$lang['admin']['info_content_thumbnailfield_path'] = 'Relativno u odnosu na upload putanju za slike, specificirajte ime direktorija koje uključuje putanju &scaron;to sadrži datoteke za polje slika.  Obično će biti isto kao i gornja putanja.';
$lang['admin']['contentimage_path'] = 'Putanja za {content_image} tag';
$lang['admin']['info_contentimage_path'] = 'Relativno u odnosu na upload putanju, specificirajte ime direktorija koje uključuje putanju &scaron;to sadrži datoteke za {content_image} tag.  Ova  vrijednost se koristi kao predodređena  za dir parametar';
$lang['admin']['editcontent_settings'] = 'Postavke za uređivanje sadržaja';
$lang['admin']['help_page_url'] = 'Apecificirajte alternativni URL (relativno u odnosu na root va&scaron;eg website-a) koji se može koristiti da jedinstveno identificira ovu stranicu.  npr.: path/to/mypage';
...
$lang['admin']['help_page_cachable'] = 'Performance se mogu popraviti deklariranjem &scaron;to je moguće vi&scaron;e stranica  kao onih koje se mogu stavljati u priručnu memoriju.  Ovo, međutim, nije moguće koristiti za stranice čiji sadržaj se može mijenjati na zahtjev.';
...
$lang['admin']['error_parsing_content_blocks'] = 'Javila se gre&scaron;ka kod parsing-a sadržaja bloka (možda je duplicirano ime bloka)';
...
$lang['admin']['clearcache_taskdescription'] = 'Ova zadaća (task), koja se dnevno izvodi, obrisati će datoteke stavljene u cache, koje su starije od godine postavljene u globalnim postavkama';
...
$lang['admin']['thumbnail_width'] = '&Scaron;irina sličice (thumbnail)';
$lang['admin']['thumbnail_height'] = 'Vsina sličice (thumbnail)';
$lang['admin']['E_STRICT'] = 'Da li je E_STRICT onemogućen kod error_reporting-a';
$lang['admin']['test_estrict_failed'] = 'E_STRICT je dozvoljen kod error_reporting-a';
$lang['admin']['info_estrict_failed'] = 'Neke datoteke koje CMSMS koristi ne rade dobro s E_STRICT.  Molim, onemogućite to prije nego &scaron;to nastavite';
$lang['admin']['E_DEPRECATED'] = 'Da li je E_DEPRECATED onemogućen kod error_reporting-a';
$lang['admin']['test_edeprecated_failed'] = 'E_DEPRECATED je omogućen';
$lang['admin']['info_edeprecated_failed'] = 'Ako je E_DEPRECATED omogućen kod error reporting-a korisnici će vidjeti brojne warning poruke koje mogu utjecati na prikaz i funkcionalnost';
$lang['admin']['session_use_cookies'] = 'Sesije mogu koristiti Cookies';
$lang['admin']['errorgettingcontent'] = 'Ne mogu dohvatiti informaciju za zadani content object';
$lang['admin']['errordeletingcontent'] = 'Gre&scaron;ka kod brisanja sadržaja (Ili je ova stranica nadređena (parent) nekoj ili se radi o predodređenom sadržaju)';
$lang['admin']['invalidemail'] = 'une&scaron;ena e-mail adresa je  neispravna';
$lang['admin']['info_deletepages'] = 'Primjedba: zbog ograničenja u pravima, neke od stranica koje su odabrane za brisanje nisu izlistane u nastavku';
...
$lang['admin']['invalidparent'] = 'Morate odabrati nadređenu (parent) stranicu kontaktirajte administratora ako vam opcija nije vidljiva).';
$lang['admin']['forgotpwprompt'] = 'Unesite va&scaron;e admin korisničko ime.  Email će biti poslan na adresu elektronske po&scaron;te povezanu uz korisničko ime s novim login informacijama';
$lang['admin']['info_basic_attributes'] = 'U ovom polju možete specificirati koja svojstva sadržaja može uređivati korisnik koji nema razinu dopu&scaron;tenja &quot;Manage All Content&quot;.';
$lang['admin']['basic_attributes'] = 'Osnovna svojstva';
$lang['admin']['no_permission'] = 'Nemate dopu&scaron;tenje za izvođenje te funkcije.';
$lang['admin']['bulk_success'] = 'Skupna operacija je uspje&scaron;no izvedena.';
$lang['admin']['no_bulk_performed'] = 'Nije izvedena skupna operacija.';
...
$lang['admin']['sitedownexcludes'] = 'Isključite ove adrese iz &quot;Site zaustavljen&quot; poruka';
...
$lang['admin']['sitedown_settings'] = 'Site Down postavke';
...
$lang['admin']['forge'] = 'Patvorite (forge)';
...
$lang['admin']['thumbnail'] = 'Sličica (thumbnail)';
$lang['admin']['searchable'] = 'Ova stranica se može pretraživati.';
...
$lang['admin']['utma'] = '156861353.975473918.1295453451.1295460922.1295466431.4';
$lang['admin']['utmz'] = '156861353.1295460922.3.4.utmcsr=themes.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/Download_Themes.html';
$lang['admin']['qca'] = 'P0-1090848070-1295453453223';
