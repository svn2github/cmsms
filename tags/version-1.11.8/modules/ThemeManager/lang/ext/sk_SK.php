<?php
$lang['error_uploadpermissions'] = '<strong>Varovanie:</strong> Nem&aacute;te dostatočn&eacute; povolenie na nahratie alebo in&scaron;tal&aacute;ciu t&eacute;m. Toto m&ocirc;že byť sp&ocirc;spben&eacute; vypnut&yacute;m Safe mode, alebo nedostatočn&yacute;mi pr&aacute;vami na z&aacute;pis pre adres&aacute;re.';
...
$lang['info_themename'] = 'Toto pole určuje n&aacute;zov t&eacute;my, bez ohľadu nato aky bol n&aacute;zov vstupnej t&eacute;my.';
$lang['error_editingproblem'] = 'Problem s upratan&iacute;m a zmenou referenci&iacute; s&uacute;borov v t&eacute;me';
$lang['error_problemsavingincludes'] = 'Problem s ukl&aacute;dan&iacute;m s&uacute;borov enk&oacute;dovan&yacute;ch v &scaron;abl&oacute;ne';
...
$lang['error_nostylesheets'] = 'Neboli n&aacute;jden&eacute; žiadne &scaron;t&yacute;ly v t&eacute;me';
$lang['error_couldnotcreatetemplate'] = 'Nie je možn&eacute; vytvoriť defin&iacute;ciu &scaron;abl&oacute;ny';
$lang['error_couldnotassoccss'] = 'Problem s pripojen&iacute;my &scaron;t&yacute;lmi v &scaron;abl&oacute;ne';
$lang['error_nooutput'] = 'Nič pre v&yacute;stup';
$lang['error_notemplate'] = 'Nemožem n&aacute;jsť &scaron;abl&oacute;nu';
$lang['error_dtdmismatch'] = 'Konflik DTD verzi&iacute;, nem&ocirc;žem importovať';
