...
$lang['reset'] = 'Reset';
$lang['error_permissions'] = '<strong><em>ATTENZIONE:</em></strong> Permessi insufficienti della directory per installare i moduli. Potreste avere problemi con PHP Safe mode.  Assicurarsi che il safe mode &egrave; disabilitato e i permessi del file system sono adeguati.';
$lang['error_minimumrepository'] = 'La versione del Deposito non &egrave; compatibile con questo modulo';
$lang['prompt_reseturl'] = 'Reset URL al valore predefinito';
$lang['prompt_resetcache'] = 'Reset la cache locale dei dati del Deposito';
