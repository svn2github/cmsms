<?php
$lang['admin']['disablesafemodewarning'] = 'Отключить предупреждение  безопасного режима Администратора';
$lang['admin']['allowparamcheckwarnings'] = 'Разрешает проверку параметров для создания предупреждающих сообщений';
$lang['admin']['date_format_string'] = 'Строка параметра даты';
$lang['admin']['date_format_string_help'] = '<em>strftime</em> отформатированная строка формата даты';
$lang['admin']['last_modified_at'] = 'Последнее обновление';
$lang['admin']['last_modified_by'] = 'Последний раз изменено';
$lang['admin']['read'] = 'Читать';
$lang['admin']['write'] = 'Писать';
$lang['admin']['execute'] = 'Выполнить';
$lang['admin']['group'] = 'Группа';
$lang['admin']['other'] = 'Другие';
$lang['admin']['event_desc_moduleupgraded'] = 'Отправлять после того, как модуль обновлен';
...
$lang['admin']['event_desc_edituserdefinedtagpost'] = 'Отправлять после того, как тэг пользователя обновлен';
$lang['admin']['event_desc_edituserdefinedtagpre'] = 'Отправлять до обновления тэга пользователя';
$lang['admin']['event_desc_deleteuserdefinedtagpre'] = 'Отправлять до удаления тега пользователя';
$lang['admin']['event_desc_deleteuserdefinedtagpost'] = 'Отправлять после того, как тег пользователя удален';
...
$lang['admin']['error_delete_default_parent'] = 'Вы не можете удалить страницу-родитель страницы по умолчанию.';
$lang['admin']['jsdisabled'] = 'Простите, данная функция требует чтобы у вас был включен Javascript.';
...
$lang['admin']['pages_reordered'] = 'Порядок страниц был успешно изменен';
$lang['admin']['sibling_duplicate_order'] = 'Две страницы одного уровня не могут иметь один и тот же порядковый номер. Порядок следования страниц не был изменен.';
$lang['admin']['no_orders_changed'] = 'Вы хотели изменить порядок следования страниц, но не поменяли номера ни одной из них. Порядок следования страниц не был изменен.';
$lang['admin']['order_too_small'] = 'Ноль не может быть порядковым номером страницы. Порядок следования страниц не был изменен.';
...
$lang['admin']['contentadded'] = 'Контент был успешно занесен в базу данных.';
$lang['admin']['contentupdated'] = 'Контент был успешно обновлен.';
$lang['admin']['contentdeleted'] = 'Контент был успешно удален из базы данных.';
...
$lang['admin']['aliasalreadyused'] = 'Этот Alias уже используется на другой странице. Измените Alias на закладке "Настройки" на какое-нибудь другое. ';
$lang['admin']['aliasmustbelettersandnumbers'] = 'Alias должен состоять из букв и цифр';
$lang['admin']['aliasnotaninteger'] = 'Alias не может быть числом';
...
$lang['admin']['confirmcancel'] = 'Вы уверены, что хотите отменить внесенные изменения? Нажмите OK, чтобы отменить все изменения. Нажмите Cancel, чтобы продолжить редактирование.';
...
$lang['admin']['edittemplatesuccess'] = 'Шаблон обновлен';
...
$lang['admin']['usertagupdated'] = 'Тег пользователя был успешно обновлен';
$lang['admin']['usertagdeleted'] = 'Тег пользователя был успешно удален';
...
$lang['admin']['errorcouldnotparsexml'] = 'Ошибка при анализе XML file. Пожалуйста, удостоверьтесь, что вы загружаете .xml файл, а не .tar.gz или zip файл.';
...
$lang['admin']['errordefaultpage'] = 'Нельзя удалить страницу по умолчанию. Пожалуйста, сначала назначте другую страницу страницей по умолчанию.';
...
$lang['admin']['uploadxmlfile'] = 'Установить модуль чере файл XML';
$lang['admin']['cachenotwritable'] = ' Нет прав на запись в папку для кеша. Очистить кеш, поэтому, невозможно. Пожалуйста удостоверьтесь, что у веб-сервера полные права rwe на папку /tmp/cache  (chmod 777)';
...
$lang['admin']['noxmlfileuploaded'] = 'Файл не был закачан. Чтобы установить модуль через XML вы должны выбрать и закачать .xml файл модуля со своего компьютера.';
...
$lang['admin']['erroruserinuse'] = 'Этот пользователь до сих пор владеет созданными им страницами. Пожалуйста, сначала смените им владельца.';
...
$lang['admin']['helpwithsection'] = 'Справка %s';
...
$lang['admin']['informationmissing'] = 'Недостаёт информации';
$lang['admin']['install'] = 'Установить';
$lang['admin']['invalidcode'] = 'Неправильный код.';
$lang['admin']['illegalcharacters'] = 'Неверные символы в поле %s.';
...
$lang['admin']['modifygroupassignments'] = 'Изменить присоединённых к группе';
$lang['admin']['moduleabout'] = 'Инфо о %s';
$lang['admin']['modulehelp'] = 'Справка %s';
...
$lang['admin']['pluginhelp'] = 'Справка %s';
...
$lang['admin']['previous'] = 'Предыдущее';
$lang['admin']['remove'] = 'Удалить';
$lang['admin']['removeconfirm'] = 'Данным действием вы удалите файлы, составляющие этот модуль из данной установки. \\nУверены ли вы, что хотите продолжить?';
...
$lang['admin']['tagtousegcb'] = 'Тэг для использования этого блока';
$lang['admin']['gcb_wysiwyg'] = 'Включить GCB WYSIWYG';
$lang['admin']['gcb_wysiwyg_help'] = 'Включить WYSIWYG редактор для редактирования Global Content Blocks';
...
$lang['admin']['missingdependency'] = 'Потеряная зависимость';
$lang['admin']['minimumversion'] = 'Минимальная версия';
$lang['admin']['minimumversionrequired'] = 'Минамально необходимая версия CMSMS';
...
$lang['admin']['moduleerrormessage'] = 'Ошибочное сообщение для модуля %s';
...
$lang['admin']['tagdescription'] = 'Теги - небольшие расширения функциональности которые можно добавлять к шаблону или непсредственно к контенту.';
...
$lang['admin']['installdirwarning'] = '<b>Внимание: </b>Папка install все еще существует. Пожалуйста удалите ее полностью .';
...
$lang['admin']['wiki'] = 'Википедия';
$lang['admin']['irc'] = 'Чат IRC';
...
$lang['admin']['hide_help_links_help'] = 'Поставьте галку, чтобы отключить вики и ссылки на справку модуля в заголовках страниц.';
...
$lang['admin']['event_desc_edittemplatepre'] = 'Отправляется до того, как изменения шаблоне были сохранены';
$lang['admin']['event_desc_edittemplatepost'] = 'Отправляется после того, как изменения шаблоне были сохранены';
$lang['admin']['event_desc_deletetemplatepre'] = 'Отправляется до того, как шаблон был удален из  системы';
$lang['admin']['event_desc_deletetemplatepost'] = 'Отправляется после того, как шаблон был удален из  системы';
...
$lang['admin']['event_desc_contentstylesheet'] = 'Отправляется до того, как таблица стилей отправна браузеру';
...
$lang['admin']['event_desc_contentpostrender'] = 'Отправляется до того, как было комбинированный html отправлен броузеру ';
...
';
$lang['admin']['event_help_deletegrouppost'] = '<p>Отправлется после того, как группа была удалена из системы</p>
<h4>Параметры</h4>
<ul>
<li>\'group\' - Ссылка на объект группы</li>
</ul>
...
<h4>Параметры</h4>
<ul>
<li>\'stylesheet\' - Ссылка на объект тасблицы стилей</li>
</ul>
';
$lang['admin']['event_help_addstylesheetpost'] = '<p>Отправлется после того, как создана новая таблица стилей</p>
<h4>Параметры</h4>
<ul>
<li>\'stylesheet\' - Ссылка на объект тасблицы стилей</li>
</ul>
...
';
$lang['admin']['event_help_deletestylesheetpost'] = '<p>Отправлется после того, как таблица стилей была удалена из системы</p>
<h4>параметры</h4>
<ul>
<li>\'stylesheet\' - Ссылка на объект тасблицы стилей</li>
</ul>
...
';
$lang['admin']['event_help_contentstylesheet'] = '<p>Отправляется до того, как стаблица стилей была отослана браузеру</p>
<h4>Параметры</h4>
<ul>
...
';
$lang['admin']['event_help_contentpostrender'] = '<p>Отправлено до того, как объединенный html был отправлен браузеру</p>
<h4>Параметры</h4>
<ul>
<li>\'content\' - Ссылка на текст html</li>
</ul>
';
$lang['admin']['event_help_smartyprecompile'] = '<p>Отправлсяется до того, как какое- либо содержание, предназначенное Smarty было отослано для обработки</p>
<h4>Параметры</h4>
<ul>
<li>\'content\' - Ссылка на текст</li>
</ul>
';
$lang['admin']['event_help_smartypostcompile'] = '<p>Отправлсяется до того, как какое- либо содержание, предназначенное Smarty было обработано</p>
<h4>Параметры</h4>
<ul>
<li>\'content\' - Ссылка на текст</li>
</ul>
...
$lang['admin']['error_udt_name_whitespace'] = 'Ошибка: Определенные пользователем тэги не могут содержать пробелов в имени тэга.';
$lang['admin']['warning_safe_mode'] = '<strong><em>WARNING:</em></strong> Включен безопасный режим PHP.  Это может вызвать трудности с загрузкой файлов через интерфейс браузера, а также модулей и изображений. Для выключение безопасного режима, обратитесь к администратору вашего сайта.';
...
$lang['admin']['utma'] = '156861353.1218847644.1167895455.1179078848.1179083498.43';
$lang['admin']['utmz'] = '156861353.1179083498.43.28.utmccn=(referral)|utmcsr=forum.cmsmadesimple.org|utmcct=/|utmcmd=referral';
?>