<?php
$lang['admin']['disablesafemodewarning'] = 'Sl&aring; av Safe mode advarsel i admin';
$lang['admin']['allowparamcheckwarnings'] = 'Tillat at parameter tester lager advarsel meldinger';
$lang['admin']['date_format_string'] = 'Date Format Streng';
$lang['admin']['date_format_string_help'] = '<em>strftime</em> formattert date format streng';
$lang['admin']['last_modified_at'] = 'Sist endret den';
$lang['admin']['last_modified_by'] = 'Sist endret av';
$lang['admin']['read'] = 'Lese(Read)';
$lang['admin']['write'] = 'Skrive(Write)';
$lang['admin']['execute'] = 'Utf&oslash;re(Execute)';
$lang['admin']['group'] = 'Gruppe(Group)';
$lang['admin']['other'] = 'Annet(Other)';
...
$lang['admin']['order_too_large'] = 'En side-rekkef&oslash;lge kan ikke v&aelig;re st&oslash;rre enn antall sider p&aring; samme niv&aring;. Sidene ble ikke sortert p&aring; ny.';
...
$lang['admin']['changepermissionsconfirm'] = 'V&AElig;R FORSIKTIG\n\nDenne handling vil pr&oslash;ve &aring; sikre at alle filene som utgj&oslash;r denne modulen er skrivbare for webserveren..\nEr du sikker p&aring; du vil fortsette?';
...
$lang['admin']['confirmdefault'] = 'Vil du virkelige sette denne siden som standard for nettstedet?';
...
$lang['admin']['errorcouldnotparsexml'] = 'Feil ved parsing av XML filen. Kontroller at du laster opp en .xml fil og ikke en .tar.gz eller en zip fil.';
...
$lang['admin']['newtemplatename'] = 'Nytt Mal Navn';
...
$lang['admin']['tagtousegcb'] = 'Tagg for Benytt denne Blokken';
...
$lang['admin']['cachecleared'] = 'Cache er t&oslash;mt';
$lang['admin']['apply'] = 'Bruk';
$lang['admin']['applydescription'] = 'Lagre endringer og fortsett redigering';
$lang['admin']['none'] = 'Ingen';
$lang['admin']['wysiwygtouse'] = 'Velg WYSIWYG &aring; benytte';
$lang['admin']['syntaxhighlightertouse'] = 'Velg hvilken syntaks uthever(highlighter) som skal benyttes';
...
$lang['admin']['indent'] = 'Bruk ekspanderende hierarki for siderlisten';
...
$lang['admin']['defaultpagecontent'] = 'Plassholder side innhold';
...
$lang['admin']['error_udt_name_whitespace'] = 'Feil: User Defined Tags/ BrukerDefinerteTagger (UDT) kan ikke ha mellomrom i navnet.';
