<?php
$lang['helpurl'] = 'RSS feed URL';
$lang['helpnumbertoshow'] = 'Maximum number of items to display -- leaving empty will show all items.';
$lang['helptarget'] = 'Adds a target param to the title link.  Set to "_blank" to open in a new page.';
$lang['helpdescriptions'] = 'Show the description of the RSS articles.';
$lang['help'] = <<<EOF
