...
DROP TABLE IF EXISTS {$tableprefix}adminlog;
...
DROP TABLE IF EXISTS {$tableprefix}userprefs;
...
CREATE TABLE {$tableprefix}adminlog (
...
INSERT INTO {$tableprefix}sections (section_id, section_name, item_order, active, create_date, modified_date, parent_id) VALUES (1,'About',1,1,now(),now(),0);
...
CREATE TABLE {$tableprefix}userprefs (
  user_id int(11) default NULL,
...
INSERT INTO {$tableprefix}userprefs (user_id, preference, value, type) VALUES (1,'use_wysiwyg','1',NULL);
...
INSERT INTO {$tableprefix}users (user_id, username, password, active, create_date, modified_date) VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3',1,now(),now());

CREATE TABLE {$tableprefix}version (
  version int(11) default NULL
) TYPE=MyISAM;

INSERT INTO {$tableprefix}version (version) VALUES (3);
