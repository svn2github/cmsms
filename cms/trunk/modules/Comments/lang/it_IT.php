...
$lang['help'] = <<<EOD
	...
	<p>Il modulo comments &egrave; un tag module.  Esso &egrave; usato per aggiungere commenti a pagine individuali, le quali possono essere lette dagli utenti. La ragione pratica di questo modulo &egrave; per la documentazione delle pagine. Cos&igrave; gli utenti possono aggiungere commenti ed informazioni alla pagina.</p>
	<h3>Come usarlo?</h3>
	<p>Esso &egrave; inserito nelle pagine o template usando il cms_module tag. Esempio di sintassi: <code>{cms_module module="comments"}</code></p>
	<h3>Quali parametri ci sono?</h3>
	<p>
	<ul>
		<li><em>(opzionale)</em> number="5" - Numero massimo di oggeti da visualizzare -- lasciandolo VUOTO li visualizza tutti.</li>
