<?php
$lang['helptree'] = '1/0, this option will generate a tree menu.';
$lang['helprelative'] = '1/0, if set the menu will generate only the childs of the current page. This is very usefull if you want to add contect sensitive menus.';
$lang['helpid'] = 'text without spaces or special chars, default: menu1. You must specify it if you want to use more than one menu per page.';
