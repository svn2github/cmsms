...
class Content extends ContentBase
{
	...
	function Edit()
	{
		...
		$text .= '<tr><td>'.lang('content').':</td><td>'.create_textarea($this->mProperties->GetValue('content_en'), 'content', 'syntaxHighlight', 'content').'</td></tr>'."\n";
		$text .= '<tr><td>'.lang('headtags').':</td><td>'.create_textarea($this->mProperties->GetValue('headtags'), 'headtags', 'syntaxHighlight', 'headtags').'</td></tr>'."\n";
