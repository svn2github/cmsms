...
<?php
	...
	if ($result) {
		...
		while($row = $result->FetchRow()) {
			...
			if ($remove)
				echo "<td width=\"18\"><a href=\"deletetemplate.php?template_id=".$row["template_id"]."\" onclick=\"return confirm('".$gettext->gettext("Are you sure you want to delete?")."');\"><img src=\"../images/delete.png\" alt=\"".$gettext->gettext("Delete")."\" border=\"0\" /></a></td>\n";
			echo "</tr>\n";
