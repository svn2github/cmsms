...
if (isset($_POST["adduser"])) {
	...
	if ($validinfo) {
		$query = "INSERT INTO ".$config->db_prefix."users (username, password, active, create_date, modified_date) VALUES ('".mysql_escape_string($user)."', '".mysql_escape_string($password)."', $active, now(), now())";
