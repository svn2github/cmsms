...
$lang['admin']['preferencedescription'] = 'Aqui voc&ecirc; encontrar&aacute; as prefer&ecirc;ncias do usu&aacute;rio.'; 
...
$lang['admin']['sitepreferences'] = 'Prefer&ecirc;ncias gerais do site';
...
$lang['admin']['addcssassociations'] = 'Adicionar Associa&ccedil;&otilde;es de Folha de Estilos';
...
$lang['admin']['editlink'] = 'Editar Link';
$lang['admin']['action'] = 'A&ccedil;&atilde;o';
$lang['admin']['addlink'] = 'Adicionar Link';
...
$lang['admin']['helplistcontent'] = '<p>Este &eacute; o principal local onde voc&ecirc; poder&aacute; fazer a edi&ccedil;&atilde;o de conte&uacute;do.</p>Daqui voc&ecirc; pode reordenar a hierarquia do sistema de menus (gerado automaticamente), adicionar, editar ou remover conte&uacute;do e links, entre outras coisas.<br>Para selecionar a p&aacute;gina principal (quando nenhum par&acirc;metro &eacute; usado), basta clicar na coluna padr&atilde;o sobre o s&iacute;mbolo \'falso\' na coluna \'Padr&atilde;o\' e a p&aacute;gina ser&aacute; determinada como a p&aacute;gina padr&atilde;o (o falso passa a ser um tique)';
...
$lang['admin']['directoryunder'] = 'pasta sob n&iacute;vel atual';
...
$lang['admin']['editseparator'] = 'Editar Separador';
$lang['admin']['usejavasyntax'] = 'Usar destaque de sintaxe nas caixas de texto (<a href="http://java.com/">requer java</a>)';
...
$lang['admin']['errorinsertingpage'] = 'Erro adicionando p&aacute;gina';
$lang['admin']['pluginhelp'] = 'Ajuda sobre a tag %s';
$lang['admin']['permissionsforgroup'] = 'Permiss&otilde;es for Grupo %s';
...
$lang['admin']['addseparator'] = 'Adicionar Separador';
...
$lang['admin']['newsitems'] = 'Novos &Iacute;tens';
...
$lang['admin']['helpeditcontent'] = '<p>This p&aacute;gina allows you to change the actual conte&uacute;do of your p&aacute;gina, the parent of this piece of conte&uacute;do used for generating the menu. You can also change the text that actually appears in the menu, the title of the p&aacute;gina, change the owner, e assign additional editors to the selected piece of conte&uacute;do.</p><p>If you choose to use the p&aacute;gina alias, the links created by the automated menu will be more readable using the p&aacute;gina alias as the argument rather than the internally defined p&aacute;gina id number.</p>';
...
$lang['admin']['helpaddcontent'] = '<p>Esta p&aacute;gina permite que voc&ecirc; crie novo conte&uacute;do. Selecione um tipo de conte&uacute;do e preencha os campos requirido e voc&ecirc; ter&aacute; seu novo conte&uacute;do configurado. Se voc&ecirc; selecionar para que seja exibido no menu, e voc&ecirc; estiver usando uma das ferramentar autom&aacute;ticas de menu {dhtmlmenu} ou {bulletmenu} ent&atilde;o o novo conte&uacute;do ser&aacute; exibido automaticamente no menu.</p><p>You can set your preferences for a WYSIWYG editor by editing your user in the Usu&aacute;rio Gerenciamento link. By setting this to false, you can create complex conte&uacute;do, ou simply cut e paste in existing conte&uacute;do from another site.</p>';
...
$lang['admin']['errrochildcontent'] = 'Imposs&iacute;vel apagar p&aacute;gina com subp&aacute;ginas. Por favor mova ou apague as subp&aacute;ginas antes';
...
$lang['admin']['nosyntax'] = 'Desculpe, destaque de sintaxe n&atilde;o &eacute; suportada pelo seu navegador.';
...
$lang['admin']['slogan'] = '&Eacute; t&atilde;o <span style="color:#FE0404">simples</span>, que parece com um <span style="color: #FE0404">final de semana</span>';
...
$lang['admin']['errorupdatingcontent'] = 'Erro atualizando conte&uacute;do';
...
$lang['admin']['currentcss'] = 'Folha de Estilos(CSS) em uso';
