...
$lang['admin']['disable_wysiwyg'] = 'D&eacute;sactiver l&#039;&eacute;diteur WYSIWYG sur cette page (ind&eacute;pendamment du mod&egrave;le ou la configuration de l&#039;utilisateur)&nbsp;';
...
$lang['admin']['help_function_recently_updated'] = '	<h3>Que fait cette Balise ?</h3>
	...
	<ul>
	 ...
	 <li><p><em>(optionel)</em> css_class=&#039;some_name&#039; - Ajoute une balise div d&eacute;finie avec cette classe autour de la liste.</p><p>Exemple : <pre>{recently_updated css_class=&#039;nom_de_classe&#039;}</pre></p></li>											 	
...
$lang['admin']['help_function_cms_selflink'] = '		<h3>Que fait cette Balise ?</h3>
		...
		<li><em>(option)</em> <tt>dir start/next/prev/up (previous)</tt> - Links to the default start page or the next or previous page, or the parent page (up). If this is used <tt>page</tt> should not be set. <b>Note!</b> Only one of the above may be used in the same cms_selflink statement!!</li>
		...
		<li><em>(option)</em> <tt>href</tt> - If href is used only the href value is generated (no other parameters possible). <strong>Exemple :</strong> < a href=&quot;{cms_selflink href=&quot;alias&quot;}&quot; >< img src=&quot;xx&quot;>< /a ></li>
		...
		<li><em>(option)</em> <tt>imageonly</tt> - If using an image, whether to suppress display of text links. If you want no text in the link at all, also set lang=0 to suppress the label. <b>Exemple :</b> {cms_selflink dir=&quot;next&quot; image=&quot;next.png&quot; text=&quot;Next&quot; imageonly=1}</li>
...
$lang['admin']['utma'] = '156861353.1803861136.1235666444.1235666444.1235666444.1';
$lang['admin']['utmc'] = '156861353';
$lang['admin']['utmz'] = '156861353.1235666444.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
