...
$lang['test_open_basedir_session_save_path'] = '&#039;Open basedir&#039; beperkingen lijken van invloed te zijn. Als u SESSION problemen krijgt en ini_set is toepasbaar, kunt u proberen om sessions door middel van cookies aan te zetten door: ini_set(&#039;session.use_only_cookies&#039;, 1);  boven in het include.php bestand te plaatsen.';
...
$lang['install_creating_table'] = '<p>Maak %s tabel...</p>';
