...
<ul>
<li><em>(option)wysiwyg</em> - Indiquez le nom du module &eacute;diteur WYSIWYG pour initialiser. Utiliser avec prudence. Si vous avez un &eacute;diteur WYSIWYG diff&eacute;rent que celui de s&eacute;lectionn&eacute; dans &quot;Param&egrave;tres globaux/Param&egrave;tres g&eacute;n&eacute;raux&quot;, cela forcera l&#039;&eacute;diteur sp&eacute;cifi&eacute; pour &ecirc;tre initialis&eacute;.</li>
<li><em>(option)force=0</em> - Normalement, cette balise ne va pas initialiser l&#039;&eacute;diteur sp&eacute;cifi&eacute; (ou d&eacute;tect&eacute;) s&#039;il n&#039;a pas &eacute;t&eacute; marqu&eacute; comme &quot;active&quot;. Ce param&egrave;tre va annuler ce comportement. Ce param&egrave;tre peut &ecirc;tre requis si la configuration de la variable &quot;process_whole_template&quot; n&#039;est pas fix&eacute;e &agrave; la valeur par d&eacute;faut.</li>
<li><em>(option)assign</em> - Assigne la sortie de la balise &agrave; la variable smarty nomm&eacute;e.</li>
</ul>';
...
$lang['admin']['event_desc_loginfailed'] = 'Erreur Login utilisateur';
...
$lang['admin']['invalid_url2'] = 'L&#039;URL sp&eacute;cifi&eacute;e est invalide.  Elle ne doit contienir que des caract&egrave;res alphanum&eacute;riques, ou - ou encore /. Il est aussi possible que cette URL soit d&eacute;j&agrave; utilis&eacute;e.';
...
<li><em>(option)</em>https - (boolean) indique dans le cas o&ugrave; param&egrave;tre &quot;ssl_url&quot; du config.php est activ&eacute; de pr&eacute;fixer les URLs des feuilles de style. S&#039;il n&#039;est pas sp&eacute;cifi&eacute;, le syst&egrave;me va tenter de d&eacute;terminer l&#039;URL racine appropri&eacute;e fond&eacute;e sur la s&eacute;curit&eacute; de la page affich&eacute;e.</li>
  ...
  <li><em>(option)</em> media - Si utilis&eacute; avec le param&egrave;tre &quot;name&quot;, ce param&egrave;tre modifiera le type de m&eacute;dia pour la feuille de style. En utilisation avec le param&egrave;tre &quot;templateid&quot;, le le type de m&eacute;dia modifiera uniquement cette feuille de style qui sera marqu&eacute;e avec le type sp&eacute;cifi&eacute;.</li>
  </ul>
...
$lang['admin']['adminlog_1day'] = '1 jouir';
...
<li><em>(optional)</em> assign (string) -  Assigne le r&eacute;sultat &agrave; une variable Smarty avec ce nom.</li>
</ul>';
...
<p>Cette balise va traiter les donn&eacute;es contenues dans le bloc &quot;pagedata&quot; des pages de contenu &agrave; travers smarty.  Il permet de sp&eacute;cifier des donn&eacute;es sp&eacute;cifiques &agrave; chaque page via smarty sans avoir &agrave; changer le gabarit de chaque page.</p>
<h3>Comment l&#039;utiliser ?</h3>
<ol>
...
$lang['admin']['help_function_image'] = '  <h3>Que fait cette Balise ?</h3>
  ...
  <h3>Quels param&egrave;tres ?</h3>
  <ul>
     <li><em>(requis)</em>  <tt>src</tt> - fichier image dans votre dossier d&#039;images.</li>
...
<strong>Note :</strong> Seulement une des options peut &ecirc;tre utilis&eacute;e de la m&ecirc;me d&eacute;claration &quot;cms_selflink&quot; !</li>
		...
		<li><em>(option)</em> <tt>lang</tt> - Affiche le label du lien  (&quot;Next Page&quot;/&quot;Previous Page&quot;) dans les diff&eacute;rentes langues.</li>
...
<ul>
	...
	<li><tt>jQuery UI</tt><em>(1.8.14)</em> - jquery-ui-1.8.14.min.js</li>
...
<h3>Quels param&egrave;tres ?</h3>
<ul>
	<li><em>(option) </em><tt>exclude</tt> - Utilise, s&eacute;par&eacute; par des virgules(CSV),la liste des scripts que vous souhaitez exclure. <code>&#039;jquery.ui.nestedSortable.js,jquery.json-2.2.js&#039;</code></li>
	<li><em>(option) </em><tt>append</tt> - Utilise, s&eacute;par&eacute; par des virgules(CSV), la liste des chemins des scripts que vous souhaitez ajouter. <code>&#039;/uploade/jquery.ui.nestedSortable.js,http://code.jquery.com/jquery-1.6.2.min.js&#039;</code></li>
...
$lang['admin']['adminpaneltitle'] = 'Console d&#039;administration de CMS Made Simple&trade;';
