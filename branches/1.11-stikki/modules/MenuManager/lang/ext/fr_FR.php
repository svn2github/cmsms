<?php
$lang['help_action'] = 'Sp&eacute;cifier le comportement du module. Il ya deux possibilit&eacute;s pour ce param&egrave;tre :
<ul>
  <li>default <em>(default)</em> - Utilis&eacute; pour la construction d&#039;un menu de navigation.</li>
  <li>breadcrumbs - Utilis&eacute; pour construire une fil d&#039;Ariane de navigation pour la page actuellement affich&eacute;e.  <strong>Note : {cms_breadcrumbs}</strong> est une fa&ccedil;on d&#039;appeler cette action.</li>
</ul>';
...
<p>La balise <strong>{cms_breadcrumbs}</strong>(application {menu action=breadcrumbs}) peut &ecirc;tre utilis&amp;eacute; pour cr&eacute;er un fil d&rsquo;Ariane de navigation pour la page actuellement affich&eacute;e.';
