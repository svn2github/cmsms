<?php
$lang['help_action'] = 'Angi oppf&oslash;rsel for modulen. Det er to muligheter for denne parameteren:
<ul>
   <li>default<em>(standard)</em> - Brukes for &aring; bygge en navigeringsmeny </li>
   <li>breadcrumbs - Brukes for &aring; bygge en br&oslash;dsmule sti til siden som for &oslash;yeblikket vises.<strong>Merk: {cms_breadcrumbs}</strong> er den kort m&aring;ten &aring; kalle denne handlingen p&aring;.</li>
</ul>';
$lang['help_root'] = 'Gjelder kun til breadcrumbs handlingen, tillater &aring; angi et start niv&aring; som ikke er det samme som det som er satt som standardside.';
...
<li>$node->first -- eksisterer, og satt til 1 hvis den er det f&oslash;rste elementet i et niv&aring; </li>
<li>$node->last -- eksisterer, og satt til 1 hvis den er det siste elementet i et niv&aring; </li>
		</ul>
	</p>
        <h3>Mellomlagring</h3>
...
<h3>Alternative tagger:</h3>
         <p><strong>{cms_breadcrumbs}</strong>-koden (forkortelse for {menu action=&#039;breadcrumbs}) kan brukes til &aring; lage en br&oslash;dsmule sti vises for &oslash;yeblikket siden.</p>';
...
$lang['utma'] = '156861353.693635281.1322942681.1322953593.1322957327.3';
$lang['utmz'] = '156861353.1322942681.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353.1.10.1322957327';
?>