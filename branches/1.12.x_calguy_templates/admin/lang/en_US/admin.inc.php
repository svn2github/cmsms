...
$lang['admin']['adminplugin'] = 'Admin Plugin';
...
$lang['admin']['alert'] = 'Alert';
$lang['admin']['alias'] = 'Alias';
...
$lang['admin']['ce_navdisplay'] = 'Content list navigation display';
...
$lang['admin']['clearusersettings'] = 'Clear all settings';
$lang['admin']['close'] = 'Close';
$lang['admin']['cms_install_information'] = 'CMS Install Information';
$lang['admin']['cms_version'] = 'CMS Version';
$lang['admin']['CMSEX_L001'] = 'Attempt to delete a non expired lock owned by another user';
$lang['admin']['CMSEX_L002'] = 'Attempt to delete a lock when it has yet to be saved';
$lang['admin']['CMSEX_L003'] = 'Lock type empty';
$lang['admin']['CMSEX_L004'] = 'Lock not saved';
$lang['admin']['CMSEX_L005'] = 'Could not find a lock with the specified identifiers';
$lang['admin']['CMSEX_L006'] = 'Lock is owned by a different user. We cannot manipulate it';
$lang['admin']['CMSEX_L007'] = 'Other/unknown locking error';
$lang['admin']['CMSEX_L008'] = 'Locking exception';
$lang['admin']['CMSEX_L009'] = 'Problem removing lock';
$lang['admin']['CMSEX_G001'] = 'Attempt to set invalid property into object';
$lang['admin']['CMSEX_SQL001'] = 'Problem creeating/updating lock record';
...
$lang['admin']['confirm_bulkuserop'] = 'Use caution when performing options on multiple users simultaneously.\nAre you sure that you want to continue?';
$lang['admin']['confirm_edituser'] = 'Are you sure you want to apply changes to this user account';
$lang['admin']['confirm_runusertag'] = 'Running a UDT may have adverse effects on your website.  Please use caution!\n\nAre you sure you want to continue?';
$lang['admin']['confirm_set_template_1'] = 'Are you sure you want to set all of these pages to use this template';
$lang['admin']['confirm_set_template_2'] = 'Yes, I am sure.';
$lang['admin']['confirm_set_template_3'] = 'Yes, I am <strong>really</strong> sure.';
$lang['admin']['confirm_toggleuseractive'] = 'Are you sure you want to toggle the active state of this user?';
...
$lang['admin']['copyusersettings'] = 'Copy settings and preferences from another user';
$lang['admin']['copyusersettings2'] = 'Copy settings from another user';
$lang['admin']['copy_from'] = 'Copy From';
$lang['admin']['copyfromuser'] = 'User';
...
$lang['admin']['deletetemplate'] = 'Delete Template';
$lang['admin']['deletetemplates'] = 'Delete Templates';
$lang['admin']['deleteuser'] = 'Delete User Account';
...
$lang['admin']['enablesitedown'] = 'Is the website &quot;Down for Maintenance&quot';
$lang['admin']['enablewysiwyg'] = 'Use the WYSIWYG on the &quot;Site Down&quot; message';
...
$lang['admin']['error_copyusersettings_self'] = 'This user account is the template user.  You cannot copy user settings here';
$lang['admin']['error_delete_default_parent'] = 'You cannot delete the default page, or a parent of the default page.';
$lang['admin']['error_frominvalid'] = 'The from address specified is not a valid email address';
$lang['admin']['error_fromrequired'] = 'A from address is required';
$lang['admin']['error_hostrequired'] = 'A hostname is required when using the smtp mailer';
$lang['admin']['error_locknotsaved'] = 'Cannot retrieve this information... lock has not been saved';
$lang['admin']['error_mailnotset_notest'] = 'Mail settings have not been saved.  Cannot test';
$lang['admin']['error_mailtest_noaddress'] = 'No address specified for testing';
$lang['admin']['error_mailtest_notemail'] = 'Value specified is not a valid email address';
$lang['admin']['error_module_mincmsversion'] = 'This module requires a newer version of CMS Made Simple';
$lang['admin']['error_multiusersettings'] = 'Cannot set multiple user settings options at the same time';
...
$lang['admin']['error_notconfirmed'] = 'Operation not confirmed';
...
$lang['admin']['error_no_content_blocks'] = 'No content blocks were detected in this template.  Please ensure that you have at least the default {content} block defined in this template';
$lang['admin']['error_objectcantsetthis'] = 'You cannot adjust the %s property of this object';
$lang['admin']['error_parsing_content_blocks'] = 'An error occurred parsing content blocks (perhaps duplicated block names)';
$lang['admin']['error_portinvalid'] = 'Port number is invalid';
$lang['admin']['error_retrieving_file_list'] = 'Error retrieving file list';
$lang['admin']['error_setusersettings_self'] = 'Cannot set the template user to this account';
$lang['admin']['error_timeoutinvalid'] = 'The timeout specified is invalid (must be between 1 and 3600 seconds)';
...
$lang['admin']['error_usernamerequired'] = 'A username is required for SMTP authentication';
$lang['admin']['error_passwordrequired'] = 'A password is required for SMTP authentication';
...
$lang['admin']['help_content_active'] = 'Inactive pages cannot be displayed, or appear in the navigation';
...
$lang['admin']['help_content_cachable'] = 'This toggle indicates wether the content of this page should be cached on the server, and on the browser.  If a page is not cachable, then it must be regenerated on each and every request.  Setting a page to be cachable can be a significant performance boost for most websites.';
...
$lang['admin']['info_changegroupperms'] = 'This page allows specifying which admin user groups have which permission.  Keep in mind that an individual admin user can belong to multiple admin groups.<br/><strong>Note: The &quot;Admin&quot; group is a special group and is automatically granted all permissions.';
$lang['admin']['info_changeusergroup'] = 'This page allows specifying the member groups for each admin user.  Group membership determines the permissions the user has, and therefore his capabilities in the admin console.<br/>Note: the &quot;Admin&quot; group is a special group and is automatically granted all permissions.';
...
EOT;
$lang['admin']['info_mailtest'] = 'This form will send a preformatted email to the address you specify.  If you do not receive the mail you may need to re-check your settings.  <strong>Note:<strong> you may also want to check your spam folder.';
$lang['admin']['info_mail_notset'] = 'Mail settings have not yet been saved.  Please ensure the information on the &quot;Mail Settings&quot; tab is correct for your server.';
$lang['admin']['info_membergroups'] = 'A user may be a member of zero or more groups.  A user who is not a member of any groups will still be able to login to the admin console';
$lang['admin']['info_noedituser'] = 'Although this user account exists, your permissions do not permit you to manage that account';
...
$lang['admin']['lock_refresh'] = 'Locking Refresh';
$lang['admin']['lock_timeout'] = 'Locking Timeout';
...
$lang['admin']['mail_settings'] = 'Mail Settings';
$lang['admin']['mail_testbody'] = '<h2 style="color: green;">Greetings</h2><p>You are receiving this message from an installation of <strong>CMS Made Simple</strong>.  This message is proving the validity of the settings used for sending email messages.   If you are reading this message, then everything appears to be working fine.  However, if you did not solicit this email from a CMS Made Simple admin console, please contact the website administrator.</p>';
$lang['admin']['mail_testsubject'] = 'CMSMS Mail Test message';
...
$lang['admin']['msg_mailprefs_set'] = 'Email settings saved';
...
$lang['admin']['msg_settemplateuser'] = 'Template user account set';
$lang['admin']['msg_usersedited'] = '%d users were modified';
$lang['admin']['msg_usersdeleted'] = '%d users were deleted';
$lang['admin']['msg_usersettingscleared'] = 'User settings cleared';
$lang['admin']['msg_usersettingscopied'] = 'User settings copied from template user account';
...
$lang['admin']['pagedata'] = 'Smarty data or logic that is specific to this page';
...
$lang['admin']['pagemetadata'] = 'Page Specific Metadata';
...
$lang['admin']['performance_information'] = 'Performance and Tuning Information';
$lang['admin']['period_ago'] = 'ago';
$lang['admin']['period_day'] = 'day';
$lang['admin']['period_days'] = 'days';
$lang['admin']['period_decade'] = 'decade';
$lang['admin']['period_decades'] = 'decades';
$lang['admin']['period_fmt'] = '%d %s %s';
$lang['admin']['period_fromnow'] = 'from now';
$lang['admin']['period_hour'] = 'hour';
$lang['admin']['period_hours'] = 'hours';
$lang['admin']['period_min'] = 'minute';
$lang['admin']['period_mins'] = 'minutes';
$lang['admin']['period_month'] = 'month';
$lang['admin']['period_months'] = 'months';
$lang['admin']['period_sec'] = 'second';
$lang['admin']['period_secs'] = 'seconds';
$lang['admin']['period_week'] = 'week';
$lang['admin']['period_weeks'] = 'weeks';
$lang['admin']['period_year'] = 'year';
$lang['admin']['period_years'] = 'years';
...
$lang['admin']['sendmail_settings'] = 'Sendmail Settings';
$lang['admin']['sendtest'] = 'Send';
...
$lang['admin']['settings_authentication'] = 'Authentication';
$lang['admin']['settings_authpassword'] = 'Password';
$lang['admin']['settings_authsecure'] = 'Encryption method';
$lang['admin']['settings_authusername'] = 'Username';
$lang['admin']['settings_mailer'] = 'Mailer';
$lang['admin']['settings_mailfrom'] = 'From Address';
$lang['admin']['settings_mailfromuser'] = 'From Name';
$lang['admin']['settings_sendmailpath'] = 'Sendmail Path';
$lang['admin']['settings_smtpauth'] = 'SMTP Authentication is Required';
$lang['admin']['settings_smtphost'] = 'SMTP Hostname';
$lang['admin']['settings_smtpport'] = 'SMTP Port';
$lang['admin']['settings_smtptimeout'] = 'SMTP Timeout (seconds)';
$lang['admin']['settings_testaddress'] = 'Email Address';
$lang['admin']['setusersettings'] = 'Set this user account to be the template';
...
$lang['admin']['sitedownexcludes'] = 'Exclude these IP addresses from the &quot;Site Down&quot; status';
...
$lang['admin']['templateuser'] = 'Template Account';
$lang['admin']['tempnam_function'] = 'tempnam function';
$lang['admin']['test'] = 'Test';
$lang['admin']['testmsg_success'] = 'Test message sent... check your inbox.';
$lang['admin']['test_allow_browser_cache'] = 'Allowing browsers to cache pages will improve performance by not requiring your system to serve the page on repeated visits to a page.';
...
$lang['admin']['test_auto_clear_cache_age'] = 'The system should be configured to destroy old temporary files after a reasonable time to improve performance and minimize disk space requirements';
$lang['admin']['test_browser_cache_expiry'] = 'A longer value will have increased performance benefits';
...
$lang['admin']['test_error_edeprecated'] = 'TODO';
$lang['admin']['test_error_estrict'] = 'TODO';
$lang['admin']['test_estrict_failed'] = 'E_STRICT is enabled in the error_reporting';
$lang['admin']['test_db_timedifference'] = 'Testing for time difference in the database';
$lang['admin']['test_db_timedifference_msg'] = 'Detected a difference of at least %d seconds.  This may effect the system dramatically';
$lang['admin']['test_file_timedifference'] = 'Testing for time difference in the filesystem';
$lang['admin']['test_file_timedifference_msg'] = 'Detected a difference of at least %d seconds.  This may effect the system dramatically';
...
$lang['admin']['test_smarty_caching'] = 'Enabling smarty caching can have serious performance benefits for most websites.';
$lang['admin']['test_smarty_cacheudt'] = 'Caching user defined tags can have serious performance benefits.  Use caution';
...
$lang['admin']['title_applyusertag'] = 'Save this user defined tag, and continue editing';
$lang['admin']['title_hierselect'] = 'This field displays the selected content page.  The actual string displayed (page title or menu text) is dependent on user and site preference.';
$lang['admin']['title_hierselect_select'] = 'Select a content page.\n\nIf the selected page has children a new dropdown will appear.  Selecting "None" indicates that the selection stops with the value of the previous select if any.';
$lang['admin']['title_mailtest'] = 'Mail Test';
...
$lang['admin']['usersettings'] = 'User Settings';
...
$lang['admin']['warn_bulk_settemplate'] = '<strong>Warning:</strong> This is potentially a destructive operation, and may break an existing website.  <span style="color: red;">Use caution!</span>';
