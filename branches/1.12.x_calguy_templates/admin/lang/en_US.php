...
$lang['adminlogdescription'] = 'Shows a log of who did what in the admin.';
...
$lang['adminprefsdescription'] = 'This is where you set your specific preferences for site administration.';
...
$lang['author'] = 'Author';
$lang['autoclearcache'] = 'Automatically clear the cache every N days';
...
$lang['clearcache_taskdescription'] = 'Executed daily, this task will clear cached files that are older than the age preset in the global preferences';
...
$lang['CMSEX_SQL001'] = 'Problem creeating/updating lock record';
$lang['code'] = 'Code';
$lang['config_information'] = 'CMS Config Settings';
...
$lang['editeventshandler'] = 'TODO *ROLF* new string needed or typo in line 462 of lib\classes\class.CmsAdminThemeBase.php??? TODO';
...
$lang['error_hostrequired'] = 'A hostname is required when using the smtp mailer';
...
$lang['error_nomodules'] = 'No modules installed! Check Extensions > Modules';
$lang['error_notconfirmed'] = 'Operation not confirmed';
$lang['error_timedifference'] = 'Filesystem time is different than server time';
...
$lang['error_parsing_content_blocks'] = 'An error occurred parsing content blocks (perhaps duplicated block names)';
...
$lang['error_timeoutinvalid'] = 'The timeout specified is invalid (must be between 1 and 3600 seconds)';
...
$lang['error_usernamerequired'] = 'A username is required for SMTP authentication';
$lang['error_passwordrequired'] = 'A password is required for SMTP authentication';
$lang['event'] = 'Event';
...
';
$lang['event_help_loginfailed'] = '<p>Sent after a user failed to login into the admin panel.</p>';
...
';
$lang['event_help_moduleinstalled'] = '<p>Sent after a module is installed.</p>';
$lang['event_help_moduleuninstalled'] = '<p>Sent after a module is uninstalled.</p>';
$lang['event_help_moduleupgraded'] = '<p>Sent after a module is upgraded.</p>';
...
$lang['extensionsdescription'] = 'Modules, tags, and other assorted fun.';
...
$lang['globalconfig'] = 'Global Settings';
...
$lang['groupassignments'] = 'Group Assignments';
...
$lang['groupperms'] = 'Group Permissions';
$lang['grouppermsdescription'] = 'Set permissions and access levels for groups';
$lang['groups'] = 'Groups';
$lang['groupsdescription'] = 'This is where you manage groups.';
...
$lang['help_content_cachable'] = 'This toggle indicates wether the content of this page should be cached on the server, and on the browser.  If a page is not cachable, then it must be regenerated on each and every request.  Setting a page to be cachable can be a significant performance boost for most websites.';
...
$lang['help_content_secure'] = 'Specify wether this page should be accessed via a secure (encrypted) connection.  i.e: via HTTPS';
$lang['help_content_showinmenu'] = 'Select wether this page will be visible (by default) in the navigation.';
...
$lang['info_changegroupperms'] = 'This page allows specifying which admin user groups have which permission.  Keep in mind that an individual admin user can belong to multiple admin groups.<br/><strong>Note: The &quot;Admin&quot; group is a special group and is automatically granted all permissions.';
$lang['info_changeusergroup'] = 'This page allows specifying the member groups for each admin user.  Group membership determines the permissions the user has, and therefore his capabilities in the admin console.<br/>Note: the &quot;Admin&quot; group is a special group and is automatically granted all permissions.';
...
EOT;
$lang['info_mailtest'] = 'This form will send a preformatted email to the address you specify.  If you do not receive the mail you may need to re-check your settings.  <strong>Note:<strong> you may also want to check your spam folder.';
$lang['info_mail_notset'] = 'Mail settings have not yet been saved.  Please ensure the information on the &quot;Mail Settings&quot; tab is correct for your server.';
...
$lang['installdirwarning'] = '<em><strong>Warning:</strong></em> install directory still exists. Please remove it completely.';
...
$lang['lock_timeout'] = 'Locking Timeout';
...
$lang['noudtcode'] = 'No code specified for user defined tag';
...
$lang['server_time_diff'] = 'Check for filesystem time differences';
...
$lang['settings_authusername'] = 'Username';
...
$lang['settings_smtptimeout'] = 'SMTP Timeout (seconds)';
...
$lang['tagdescription'] = 'Tags are little bits of functionality that can be added to your content and/or templates.';
$lang['tags'] = 'Tags';
...
$lang['usersdescription'] = 'This is where you manage users.';
$lang['usersgroups'] = 'Users &amp; Groups';
...
EOT;
$lang['warn_nosefurl'] = 'SEO Friendly or <em>Pretty</em> URLs have not been configured, some of these settings are irrelevant';
