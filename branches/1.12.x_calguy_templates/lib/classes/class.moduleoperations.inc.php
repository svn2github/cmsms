...
final class ModuleOperations
{
	 ...
	 * @ignore
	 */
	protected $cmssystemmodules =  array( 'AdminSearch', 'CMSContentManager', 'FileManager','MenuManager','ModuleManager','Search','CMSMailer','News','MicroTiny','CMSPrinting','ThemeManager' );
