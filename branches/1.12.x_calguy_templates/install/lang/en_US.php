...
$lang['install_admin_set_sequences'] = 'TODO';
...
$lang['test_check_memory_failed'] = 'You may not have enough memory to run CMSMS correctly, or with all of your desired addons. If possible, you should try to get your webhost to raise this value. Proceed with caution.';
$lang['test_check_modules_failed'] = 'The modules folder is not writable. You can still install the CMS system, but you will not be able to install modules via the Module Manager in the Admin Panel.';
...
$lang['test_requires_php_version'] = 'CMS Made Simple requires a php version of 5.3.2 or greater (you have %s), but PHP %s or greater is recommended to ensure maximum compatibility with third party addons';
...
// W
$lang['warning_safe_mode'] = '<strong><em>WARNING:</em></strong> PHP Safe mode is enabled. This will cause difficulty with files uploaded via the webbrowser interface, including images, theme and module XML packages. You are advised to contact your webhost to see about disabling Safe mode.';
$lang['write'] = 'Write';
