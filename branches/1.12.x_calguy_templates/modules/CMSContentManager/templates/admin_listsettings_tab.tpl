...
<div class="pageoverflow">
	<p class="pagetext"><label for="namecolumn">{$mod->Lang('prompt_list_namecolumn')}:</label>&nbsp;{cms_help key2='help_listsettings_namecolumn'}</p>
	<p class="pageinput">
...
<div class="pageoverflow">
	<p class="pagetext"><label for="visiblecolumns">{$mod->Lang('prompt_list_visiblecolumns')}:</label>&nbsp;{cms_help key2='help_listsettings_visiblecolumns'}</p>
	<p class="pageinput">
