...
<div class="pageoverflow">
  <p class="pagetext"><label for="locktimeout">{$mod->Lang('prompt_locktimeout')}:</label>&nbsp;{cms_help key2='help_general_locktimeout'}</p>
  <p class="pageinput">
    <input type="text" name="{$actionid}locktimeout" value="{$locktimeout}" size="3" maxlength="3"/>
  </p>
</div>
<div class="pageoverflow">
  <p class="pagetext"><label for="lockrefresh">{$mod->Lang('prompt_lockrefresh')}:</label>&nbsp;{cms_help key2='help_general_lockrefresh'}</p>
  <p class="pageinput">
