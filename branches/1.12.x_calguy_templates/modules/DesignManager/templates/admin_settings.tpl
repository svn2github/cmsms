...
<fieldset>
  ...
  <div class="pageoverflow">
    <p class="pagetext"><label for="locktimeout">{$mod->Lang('lock_timeout')}:</label>&nbsp;{cms_help key2='help_locktimeout'}</p>
    <p class="pageinput">
      <input id="locktimeout" type="text" name="{$actionid}lock_timeout" value="{$lock_timeout}" size="3" maxlength="3"/>
    </p>
  </div>
  <div class="pageoverflow">
    <p class="pagetext"><label for="lockrefresh">{$mod->Lang('lock_refresh')}:</label>&nbsp;{cms_help key2='help_lockrefresh'}</p>
    <p class="pageinput">
