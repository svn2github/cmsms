    ...
    {if $type_obj->get_dflt_flag()}
      <div class="pageoverflow">
        ...
        <p class="pageinput">
          ...
          <input id="tpl_dflt" type="checkbox" name="{$actionid}default" value="1" {if $template->get_type_dflt()}checked="checked"{/if}/>&nbsp;{admin_icon name='help_template_dflt' icon='info.gif' class='helpicon'}
      </p>
      </div>
    {/if}
  {/if}
