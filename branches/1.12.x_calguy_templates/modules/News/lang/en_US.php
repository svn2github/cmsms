...
$lang['info_public'] = 'Public fields are available for frontend editing, and/or for display in summary or detail views.  Private fields are useful for data that is associated with the news article but is not for public use.';
