...
$lang['admin']['new_version_available'] = '<em>Achtung:</em> Eine neue Version von CMS made simple ist verf&uuml;gbar. Sie sollten schnellstm&ouml;glich Ihren Administrator f&uuml;r eine Aktualisierung kontaktieren.';
$lang['admin']['info_urlcheckversion'] = 'Wird in diesem Feld das Wort &quot;none&quot; eingegeben, erfolgt keine &Uuml;berpr&uuml;fung.<br/>Ohne Eintrag wird eine intern vorgegebene URL verwendet.';
...
$lang['admin']['nogcbwysiwyg'] = 'WYSIWYG-Editoren f&uuml;r Globale Inhalsbl&ouml;cke verbieten';
...
$lang['admin']['help_function_current_date'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<ul>
		<li><em>(optional) </em>format - Datums-/Zeitformat, verwendet die Parameter der PHP-Funktion strftime. Weitere Informationen finden Sie <a href=&quot;http://php.net/strftime&quot; target=&quot;_blank&quot;>hier</a>.</li>
		<li><em>(optional) </em>ucword - Wird dieser Parameter auf true gesetzt, wird das erste Zeichen eines jeden Wortes als Kleinbuchstabe ausgegeben.</li>
	</ul>';
$lang['admin']['help_function_valid_xhtml'] = '<h3>Was macht dieser Tag?</h3>
<p>Gibt einen Link zum W3C-HTML-Validator aus.</p>
<h3>Wie wird er eingesetzt?</h3>
<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{valid_xhtml}</code></p>
<h3>Welche Parameter sind m&ouml;glich?</h3>

    <ul>
	<li><em>(optional)</em> url         (string)     - die URL f&uuml;r die Validierung. Standard ist http://validator.w3.org/check/referer.</li>
	<li><em>(optional)</em> class       (string)     - damit kann dem Link (a) eine CSS-Klasse zugeordnet werden.</li>
	<li><em>(optional)</em> target      (string)     - damit kann dem Link (a) ein Ziel (target) zugeordnet werden.</li>
	<li><em>(optional)</em> image       (true/false) - mit dem Wert false wird anstatt des Bilds/Icons ein Textlink angezeigt.</li>
	<li><em>(optional)</em> text        (string)     - damit kann ein Text f&uuml;r den Link bzw. ein alternativer Text f&uuml;r das Bild/Icon vorgegeben werden. Standard ist &#039;valid XHTML 1.0 Transitional&#039;.<br />Bei Verwendung eines Bildes/Icons wird der vorgegebene Text als alternativer Text f&uuml;r das Bild verwendet. Dieser Wert kann jedoch vom Parameter &#039;alt&#039; des Bildes &uuml;berschrieben werden.</li>
	<li><em>(optional)</em> image_class (string)     - damit kann dem Bild (img) eine CSS-Klasse zugeordnet werden Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein.</li>
	<li><em>(optional)</em> src         (string)     - das angezeigte Bild/Icon. Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein. Standard ist hier http://www.w3.org/Icons/valid-xhtml10</li>
	<li><em>(optional)</em> width       (string)     - die Breite des Bildes/Icons. Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein. Standard ist 88 (Breite des Bildes von http://www.w3.org/Icons/valid-xhtml10)</li>
	<li><em>(optional)</em> height      (string)     - die H&ouml;he des Bildes/Icons. Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein. Standard ist hier 31 (H&amp;ouml;he des Bildes von http://www.w3.org/Icons/valid-xhtml10)</li>
	<li><em>(optional)</em> alt         (string)     - ein alternativer Text f&uuml;r das Bild (Attribut &#039;alt&#039;). Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein. Ohne diesen Parameter wird der Wert des Parameters &#039;link&#039; verwendet.</li>
    </ul>';
$lang['admin']['help_function_valid_css'] = '<h3>Was macht dieser Tag?</h3>
<p>Gibt einen Link zum W3C-CSS-Validator aus.</p>
<h3>Wie wird er eingesetzt?</h3>
<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{valid_css}</code></p>
<h3>Welche Parameter sind m&ouml;glich?</h3>

    <ul>
        <li><em>(optional)</em> url         (string)     - die URL f&uuml;r die Validierung. Standard ist http://jigsaw.w3.org/css-validator/check/referer.</li>
	<li><em>(optional)</em> class       (string)     - damit kann dem Link (a) eine CSS-Klasse zugeordnet werden.</li>
	<li><em>(optional)</em> target      (string)     - damit kann dem Link (a) ein Ziel (target) zugeordnet werden.</li>
	<li><em>(optional)</em> image       (true/false) - mit dem Wert false wird anstatt des Bilds/Icons ein Textlink angezeigt.</li>
	<li><em>(optional)</em> text        (string)     - damit kann ein Text f&uuml;r den Link bzw. ein alternativer Text f&uuml;r das Bild/Icon vorgegeben werden. Standard ist &#039;Valid CSS 2.1&#039;.<br />	Bei Verwendung eines Bildes/Icons wird der vorgegebene Text als alternativer Text f&uuml;r das Bild verwendet. Dieser Wert kann jedoch vom Parameter &#039;alt&#039; des Bildes &uuml;berschrieben werden.</li>
	<li><em>(optional)</em> image_class (string)     - damit kann dem Bild (img) eine CSS-Klasse zugeordnet werden Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein.</li>
        <li><em>(optional)</em> src         (string)     - das angezeigte Bild/Icon. Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein. Standard ist hier http://jigsaw.w3.org/css-validator/images/vcss</li>
        <li><em>(optional)</em> width       (string)     - die Breite des Bildes/Icons. Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein. Standard ist 88 (Breite des Bildes von http://jigsaw.w3.org/css-validator/images/vcss)</li>
        <li><em>(optional)</em> height      (string)     - die H&ouml;he des Bildes/Icons. Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein. Standard ist hier 31 (H&amp;ouml;he des Bildes von http://jigsaw.w3.org/css-validator/images/vcss)</li>
	<li><em>(optional)</em> alt         (string)     - ein alternativer Text f&uuml;r das Bild (Attribut &#039;alt&#039;). Der Parameter &#039;image&#039; darf jedoch nicht auf false gesetzt sein. Ohne diesen Parameter wird der Wert des Parameters &#039;link&#039; verwendet.</li>
    </ul>';
$lang['admin']['help_function_title'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Gibt den Titel einer Seite aus.</p>
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{title}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<p><em>(optional)</em> assign (string) - Das Ergebnis wird an eine Smarty-Variable mit diesem Namen &uuml;bergeben.</p>';
$lang['admin']['help_function_stylesheet'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Holt die Stylesheets aus dem System. Standardm&auml;&szlig;ig werden alle mit dem aktuellen Template verbundenen Stylesheets geladen.</p>
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in den head-Bereich Ihres Template bzw. Ihrer Seite ein: <code>{stylesheet}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
		<li><em>(optional)</em>name - Mit dem Parameter name kann ein Stylesheet festgelegt werden, welches anstatt der mit der aktuellen Seite verbundenen Stylesheets geladen werden soll (unabh&auml;ngig davon, ob es mit dem aktuellen Template verkn&uuml;pft ist oder nicht).</li>
		<li><em>(optional)</em>media - Wenn der Parameter name definiert wurde, k&ouml;nnen Sie f&uuml;r dieses Stylesheet einen abweichenden Medientyp festlegen.</li>
	</ul>';
$lang['admin']['help_function_stopexpandcollapse'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Damit lassen sich Inhalte auseinander und wieder zusammen falten, zum Beispiel so:<br />
	<a href=&quot;#expand1&quot; onClick=&quot;expandcontent(&#039;expand1&#039;)&quot; style=&quot;cursor:hand; cursor:pointer&quot;>F&uuml;r weitere Informationen klicken Sie bitte hier</a><span id=&quot;expand1&quot; class=&quot;expand&quot;><a name=&quot;help&quot;></a> - Hier stehen alle ben&ouml;tigten Informationen ...</a></span></p>

	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{startExpandCollapse id=&quot;name&quot; title=&quot;Hier klicken&quot;}</code>. Am Ende des faltbaren Inhalte muss der Tag {stopExpandCollapse} aufgerufen werden. Hier ein Beispiel:
	<br />
	<code>{startExpandCollapse id=&quot;name&quot; title=&quot;Hier klicken&quot;}<br />
	Hier steht der Text, den der Besucher Ihrer Webseite angezeigt bekommt, wenn er auf den oben stehenden Link &quot;Hier klicken&quot; geklickt hat. Es wird dann der gesamte Inhalt angezeigt, der sich zwischen den Tags  {startExpandCollapse} und {stopExpandCollapse} befindet.<br />
	{stopExpandCollapse}
	</code>
	<br />
	<br />
	Hinweis: Wenn Sie diesen Tag mehrfach auf einer Seite einsetzen m&ouml;chten, muss der Tag mit einer eindeutigen ID versehen werden.</p>
	...
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<p>
	<i>startExpandCollapse ben&ouml;tigt die folgenden Parameter:</i><br />
	&nbsp; &nbsp;id - Eine eindeutige ID f&uuml;r den auseinander/zusammen zu faltenden Bereich.<br />
	&nbsp; &nbsp;title - Der Text, auf den geklickt werden muss, um die Inhalte auseinander/zusammen zu falten.<br />
	<i>stopExpandCollapse ben&ouml;tigt keine Parameter.</i><br />
	</p>';
...
$lang['admin']['help_function_sitemap'] = '    <h3>Hinweis</h3>
    <p>Dieses Plugin wird nicht l&auml;nger unterst&uuml;tzt. Sie sollten anstatt dessen  Users should now see the <code>{site_mapper}</code> plugin.</p>
    <h3>Was macht dieser Tag?</h3>
    <p>Gibt eine Sitemap (Index aller auf der Webseite angezeigten Seiten) aus.</p>
    <h3>Wie wird er eingesetzt?</h3>
    <p>F&uuml;;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein:  <code>{sitemap}</code></p>
    <h3>Welche Parameter sind m&ouml;glich?</h3>
            <ul>
            <li><em>(optional)</em> <tt>class</tt> - Eine CSS-Klasse f&uuml;r den ul-Tag, der die gesamte Sitemap umschlie&szlig;t.</li>
            <li><em>(optional)</em> <tt>start_element</tt> - Die . Mit diesem Parameter wird das Start-Element der Sitemap festgelegt. Dies kann entweder &uuml;ber die Angabe der Hierarchie (z.Bsp.: 1.2 oder 3.5.1) oder den Seiten-Alias erfolgen.</li>
...
$lang['admin']['help_function_adsense'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>Zun&auml;chst sollten Sie sich ein Google-Adsense-Konto einrichten und die Parameter f&uuml;r dessen Einsatz abfragen. Dann f&uuml;gen Sie den Tag wie folgt in Ihr Template bzw. Ihre Seite ein: <code>{adsense ad_client=&quot;pub-random#&quot; ad_width=&quot;120&quot; ad_height=&quot;600&quot; ad_format=&quot;120x600_as&quot;}</code>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	...
	<ul>
		...
		<li>ad_width - Breite der Anzeige</li>
		<li>ad_height - H&ouml;he der Anzeige</li>
		<li>ad_format - &quot;Format&quot; der Anzeige, <em>z.Bsp. 120x600_as</em></li>
		<li>ad_channel - Channels sind eine Erweiterung des Adsense-Programms. Wenn Sie dies nutzen, geben Sie es hier ein.</li>
		<li>ad_type - m&ouml;gliche Optionen sind text, image oder text_image.</li>
		<li>color_border - die Farbe der Umrandung. Verwenden Sie den HEX-Code oder den (englischen) Namen der Farbe (z.Bsp. Red)</li>
		<li>color_link - die Farbe des Linktextes. Verwenden Sie den HEX-Code oder den (englischen) Namen der Farbe (z.Bsp. Red)</li>
		<li>color_url - die Farbe der URL. Verwenden Sie den HEX-Code oder den (englischen) Namen der Farbe (z.Bsp. Red)</li>
		<li>color_text - dies Farbe des Textes. Verwenden Sie den HEX-Code oder den (englischen) Namen der Farbe (z.Bsp. Red)</li>
	</ul>';
$lang['admin']['help_function_sitename'] = '        <h3>Was macht dieser Tag?</h3>
        ...
        <h3>Wie wird er eingesetzt?</h3>
        <p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{sitename}</code></p>
        <h3>Welche Parameter sind m&ouml;glich?</h3>
	<p><em>(optional)</em> assign (string) - Das Ergebnis wird an eine Smarty-Variable mit diesem Namen &uuml;bergeben.</p>';
...
$lang['admin']['help_function_root_url'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{root_url}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<p>Derzeit keine.</p>';
$lang['admin']['help_function_repeat'] = '	<h3>Was macht dieser Tag?</h3>
  <p>Wiederholt eine vorgegebene Sequenz von Zeichen entsprechend der Vorgabe</p>
	<h3>Wie wird er eingesetzt?</h3>
  <p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{repeat string=&#039;repeat this &#039; times=&#039;3&#039;}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
  <ul>
  <li>string=&#039;text&#039; - Der zu wiederholende String</li>
  <li>times=&#039;num&#039; - Die Anzahl der Wiederholungen.</li>
  </ul>';
$lang['admin']['help_function_recently_updated'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{recently_updated}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
											 <li><p><em>(optional)</em> number=&#039;10&#039; - Anzahl der anzuzeigenden Seiten, voreingestellt ist 10.</p><p>Beispiel:</p><pre>{recently_updated number=&#039;15&#039;}</pre></li>
											 	<li><p><em>(optional)</em> leadin=&#039;Zuletzt ge&auml;ndert&#039; - Text, der links vom Bearbeitungsdatum angezeigt wird.</p><p>Beispiel: <pre>{recently_updated leadin=&#039;Zuletzte ge&auml;ndert&#039;}</pre></p></li>
											 	<li><p><em>(optional)</em> showtitle=&#039;true&#039; - Zeigt den Titel an, falls einer existiert (true|false).</p><p>Beispiel: <pre>{recently_updated showtitle=&#039;true&#039;}</pre></p></li>											 	
											 	<li><p><em>(optional)</em> css_class=&#039;irgendein_name&#039; - f&uuml;gt die Liste in einen div-Tag mit dieser Klasse ein.</p><p>Beispiel: <pre>{recently_updated css_class=&#039;irgendein_name&#039;}</pre></p></li>											 	
											 		<li><p><em>(optional)</em> dateformat=&#039;d.m.y h:m&#039; - Standard ist d.m.y h:m , passen Sie das Format Ihren W&uuml;nschen an (siehe php-date-format)</p><p>Beispiel: <pre>{recently_updated dateformat=&#039;D M j G:i:s T Y&#039;}</pre></p></li>											 	
	</ul>
	<p>oder kombiniert:</p>
	<pre>{recently_updated number=&#039;15&#039; showtitle=&#039;false&#039; leadin=&#039;Zuletzt ge&auml;ndert: &#039; css_class=&#039;meine_css&#039; dateformat=&#039;D M j G:i:s T Y&#039;}</pre>';
$lang['admin']['help_function_print'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie in Ihrem Template an der Stelle, an der der Druck-Button erscheinen soll, <code>{print}</code> ein. Weitere Informationen dazu finden Sie in der <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=Printing&quot;>Modulhilfe</a> des Print-Moduls.';
$lang['admin']['help_function_oldprint'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{print}</code><br></p>
        <h3>Welche Parameter sind m&ouml;glich?</h3>
        <ul>
                <li><em>(optional)</em> goback - Wenn Sie diesen Parameter auf  true setzen, wird auf der auszudruckenden Seite ein Zur&uuml;ck-Link angezeigt.</li>
                <li><em>(optional)</em> popup - Wenn Sie diesen Parameter auf true setzen, wird die auszudruckende Seite in einem neuen Fenster angezeigt.</li>
                <li><em>(optional)</em> script - Wenn Sie diesen Parameter auf true setzen, wird f&uuml;r den Start des Ausdrucks der Seite Javascript verwendet.</li>
                <li><em>(optional)</em> showbutton - Wenn Sie diesen Parameter auf true setzen, wird anstatt des Textlinks eine Druckersymbol angezeigt.</li>
                <li><em>(optional)</em> class - CSS-Klasse f&uuml;r den Link, voreingestellt ist noprint.</li>
                <li><em>(optional)</em> text - Mit diesem Parameter kann der Text f&uuml;r den Link festgelegt werden, der anstatt &quot;Print this page&quot; angezeigt werden soll.
                    <p>Beispiel:</p>
                     <pre>{print text=&quot;Druckversion&quot;}</pre>      
                     </li>
               <li><em>(optional)</em> title - Text, der als Titel-Attribut angezeigt wird. Ohne Angabe wird der text-Parameter verwendet.</li>
                <li><em>(optional)</em> Hier k&ouml;nnen dem Link (a) weitere Optionen hinzugef&uuml;gt werden.</li>
                <li><em>(optional)</em> src_img - Zeigt diese Bilddatei an. Voreingestellt ist images/cms/printbutton.gif.</li>
                <li><em>(optional)</em> class_img - eine CSS-Klasse f&uuml;r den img-Tag (wenn der Parameter showbutton gesetzt wurde).</li>
        </ul>';
$lang['admin']['login_info_title'] = 'Information';
$lang['admin']['login_info'] = 'An dieser Stelle sollten Sie auf folgendes achten';
$lang['admin']['login_info_params'] = '<ol> 
  <li>In Ihrem Browser sollten Cookies aktiviert/zugelassen sein</li> 
  <li>In Ihrem Browser sollte Javascript aktiviert/zugelassen sein</li> 
  <li>F&uuml;r die folgende Adresse sollten sich neu &ouml;ffnende Fenster zugelassen werden:</li> 
</ol>';
...
$lang['admin']['help_function_modified_date'] = '        <h3>Was macht dieser Tag?</h3>
        ...
        <h3>Wie wird er eingesetzt?</h3>
        <p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{modified_date format=&quot;%A %d-%b-%y %T %Z&quot;}</code></p>
        <h3>Welche Parameter sind m&ouml;glich?</h3>
        <ul>
                <li><em>(optional)</em>format - Format von Datum/Zeit, es werden die Parameter der PHP-Funktion strftime verwendet. Weitere Informationen zu diesen Parametern finden Sie <a href=&quot;http://php.net/strftime&quot; target=&quot;_blank&quot;>hier</a>.</li>
        </ul>';
$lang['admin']['help_function_metadata'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{metadata}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
		<li><em>(optional)</em>showbase (true/false) - Wird dieser Parameter auf false gesetzt, wird der base-Tag nicht an den Browser gesandt. Wenn Sie in der config.php den Parameter $config[use_hierarchy] auf true setzen, MUSS dieser Parameter ebenfalls auf true gesetzt werden.</li>
	</ul>';
$lang['admin']['help_function_menu_text'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Gibt den Men&uuml;text einer Seite aus.</p>
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein:  <code>{menu_text}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<p>Derzeit keine.</p>';
$lang['admin']['help_function_menu'] = '	<h3>Was macht dieser Tag?</h3>
	...
	Anstatt <code>{cms_module module=&#039;MenuManager&#039;}</code>k&ouml;nnen Sie jetzt <code>{menu} </code>verwenden, um das Modul in einem Template oder eine Seite einzuf&uuml;gen.
	</p>
	<h3>Wie wird er eingesetzt?</h3>
...
$lang['admin']['help_function_last_modified_by'] = '        <h3>Was macht dieser Tag?</h3>
        <p>Gibt die Person aus, die die Seite zuletzt bearbeitet hat. Wurde kein Format vorgegeben, wird standardm&auml;&szlig;ig die ID des Benutzers ausgegeben.</p>
        <h3>Wie wird er eingesetzt?</h3>
        <p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{last_modified_by format=&quot;fullname&quot;}</code></p>
        <h3>Welche Parameter sind m&ouml;glich?</h3>
        <ul>
                <li><em>(optional)</em>format - ID, username, fullname</li>';
$lang['admin']['help_function_iamge'] = '  <h3>Was macht dieser Tag?</h3>
  <p>Erzeugt einen image-Tag auf ein Bild im Verzeichnis /uploads/images</p>
  <h3>Wie wird er eingesetzt?</h3>
  <p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{image src=&quot;irgendwas.jpg&quot;}</code></p>
  <h3>Welche Parameter sind m&ouml;glich?</h3>
  <ul>
...
$lang['admin']['help_function_imagegallery'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<p>wobei ihr_verzeichnis das Verzeichnis ist, in dem sich die Bilder befinden.</p>
	
    <h3>Welche Parameter sind m&ouml;glich?</h3>
    <p>Sie k&ouml;nnen einige Parameter verwenden, die sich aber 
    an Beispielen am besten erl&auml;utern lassen.</p>
        <ol>
		<li><strong>picFolder z.Bsp. picFolder=&quot;uploads/images/ihr_verzeichnis/&quot;</strong><br/>
		Legt den Pfad zu der Galerie fest (ihr_verzeichnis) und endet mit einem &#039;/&#039;. 
		So k&ouml;nnen Sie mehrere Verzeichnisse und Galerien verwenden.</li>

		<li><strong>type z.Bsp type=&quot;click&quot; oder type=&quot;popup&quot;</strong><br/>
		Um die Popup-Funktion verwenden zu k&ouml;nnen, m&uuml;ssen Sie im 
		head-Bereich Ihres Templates ein Javascript einbinden. Das Javascript finden Sie 
		am Ende der Seite! <em>Voreingestellt ist &#039;click&#039;.</em></li>

		<li><strong>divID z.Bsp. divID =&quot;imagegallery&quot;</strong><br/>
		Legt die ID f&uuml;r den &#039;div&#039;-Container fest, der die Bildergalerie umschlie&szlig;t, 
		so dass Sie f&uuml;r jede Galerie ein eigenes Stylesheet verwenden k&ouml;nnen. <em>Voreingestellt ist &#039;imagegallery&#039;.</em></li>

		<li><strong>sortBy z.Bsp. sortBy = &quot;name&quot; oder sortBy = &quot;date&quot;</strong><br/>
		Sortiert die Bilder nach Namen (&#039;name&#039;) ODER Datum (&#039;date&#039;). <em>Keine Voreinstellung.</em></li>

		<li><strong>sortByOrder z.Bsp. sortByOrder = &quot;asc&quot; oder sortByOrder = &quot;desc&quot;</strong><br/>
		Sortiert die Bilder in aufsteigender (&#039;asc&#039;) ODER absteigender &#039;(desc&#039;) Reihenfolge. <em>Keine Voreinstellung.</em>.</li>

		<li>Dieser Parameter legt die Beschriftung oberhalb des Bildes im Gro&szlig;format fest<br/>
		<strong>bigPicCaption = &quot;name&quot; </strong>(Dateiname ohne Dateibezeichner)<em> oder </em><br/>
		<strong>bigPicCaption = &quot;file&quot; </strong>(Dateiname mit Dateibezeichner)<em> oder </em><br/>
		<strong>bigPicCaption = &quot;number&quot; </strong>(eine Zahlen-Sequenz)<em> oder </em><br/>
		<strong>bigPicCaption = &quot;none&quot; </strong>(Keine Beschriftung)<br/>
		<em>Voreingestellt ist &quot;name&quot;. </em></li>

		<li>Dieser Parameter legt die Beschriftung der Vorschaubilder fest<br/>
		<strong>thumbPicCaption = &quot;name&quot;</strong> (Dateiname ohne Dateibezeichner)<em> oder </em><br/>
		<strong>thumbPicCaption = &quot;file&quot;</strong> (Dateiname mit Dateibezeichner)<em> oder </em><br/>
		<strong>thumbPicCaption = &quot;number&quot; </strong>(eine Zahlen-Sequenz)<em> oder </em><br/>
		<strong>thumbPicCaption = &quot;none&quot; </strong>(Keine Beschriftung)<br/>
		<em>Voreingestellt ist &quot;name&quot;.</em></li>

		<li>Dieser Parameter legt den &#039;alt&#039;-Tag f&uuml;r das Bild im Gro&szlig;format fest - empfohlen.<br/>
		<strong>bigPicAltTag = &quot;name&quot; </strong>(Dateiname ohne Dateibezeichner)<em> oder </em><br/>
		<strong>bigPicAltTag = &quot;file&quot; </strong>(Dateiname mit Dateibezeichner)<em> oder </em><br/>
		<strong>bigPicAltTag = &quot;number&quot; </strong>(eine Zahlen-Sequenz)<br/>
		<em>Voreingestellt ist &quot;name&quot;.</em></li>

		<li>Dieser Parameter legt den &#039;title&#039;-Tag f&uuml;r das Bild im Gro&szlig;format fest.<br/>
		<strong>bigPicTitleTag = &quot;name&quot; </strong>(Dateiname ohne Dateibezeichner)<em> oder </em><br/>
		<strong>bigPicTitleTag = &quot;file&quot; </strong>(Dateiname mit Dateibezeichner)<em> oder </em><br/>
		<strong>bigPicTitleTag = &quot;number&quot; </strong>(eine Zahlen-Sequenz)<em> oder </em><br/>
		<strong>bigPicTitleTag = &quot;none&quot; </strong>(Kein Titel)<br/>
		<em>Voreingestellt ist &quot;name&quot;.</em></li>

		<li><strong>thumbPicAltTag</strong><br/>
		<em>Entspricht dem bigPicAltTag, jedoch f&uuml;r die Vorschaubilder.</em><em></li>

		<li><strong>thumbPicTitleTag *</strong><br/>
		<em>Entspricht dem bigPicAltTag, jedoch f&uuml;r die Vorschaubilder.<br/>
	        <strong>*Hinweis: Nach diesen Parametern wird standardm&auml;&szlig;ig &#039;... klicken Sie hier f&uuml;r
	        die Anzeige des Bildes im Gro&szlig;format&#039; oder falls einer dieser Parameter nicht gesetzt wurde 
	        &#039;Klicken Sie hier f&uuml;r die Anzeige des Bildes im Gro&szlig;format ...&#039; hinzugef&uuml;gt.</strong></em></li>
        </ol>
  <p>Ein etwas komplexeres Beispiel</p>
        ...
        f&uuml;r &#039;alt&#039; und &#039;Klicken Sie hier f&uuml;r die Anzeige des Bildes im Gro&szlig;format ...&#039; f&uuml;r den &#039;title&#039; sein. Das Plugin muss wie folgt aufgerufen werden:</p>
...
<br/>
        ...
        <h4>Das Javascript f&uuml;r die Popup-Funktion ist jetzt im Code des Plugins enthalten. Wenn Sie das Javascript im Templates eingef&uuml;gt haben, entfernen Sie es.</h4>';
...
$lang['admin']['help_function_googlepr'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{googlepr}</code></p>

	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
		<li><em>(optional)</em> domain - Die Webseite, f&uuml;r die der Pagerank angezeigt werden soll.</li>
	</ul>';
$lang['admin']['help_function_google_search'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{google_search}</code><br />
	<br />
	Hinweis: Damit die Suche funktioniert, muss Ihre Webseite von Google indiziert worden sein. Sie k&ouml;nnen Ihre Webseite <a href=&quot;http://www.google.com/addurl.html&quot;>hier</a> bei Google anzumelden.</p>
	...
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
		<li><em>(optional)</em> domain - Dieser Parameter &uuml;bergibt den Domainnamen an die Google-Suche. Dieses Script versucht, die Domain automatisch zu bestimmen.</li>
		<li><em>(optional)</em> buttonText - Der Text, der auf dem Such-Button angezeigt wird. Standard ist &quot;Search Site&quot;.</li>
	</ul>';
$lang['admin']['help_function_global_content'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein:<code>{global_content name=&#039;mein_blob&#039;}</code>, wobei mein_blob der Name ist, der dem Block bei dessen Erstellung gegeben wurde.</p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
		<li>name - Der Name des Globalen Inhaltsblocks, der angezeigt werden soll.</li>
	</ul>';
$lang['admin']['help_function_get_template_vars'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{get_template_vars}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
											  <p>Derzeit keine.</p>';
$lang['admin']['help_function_embed'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Aktiviert die Einbettung einer externen Applikation in CMSms. Die h&auml;ufigste Anwendung hierf&uuml;r ist wohl ein Forum. 
	F&uuml;r die Implementierung werden IFRAMES verwendet, so dass &auml;ltere Browser damit Probleme haben k&ouml;nnen. Dies ist der einzige funktionierende Weg, 
	ohne Ver&auml;nderungen an der einzubettenden Applikation vorzunehmen.</p>
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{embed url=http://www.google.com/}</code><br></p>
        <h4>Beispiel, um das Iframe gr&ouml;&szlig;er zu machen</h4>
	<p>F&uuml;gen Sie Ihrem Stylesheet folgendes hinzu:</p>
        <pre>#myframe { height: 600px; }</pre>
        <h3>Welche Parameter sind m&ouml;glich?</h3>
        <ul>
               <li><em>(erforderlich) </em>url - die URL, die eingebettet werden soll
               <li><em>(optional) </em>header=true - damit wird der header-Code erzeugt, damit sich die Gr&ouml;&szlig;e des Iframes der eingebetteten Applikation anpasst.</li>

        </ul>
       <p>Auf der Seite rufen Sie den Tag mit {embed url=..} auf; in den &quot;Metadaten&quot; (Registerkarte Optionen) muss {embed header=true} eingef&uuml;gt werden. Damit dies funktioniert, sollten Sie sicherstellen, dass der {metadata}-Tag im head-Bereich Ihres Templates aufgerufen wird.</p>';
$lang['admin']['help_function_edit'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Erzeugt einen Link, um die Seite zu bearbeiten.</p>
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{edit}</code><br></p>
        <h3>Welche Parameter sind m&ouml;glich?</h3>
        <ul>
                <li><em>(optional) </em>showbutton - Wenn Sie diesen Parameter auf true setzen, wird anstatt des Textlinks eine Grafik angezeigt.</li>
	        <li><em>(optional) </em>text - Mit diesem Parameter kann der anzuzeigende Text f&uuml;r den Link festgelegt werden.</li>
        </ul>';
$lang['admin']['help_function_description'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Gibt die Beschreibung einer Seite aus (Titel-Attribut).</p>
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{description}</code></p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<p>Derzeit keine.</p>';
$lang['admin']['help_function_created_date'] = '        <h3>Was macht dieser Tag?</h3>
        ...
        <h3>Welche Parameter sind m&ouml;glich?</h3>
        <ul>
                <li><em>(optional)</em>format - Datums-/Uhrzeit-Format. Verwendet die Parameter der PHP-Funktion strftime. Weitere Informationen dazu finden Sie <a href=&quot;http://php.net/strftime&quot; target=&quot;_blank&quot;>hier</a>.</li>
        </ul>';
$lang['admin']['help_function_content'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{content}</code>.</p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
		<li><em>(optional)</em>block - &uuml;ber diesen Parameter k&ouml;nnen Sie mehr als einen Inhaltsblock auf einer Seite erstellen. Wird der content-Tags mehrfach in einem Template aufgerufen, werden auch in der Administration auf der Seite zum Bearbeiten der Seite die entsprechende Anzahl Bearbeitungsfelder angezeigt.
		<p>Beispiel:</p>
<pre>{content block=&quot;Zweiter Inhaltsblock&quot;}</pre>
<p>Wenn Sie jetzt diese Seite bearbeiten, erscheint beim Bearbeiten der Seite ein weiterer Textbereich mit dem Namen &quot;Zweiter Inhaltsblock&quot;.</li>
		<li><em>(optional)</em>wysiwyg (true/false) - Wird dieser Parameter auf false gesetzt, wird zum Bearbeiten dieser Seite nicht der festgelegte WYSIWYG-Editor verwendet. Ist der Parameter true, funktioniert es wie bekannt. Funktioniert nur, wenn der block-Parameter verwendet wird.</li>
		<li><em>(optional)</em>oneline (true/false) - Wird dieser Parameter auf true gesetzt, wird bei der Bearbeitung dieses Blocks nur eine Zeile angezeigt. Ist der Parameter false, funktioniert es wie bekannt. Funktioniert nur, wenn der block-Parameter verwendet wird.</li>
		<li><em>(optional)</em>assign - Mit diesem Parameter kann der Inhalt einer Smarty-Variablen zugewiesen werden. Diese kann dann in anderen Bereichen der Seite verwendet werden. Auch eine Pr&uuml;fung, ob ein bestimmter Inhalt existiert, ist damit m&ouml;glich.
...
$lang['admin']['help_function_contact_form'] = '  <h3>HINWEIS:</h3>
  <p>Dieses Plugin wird nicht l&auml;nger unterst&uuml;tzt und wird auch in k&uuml;nftigen Versionen von CMS made simple nicht mehr enthalten sein. Wir empfehlen die Verwendung des Formbuilder-Moduls mit dem enthaltenen Kontaktformular.</p>
	<h3>Was macht dieser Tag?</h3>
	<p>Gibt ein Kontaktformular aus. Damit k&ouml;nnen die Besucher Ihrer Webseite eine Nachricht an eine festgelegte Emailadresse senden.</p>
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{contact_form email=&quot;ihrname@ihredomain.de&quot;}</code><br>
	<br>
	Wenn die Email an mehrere Email-Adressen versandt werden soll, m&uuml;ssen diese mit Komma voneinander getrennt angegeben werden.</p>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
		<li>email - die Emailadresse, an die die Nachricht gesandt werden soll.</li>
		<li><em>(optional) </em>style - true/false, verwendet vordefinierte Styles. Standard ist true.</li>
		<li><em>(optional) </em>subject_get_var - ein String, mit dem festgelegt werden kann, ob das Betreff-Feld via _GET-Variable vorbelegt werden kann.
		<p>Beispiel:</p>
               <pre>{contact_form email=&quot;ihrname@ihredomain.de&quot; subject_get_var=&quot;subject&quot;}</pre>
             <p>Dann rufen Sie die Seite &quot;Kontakt&quot; wie folgt auf: /index.php?page=kontakt&amp;subject=Test+Betreff</p>
             <p>Anschlie&szlig;end wird die &quot;Betreff&quot;-Box mit &quot;Test Betreff&quot; vorbelegt sein.</p>
           </li>
		<li><em>(optional)</em>captcha - true/false, verwendet den Captcha-Antwort-Test (das Captcha-Modul muss installiert sein). Standard ist false.</li>
	</ul>';
$lang['admin']['help_function_cms_versionname'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{cms_versionname}</code>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<p>Keine</p>';
$lang['admin']['help_function_cms_version'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{cms_version}</code>
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<p>Keine.</p>';
...
$lang['admin']['help_function_cms_selflink'] = '		<h3>Was macht dieser Tag?</h3>
		...
		<li><em>(optional)</em> <tt>anchorlink</tt> - Neuer Parameter f&uuml;r einen seiteninternen Link. Wenn dieser Parameter verwendet wird, muss auch der Wert <tt>dir =&quot;anchor&quot;</tt> gesetzt werden. Das Zeichen # muss nicht hinzugef&uuml;gt werden, da dies automatisch erfolgt.</li> <!-- Russ - 25-04-2006 -->
	...
	<li><em>(optional)</em> <tt>text</tt> - Text, der f&uuml;r den Link angezeigt wird. Wird kein Wert festgelegt, wird anstatt dessen der Seitenname verwendet.</li>
		...
		<li><em>(optional)</em> <tt>href</tt> - Wenn der Parameter href verwendet wird, wird nur der href-Wert erzeugt (kein anderer Parameter m&ouml;glich). <strong>Beispiel:</strong> <a href=&quot;{cms_selflink href=&quot;alias&quot;}&quot;><img src=&quot;&quot;></a></li>
		<li><em>(optional)</em> <tt>image</tt> - Die URL eines Bildes, welches als Link verwendet werden soll. <strong>Beispiel:</strong> {cms_selflink dir=&quot;next&quot; image=&quot;next.png&quot; text=&quot;Next&quot;}</li>
...
$lang['admin']['help_function_cms_module'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<ul>
		<li>module - Name des Moduls, das eingef&uuml;gt werden soll. Dieser ist nicht zeichensensitiv.</li>
	</ul>';
...
<h3>Wie wird er eingesetzt?</h3>
<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: <code>{breadcrumbs}</code></p>
<h3>Welche Parameter sind m&ouml;glich?</h3>
<ul>
	<li><em>(optional)</em> <tt>delimiter</tt> - Text, um die Eintr&auml;ge in der Auflistung voneinander zu trennen (voreingestellt &quot;&amp;gt;&amp;gt;&quot;).
...
$lang['admin']['help_function_anchor'] = '	<h3>Was macht dieser Tag?</h3>
	...
	<h3>Welche Parameter sind m&ouml;glich?</h3>
	<ul>
	<li><tt>anchor</tt> - Worauf der Link verweisen soll (der Teil nach #).</li>
	<li><tt>text</tt> - Der Text, der im Link angezeigt werden soll.</li>
	<li><tt>class</tt> - die CSS-Klasse f&uuml;r den Link</li>
	<li><tt>title</tt> - das Titel-Attribut f&uuml;r den Link</li>
	<li><tt>tabindex</tt> - ein numerischer Tabindex f&uuml;r den Link</li>
	<li><tt>accesskey</tt> - ein Accesskey f&uuml;r den Link</li>
...
$lang['admin']['help_function_site_mapper'] = '	<h3>Was macht dieser Tag?</h3>
	<p>Mit diesem Tag wird nur der Syntax zur Verwendung des <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=MenuManager&quot;>MenuManager-Moduls</a> und der Erstellung einer Sitemap vereinfacht.</p>
	<h3>Wie wird er eingesetzt?</h3>
	<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein: {site_mapper}</code></p><p>Weitere Informationen dazu finden Sie in der <a href=&quot;listmodules.php?action=showmodulehelp&amp;module=MenuManager&quot;>Hilfe des MenuManagers</a>.</p>
  <p>Wenn kein Parameter f&uuml;r template angegeben wird, wird das Template minimal_menu.tpl verwendet.</p>
  <p>Weitere im Tag verwendete Parameter sind im MenuManager-Template als  <code>{$menuparams.paramname}</code> verf&uuml;gbar.</p>';
$lang['admin']['help_function_redirect_url'] = '	<h3>Was macht dieser Tag?</h3>
  <p>Dieses Plugin erlaubt Ihnen, Ihre Besucher auf eine andere URL weiterzuleiten. Dies l&auml;sst sich auch gut mit Smarty-Bedingungen verwenden (zum Beispiel, wenn die Seite gerade wegen Wartungsarbeiten nicht erreichbar ist).</p>
	<h3>Wie wird er eingesetzt?</h3>
<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein:  <code>{redirect_url urle=&#039;www.cmsmadesimple.org&#039;}</code></p>';
$lang['admin']['help_function_redirect_page'] = '	<h3>Was macht dieser Tag?</h3>
 <p>Dieses Plugin erlaubt Ihnen, Ihre Besucher auf eine andere Seite weiterzuleiten. Dies l&auml;sst sich auch gut mit Smarty-Bedingungen verwenden (zum Beispiel eine Weiterleitung auf eine Login-Seite, wenn der Besucher noch nicht angemeldet ist).</p>
	<h3>Wie wird er eingesetzt?</h3>
<p>F&uuml;gen Sie den Tag folgenderma&szlig;en in Ihr Template bzw. Ihre Seite ein:  <code>{redirect_page page=&#039;some-page-alias&#039;}</code></p>';
$lang['admin']['of'] = 'von';
$lang['admin']['first'] = 'Erster';
$lang['admin']['last'] = 'Letzter';
...
$lang['admin']['date_format_string'] = 'Datumsformat';
$lang['admin']['date_format_string_help'] = 'mit <em>strftime</em> formatiertes Datum';
...
$lang['admin']['cantremove'] = 'Konnte nicht entfernt werden';
...
$lang['admin']['confirmdefault'] = 'Wollen Sie wirklich die Seite - %s - als Startseite Ihrer Webseite festlegen?';
...
$lang['admin']['deleteconfirm'] = 'Wollen Sie wirklich den Datensatz - %s - l&ouml;schen?';
$lang['admin']['deleteassociationconfirm'] = 'Wollen Sie wirklich die Verkn&uuml;pfung mit - %s - l&ouml;schen?';
...
$lang['admin']['errorupdatingpages'] = 'Bei der Aktualisierung der Seiten ist ein Fehler aufgetreten.';
...
$lang['admin']['new_window'] = 'Neues Fenster';
...
$lang['admin']['homepage'] = 'Zur Startseite';
...
$lang['admin']['gcb_wysiwyg'] = 'WYSIWYG f&uuml;r GCB aktivieren';
$lang['admin']['gcb_wysiwyg_help'] = 'Aktiviert den WYSIWYG-Editor f&uuml;r die Bearbeitung der Globalen Inhaltsbl&ouml;cke (=GCB)';
...
$lang['admin']['usersgroups'] = 'Benutzer &amp; Gruppen';
...
$lang['admin']['admindescription'] = 'Administrative Funktionen der Webseite';
...
$lang['admin']['langparam'] = 'Dieser Parameter legt die verwendete Sprache f&uuml;r die Anzeige im Frontend fest, wird jedoch nicht von allen Modulen unterst&uuml;tzt bzw. ben&ouml;tigt.';
...
$lang['admin']['sitename'] = 'Seitenname';
...
$lang['admin']['utma'] = '156861353.717462736.1147511856.1204776557.1204988561.317';
?>