...
$lang['admin']['info_content_ping_interval'] = 'When editing a page, the server will be pinged at this interval (in seconds), as ong as there is keyboard activity, to indicate that the lock on the content object should not go stale.';
