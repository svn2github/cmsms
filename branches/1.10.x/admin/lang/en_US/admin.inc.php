...
$lang['admin']['locknotstale'] = 'The lock on this item is not stale.  It cannot be stolen';
$lang['admin']['nolockexpiry'] = 'The lock on this item never goes stale.  It cannot be stolen';
$lang['admin']['time_locked'] = 'Time since last modification';
$lang['admin']['lock_modified'] = 'Lock Last Modified';
$lang['admin']['lock_created'] = 'Lock Created';
$lang['admin']['lock_owner'] = 'Lock Owner';
$lang['admin']['steal'] = 'Steal';
$lang['admin']['steal_lock'] = 'Steal a locked item';
$lang['admin']['days_hours'] = '%d days and %d hours';
$lang['admin']['day_hours'] = '%d day and %d hours';
$lang['admin']['hours_minutes'] = '%d hours and %d minutes';
$lang['admin']['hoursminutes'] = '%d hour and %d minutes';
$lang['admin']['n_minutes'] = '%d minutes';
$lang['admin']['info_content_ping_interval'] = 'When editing a page, the server will be pinged at this interval (in seconds),sso long as there is keyboard activity, to indicate that the lock on the content object should not go stale.';
$lang['admin']['content_ping_interval'] = 'How often should locks be checked when editing content';
$lang['admin']['steal_content_lock'] = 'Steal content lock for: %s';
$lang['admin']['listcontent_lockstatus_locked'] = 'This page is locked by %s since %s';
$lang['admin']['listcontent_lockstatus_stale'] = 'This page is locked by %s since %s, however the lock is stale';
$lang['admin']['listcontent_lockstatus_unlocked'] = 'This page is unlocked';
$lang['admin']['info_listcontent_lockstaleage'] = 'Stale locks can be stolen by another user to allow editing a page that has accidentally been left locked';
$lang['admin']['minutes'] = 'Minutes';
$lang['admin']['listcontent_lockstaleage'] = 'Content locks are considered stale after';
$lang['admin']['problemlocking'] = 'Problem obtaining a lock for this item.  Perhaps it is being used by another user';
$lang['admin']['content_page_locked'] = 'Thsi page is currently being edited';
...
$lang['admin']['no_permission'] = 'You do not have permission to perform that function.';
