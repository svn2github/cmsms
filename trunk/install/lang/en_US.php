...
$lang['install_test_failed'] = 'One or more tests have resulted in a warning...<br />You can still install the system, but some functions may not work correctly.<br />Please try to correct the situation and click "Try Again", or ignore the warnings and click the "Continue" button.';
...
$lang['install_value_exceed'] = 'A setting meets or exceeds the recommended threshold<br />or... A capability that <em>may</em> be required for some optional functionality is available';
