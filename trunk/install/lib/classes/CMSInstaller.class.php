...
class CMSInstaller
{
   ...
   * Class constructor
   */
  function __construct($maxpages = 7, $debug = false)
  {
  ...
  function processSubmit($process = 'install')
  {
	...
	$result = $db->Connect($_POST['host'],$_POST['username'],
  ...
  public static function set_db_prefix($prefix)
  {
    self::$_ext_set = 1;
