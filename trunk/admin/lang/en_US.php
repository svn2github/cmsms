...
<p>This content type is used to logically separate items in the navigation <em>(usually with a horizontal or vertical bar)</em>.  It does not allow any children, and does not have any URL or content of its own.</p>
  ...
  <li>ErrorPage
<p>This content type is used to display 404 <em>(content not found)</em> errors on your website.  Only one page of this type is allowed in each installation.</p>
  </li>
</ul>
EOT;
...
EOT;
$lang['info_mailtest'] = 'This form will send a pre formatted email to the address you specify.  If you do not receive the mail you may need to re-check your settings.  <strong>Note:<strong> you may also want to check your spam folder.';
