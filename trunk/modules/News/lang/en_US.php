...
$lang['help_article_searchable'] = 'This field indicates wether this article should be indexed by the search module';
...
$lang['help_articles_filtercchildcats'] = 'If enabled, articles in the selected category, and their child categories will be displayed.';
...
$lang['help_opt_allowed_upload_types'] = 'For custom fields of type &quot;file&quot; This setting indicates a comma separted list of file extensions that are valid for the article editor to upload.';
...
$lang['help_opt_allow_summary_wysiwyg'] = 'This field indicates wether a WYSIWYG editor should be enabled for the summary field when editing an article.  In many circumstances the summary field is a simple text field, however this is optional.<br/>This setting is ignored if the summary field is disabled completely <em>(see above)</em>';
