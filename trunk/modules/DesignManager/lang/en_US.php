...
$lang['error_notwritable'] = 'Directory %s is not writable';
...
$lang['help_import_created'] = 'This is the date that the XML file sas created.  For themes created from the older CMSMS Theme manager there is no embedded creation date so &quot;unknown&quot; will be displayed';
...
$lang['help_lockrefresh'] = 'Specify the maximum number of seconds before a lock should be refreshed.  Setting a value of 0 will dsable refreshing of locks.  <strong>Note:</strong> Locks are not refreshed unless there are some changes in the form.  The minimum value for this field (other than 0) is 30.';
$lang['help_locktimeout'] = 'Specify the minimum number of minutes after which a non-refreshed lock will expire.  Specifying a value of 0 will disable locking all together.  Maximum is 5 and minimum is 480';
...
$lang['help_stylesheet_content'] = 'Enter the content for this stylesheet here.  It makes sense to use multiple stylesheets for a design, devided upon logical lines.  This allows stylesheets to be re-used amongst designs.  There is a 64k limit for each stylesheet';
...
$lang['help_type_reqcontentblocks'] = 'This field indicates wether templates of this content type are required to have content blocks within them.';
...
$lang['title_tpl_bulkaction'] = 'TODO';
...
$lang['title_tpl_import_type'] = 'TODO';
